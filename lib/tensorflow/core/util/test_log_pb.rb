...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("tensorflow/core/util/test_log.proto", :syntax => :proto3) do
    ...
    add_message "tensorflow.MetricEntry" do
      optional :name, :string, 1
      optional :value, :double, 2
      optional :min_value, :message, 3, "google.protobuf.DoubleValue"
      optional :max_value, :message, 4, "google.protobuf.DoubleValue"
    end
    add_message "tensorflow.BenchmarkEntry" do
      ...
      repeated :metrics, :message, 7, "tensorflow.MetricEntry"
    end
    ...
    add_message "tensorflow.CommitId" do
      ...
      optional :pending_changelist, :int64, 4
      oneof :kind do
...
module Tensorflow
  ...
  MetricEntry = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("tensorflow.MetricEntry").msgclass
