...
module Tensorflow
  module RawOps
    ...
    def self.abort(error_msg: nil, exit_without_error: false, name: nil)
      self.execute("Abort", [], error_msg: error_msg, exit_without_error: exit_without_error, name: name)
    end
  

    def self.abs(x, typeT: nil, name: nil)
      self.execute("Abs", [x], T: typeT, name: name)
    end
  

    def self.accumulate_nv2(inputs, n: nil, typeT: nil, shape: nil, name: nil)
      self.execute("AccumulateNV2", [inputs], N: n, T: typeT, shape: shape, name: name)
    end
  

    def self.accumulator_apply_gradient(handle, local_step, gradient, dtype: nil, name: nil)
      self.execute("AccumulatorApplyGradient", [handle, local_step, gradient], dtype: dtype, name: name)
    end
  

    def self.accumulator_num_accumulated(handle, name: nil)
      self.execute("AccumulatorNumAccumulated", [handle], name: name)
    end
  

    def self.accumulator_set_global_step(handle, new_global_step, name: nil)
      self.execute("AccumulatorSetGlobalStep", [handle, new_global_step], name: name)
    end
  

    def self.accumulator_take_gradient(handle, num_required, dtype: nil, name: nil)
      self.execute("AccumulatorTakeGradient", [handle, num_required], dtype: dtype, name: name)
    end
  

    def self.acos(x, typeT: nil, name: nil)
      self.execute("Acos", [x], T: typeT, name: name)
    end
  

    def self.acosh(x, typeT: nil, name: nil)
      self.execute("Acosh", [x], T: typeT, name: name)
    end
  

    def self.add(x, y, typeT: nil, name: nil)
      self.execute("Add", [x, y], T: typeT, name: name)
    end
  

    def self.add_many_sparse_to_tensors_map(sparse_indices, sparse_values, sparse_shape, typeT: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.add_n(inputs, n: nil, typeT: nil, name: nil)
      self.execute("AddN", [inputs], N: n, T: typeT, name: name)
    end
  

    def self.add_sparse_to_tensors_map(sparse_indices, sparse_values, sparse_shape, typeT: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.add_v2(x, y, typeT: nil, name: nil)
      self.execute("AddV2", [x, y], T: typeT, name: name)
    end
  

    def self.adjust_contrast(images, contrast_factor, min_value, max_value, typeT: nil, name: nil)
      self.execute("AdjustContrast", [images, contrast_factor, min_value, max_value], T: typeT, name: name)
    end
  

    def self.adjust_contrastv2(images, contrast_factor, typeT: nil, name: nil)
      self.execute("AdjustContrastv2", [images, contrast_factor], T: typeT, name: name)
    end
  

    def self.adjust_hue(images, delta, typeT: nil, name: nil)
      self.execute("AdjustHue", [images, delta], T: typeT, name: name)
    end
  

    def self.adjust_saturation(images, scale, typeT: nil, name: nil)
      self.execute("AdjustSaturation", [images, scale], T: typeT, name: name)
    end
  

    def self.all(input, reduction_indices, keep_dims: false, tidx: nil, name: nil)
      self.execute("All", [input, reduction_indices], keep_dims: keep_dims, Tidx: tidx, name: name)
    end
  

    def self.all_candidate_sampler(true_classes, num_true: nil, num_sampled: nil, unique: nil, seed: 0, seed2: 0, name: nil)
    ...
    def self.all_to_all(input, group_assignment, typeT: nil, concat_dimension: nil, split_dimension: nil, split_count: nil, name: nil)
    ...
    def self.angle(input, typeT: nil, tout: nil, name: nil)
      self.execute("Angle", [input], T: typeT, Tout: tout, name: name)
    end
  

    def self.anonymous_iterator(output_types: nil, output_shapes: nil, name: nil)
      self.execute("AnonymousIterator", [], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.anonymous_iterator_v2(output_types: nil, output_shapes: nil, name: nil)
      self.execute("AnonymousIteratorV2", [], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.anonymous_memory_cache(name: nil)
      self.execute("AnonymousMemoryCache", [], name: name)
    end
  

    def self.anonymous_multi_device_iterator(devices: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.anonymous_random_seed_generator(seed, seed2, name: nil)
      self.execute("AnonymousRandomSeedGenerator", [seed, seed2], name: name)
    end
  

    def self.any(input, reduction_indices, keep_dims: false, tidx: nil, name: nil)
      self.execute("Any", [input, reduction_indices], keep_dims: keep_dims, Tidx: tidx, name: name)
    end
  

    def self.apply_ada_max(var, m, v, beta1_power, lr, beta1, beta2, epsilon, grad, typeT: nil, use_locking: false, name: nil)
      self.execute("ApplyAdaMax", [var, m, v, beta1_power, lr, beta1, beta2, epsilon, grad], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.apply_adadelta(var, accum, accum_update, lr, rho, epsilon, grad, typeT: nil, use_locking: false, name: nil)
      self.execute("ApplyAdadelta", [var, accum, accum_update, lr, rho, epsilon, grad], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.apply_adagrad(var, accum, lr, grad, typeT: nil, use_locking: false, update_slots: true, name: nil)
      self.execute("ApplyAdagrad", [var, accum, lr, grad], T: typeT, use_locking: use_locking, update_slots: update_slots, name: name)
    end
  

    def self.apply_adagrad_da(var, gradient_accumulator, gradient_squared_accumulator, grad, lr, l1, l2, global_step, typeT: nil, use_locking: false, name: nil)
    ...
    def self.apply_adagrad_v2(var, accum, lr, epsilon, grad, typeT: nil, use_locking: false, update_slots: true, name: nil)
    ...
    def self.apply_adam(var, m, v, beta1_power, beta2_power, lr, beta1, beta2, epsilon, grad, typeT: nil, use_locking: false, use_nesterov: false, name: nil)
    ...
    def self.apply_add_sign(var, m, lr, alpha, sign_decay, beta, grad, typeT: nil, use_locking: false, name: nil)
      self.execute("ApplyAddSign", [var, m, lr, alpha, sign_decay, beta, grad], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.apply_centered_rms_prop(var, mg, ms, mom, lr, rho, momentum, epsilon, grad, typeT: nil, use_locking: false, name: nil)
      self.execute("ApplyCenteredRMSProp", [var, mg, ms, mom, lr, rho, momentum, epsilon, grad], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.apply_ftrl(var, accum, linear, grad, lr, l1, l2, lr_power, typeT: nil, use_locking: false, name: nil)
      self.execute("ApplyFtrl", [var, accum, linear, grad, lr, l1, l2, lr_power], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.apply_ftrl_v2(var, accum, linear, grad, lr, l1, l2, l2_shrinkage, lr_power, typeT: nil, use_locking: false, name: nil)
      self.execute("ApplyFtrlV2", [var, accum, linear, grad, lr, l1, l2, l2_shrinkage, lr_power], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.apply_gradient_descent(var, alpha, delta, typeT: nil, use_locking: false, name: nil)
      self.execute("ApplyGradientDescent", [var, alpha, delta], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.apply_momentum(var, accum, lr, grad, momentum, typeT: nil, use_locking: false, use_nesterov: false, name: nil)
    ...
    def self.apply_power_sign(var, m, lr, logbase, sign_decay, beta, grad, typeT: nil, use_locking: false, name: nil)
      self.execute("ApplyPowerSign", [var, m, lr, logbase, sign_decay, beta, grad], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.apply_proximal_adagrad(var, accum, lr, l1, l2, grad, typeT: nil, use_locking: false, name: nil)
      self.execute("ApplyProximalAdagrad", [var, accum, lr, l1, l2, grad], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.apply_proximal_gradient_descent(var, alpha, l1, l2, delta, typeT: nil, use_locking: false, name: nil)
      self.execute("ApplyProximalGradientDescent", [var, alpha, l1, l2, delta], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.apply_rms_prop(var, ms, mom, lr, rho, momentum, epsilon, grad, typeT: nil, use_locking: false, name: nil)
      self.execute("ApplyRMSProp", [var, ms, mom, lr, rho, momentum, epsilon, grad], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.approximate_equal(x, y, typeT: nil, tolerance: 9.999999747378752e-06, name: nil)
      self.execute("ApproximateEqual", [x, y], T: typeT, tolerance: tolerance, name: name)
    end
  

    def self.arg_max(input, dimension, typeT: nil, tidx: nil, output_type: nil, name: nil)
      self.execute("ArgMax", [input, dimension], T: typeT, Tidx: tidx, output_type: output_type, name: name)
    end
  

    def self.arg_min(input, dimension, typeT: nil, tidx: nil, output_type: nil, name: nil)
      self.execute("ArgMin", [input, dimension], T: typeT, Tidx: tidx, output_type: output_type, name: name)
    end
  

    def self.as_string(input, typeT: nil, precision: -1, scientific: false, shortest: false, width: -1, fill: nil, name: nil)
    ...
    def self.asin(x, typeT: nil, name: nil)
      self.execute("Asin", [x], T: typeT, name: name)
    end
  

    def self.asinh(x, typeT: nil, name: nil)
      self.execute("Asinh", [x], T: typeT, name: name)
    end
  

    def self.assert(condition, data, typeT: nil, summarize: 3, name: nil)
      self.execute("Assert", [condition, data], T: typeT, summarize: summarize, name: name)
    end
  

    def self.assert_next_dataset(input_dataset, transformations, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.assign(ref, value, typeT: nil, validate_shape: true, use_locking: true, name: nil)
      self.execute("Assign", [ref, value], T: typeT, validate_shape: validate_shape, use_locking: use_locking, name: name)
    end
  

    def self.assign_add(ref, value, typeT: nil, use_locking: false, name: nil)
      self.execute("AssignAdd", [ref, value], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.assign_add_variable_op(resource, value, dtype: nil, name: nil)
      self.execute("AssignAddVariableOp", [resource, value], dtype: dtype, name: name)
    end
  

    def self.assign_sub(ref, value, typeT: nil, use_locking: false, name: nil)
      self.execute("AssignSub", [ref, value], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.assign_sub_variable_op(resource, value, dtype: nil, name: nil)
      self.execute("AssignSubVariableOp", [resource, value], dtype: dtype, name: name)
    end
  

    def self.assign_variable_op(resource, value, dtype: nil, name: nil)
      self.execute("AssignVariableOp", [resource, value], dtype: dtype, name: name)
    end
  

    def self.atan(x, typeT: nil, name: nil)
      self.execute("Atan", [x], T: typeT, name: name)
    end
  

    def self.atan2(y, x, typeT: nil, name: nil)
      self.execute("Atan2", [y, x], T: typeT, name: name)
    end
  

    def self.atanh(x, typeT: nil, name: nil)
      self.execute("Atanh", [x], T: typeT, name: name)
    end
  

    def self.audio_spectrogram(input, window_size: nil, stride: nil, magnitude_squared: false, name: nil)
      self.execute("AudioSpectrogram", [input], window_size: window_size, stride: stride, magnitude_squared: magnitude_squared, name: name)
    end
  

    def self.audio_summary(tag, tensor, sample_rate: nil, max_outputs: 3, name: nil)
      self.execute("AudioSummary", [tag, tensor], sample_rate: sample_rate, max_outputs: max_outputs, name: name)
    end
  

    def self.audio_summary_v2(tag, tensor, sample_rate, max_outputs: 3, name: nil)
      self.execute("AudioSummaryV2", [tag, tensor, sample_rate], max_outputs: max_outputs, name: name)
    end
  

    def self.auto_shard_dataset(input_dataset, num_workers, index, auto_shard_policy: 0, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.avg_pool(value, ksize: nil, strides: nil, padding: nil, data_format: "NHWC", typeT: nil, name: nil)
      self.execute("AvgPool", [value], ksize: ksize, strides: strides, padding: padding, data_format: data_format, T: typeT, name: name)
    end
  

    def self.avg_pool3_d(input, ksize: nil, strides: nil, padding: nil, data_format: "NDHWC", typeT: nil, name: nil)
      self.execute("AvgPool3D", [input], ksize: ksize, strides: strides, padding: padding, data_format: data_format, T: typeT, name: name)
    end
  

    def self.avg_pool3_d_grad(orig_input_shape, grad, ksize: nil, strides: nil, padding: nil, data_format: "NDHWC", typeT: nil, name: nil)
    ...
    def self.avg_pool_grad(orig_input_shape, grad, ksize: nil, strides: nil, padding: nil, data_format: "NHWC", typeT: nil, name: nil)
    ...
    def self.barrier(component_types: nil, shapes: [], capacity: -1, container: nil, shared_name: nil, name: nil)
    ...
    def self.barrier_close(handle, cancel_pending_enqueues: false, name: nil)
      self.execute("BarrierClose", [handle], cancel_pending_enqueues: cancel_pending_enqueues, name: name)
    end
  

    def self.barrier_incomplete_size(handle, name: nil)
      self.execute("BarrierIncompleteSize", [handle], name: name)
    end
  

    def self.barrier_insert_many(handle, keys, values, typeT: nil, component_index: nil, name: nil)
      self.execute("BarrierInsertMany", [handle, keys, values], T: typeT, component_index: component_index, name: name)
    end
  

    def self.barrier_ready_size(handle, name: nil)
      self.execute("BarrierReadySize", [handle], name: name)
    end
  

    def self.barrier_take_many(handle, num_elements, component_types: nil, allow_small_batch: false, wait_for_incomplete: false, timeout_ms: -1, name: nil)
    ...
    def self.batch(in_tensors, num_batch_threads: nil, max_batch_size: nil, max_enqueued_batches: 10, batch_timeout_micros: nil, allowed_batch_sizes: [], grad_timeout_micros: nil, container: nil, shared_name: nil, batching_queue: nil, typeT: nil, name: nil)
    ...
    def self.batch_cholesky(input, typeT: nil, name: nil)
      self.execute("BatchCholesky", [input], T: typeT, name: name)
    end
  

    def self.batch_cholesky_grad(l, grad, typeT: nil, name: nil)
      self.execute("BatchCholeskyGrad", [l, grad], T: typeT, name: name)
    end
  

    def self.batch_dataset(input_dataset, batch_size, output_types: nil, output_shapes: nil, name: nil)
      self.execute("BatchDataset", [input_dataset, batch_size], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.batch_dataset_v2(input_dataset, batch_size, drop_remainder, parallel_copy: false, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.batch_fft(input, name: nil)
      self.execute("BatchFFT", [input], name: name)
    end
  

    def self.batch_fft2_d(input, name: nil)
      self.execute("BatchFFT2D", [input], name: name)
    end
  

    def self.batch_fft3_d(input, name: nil)
      self.execute("BatchFFT3D", [input], name: name)
    end
  

    def self.batch_function(in_tensors, captured_tensors, f: nil, num_batch_threads: nil, max_batch_size: nil, batch_timeout_micros: nil, max_enqueued_batches: 10, allowed_batch_sizes: [], container: nil, shared_name: nil, batching_queue: nil, tin: nil, tcaptured: nil, tout: nil, name: nil)
    ...
    def self.batch_ifft(input, name: nil)
      self.execute("BatchIFFT", [input], name: name)
    end
  

    def self.batch_ifft2_d(input, name: nil)
      self.execute("BatchIFFT2D", [input], name: name)
    end
  

    def self.batch_ifft3_d(input, name: nil)
      self.execute("BatchIFFT3D", [input], name: name)
    end
  

    def self.batch_mat_mul(x, y, typeT: nil, adj_x: false, adj_y: false, name: nil)
      self.execute("BatchMatMul", [x, y], T: typeT, adj_x: adj_x, adj_y: adj_y, name: name)
    end
  

    def self.batch_mat_mul_v2(x, y, typeT: nil, adj_x: false, adj_y: false, name: nil)
      self.execute("BatchMatMulV2", [x, y], T: typeT, adj_x: adj_x, adj_y: adj_y, name: name)
    end
  

    def self.batch_matrix_band_part(input, num_lower, num_upper, typeT: nil, name: nil)
      self.execute("BatchMatrixBandPart", [input, num_lower, num_upper], T: typeT, name: name)
    end
  

    def self.batch_matrix_determinant(input, typeT: nil, name: nil)
      self.execute("BatchMatrixDeterminant", [input], T: typeT, name: name)
    end
  

    def self.batch_matrix_diag(diagonal, typeT: nil, name: nil)
      self.execute("BatchMatrixDiag", [diagonal], T: typeT, name: name)
    end
  

    def self.batch_matrix_diag_part(input, typeT: nil, name: nil)
      self.execute("BatchMatrixDiagPart", [input], T: typeT, name: name)
    end
  

    def self.batch_matrix_inverse(input, adjoint: false, typeT: nil, name: nil)
      self.execute("BatchMatrixInverse", [input], adjoint: adjoint, T: typeT, name: name)
    end
  

    def self.batch_matrix_set_diag(input, diagonal, typeT: nil, name: nil)
      self.execute("BatchMatrixSetDiag", [input, diagonal], T: typeT, name: name)
    end
  

    def self.batch_matrix_solve(matrix, rhs, adjoint: false, typeT: nil, name: nil)
      self.execute("BatchMatrixSolve", [matrix, rhs], adjoint: adjoint, T: typeT, name: name)
    end
  

    def self.batch_matrix_solve_ls(matrix, rhs, l2_regularizer, typeT: nil, fast: true, name: nil)
      self.execute("BatchMatrixSolveLs", [matrix, rhs, l2_regularizer], T: typeT, fast: fast, name: name)
    end
  

    def self.batch_matrix_triangular_solve(matrix, rhs, lower: true, adjoint: false, typeT: nil, name: nil)
      self.execute("BatchMatrixTriangularSolve", [matrix, rhs], lower: lower, adjoint: adjoint, T: typeT, name: name)
    end
  

    def self.batch_norm_with_global_normalization(t, m, v, beta, gamma, typeT: nil, variance_epsilon: nil, scale_after_normalization: nil, name: nil)
    ...
    def self.batch_norm_with_global_normalization_grad(t, m, v, gamma, backprop, typeT: nil, variance_epsilon: nil, scale_after_normalization: nil, name: nil)
    ...
    def self.batch_self_adjoint_eig(input, typeT: nil, name: nil)
      self.execute("BatchSelfAdjointEig", [input], T: typeT, name: name)
    end
  

    def self.batch_self_adjoint_eig_v2(input, compute_v: true, typeT: nil, name: nil)
      self.execute("BatchSelfAdjointEigV2", [input], compute_v: compute_v, T: typeT, name: name)
    end
  

    def self.batch_svd(input, compute_uv: true, full_matrices: false, typeT: nil, name: nil)
      self.execute("BatchSvd", [input], compute_uv: compute_uv, full_matrices: full_matrices, T: typeT, name: name)
    end
  

    def self.batch_to_space(input, crops, typeT: nil, block_size: nil, tidx: nil, name: nil)
      self.execute("BatchToSpace", [input, crops], T: typeT, block_size: block_size, Tidx: tidx, name: name)
    end
  

    def self.batch_to_space_nd(input, block_shape, crops, typeT: nil, tblock_shape: nil, tcrops: nil, name: nil)
      self.execute("BatchToSpaceND", [input, block_shape, crops], T: typeT, Tblock_shape: tblock_shape, Tcrops: tcrops, name: name)
    end
  

    def self.bessel_i0e(x, typeT: nil, name: nil)
      self.execute("BesselI0e", [x], T: typeT, name: name)
    end
  

    def self.bessel_i1e(x, typeT: nil, name: nil)
      self.execute("BesselI1e", [x], T: typeT, name: name)
    end
  

    def self.betainc(a, b, x, typeT: nil, name: nil)
      self.execute("Betainc", [a, b, x], T: typeT, name: name)
    end
  

    def self.bias_add(value, bias, typeT: nil, data_format: "NHWC", name: nil)
      self.execute("BiasAdd", [value, bias], T: typeT, data_format: data_format, name: name)
    end
  

    def self.bias_add_grad(out_backprop, typeT: nil, data_format: "NHWC", name: nil)
      self.execute("BiasAddGrad", [out_backprop], T: typeT, data_format: data_format, name: name)
    end
  

    def self.bias_add_v1(value, bias, typeT: nil, name: nil)
      self.execute("BiasAddV1", [value, bias], T: typeT, name: name)
    end
  

    def self.bincount(arr, size, weights, typeT: nil, name: nil)
      self.execute("Bincount", [arr, size, weights], T: typeT, name: name)
    end
  

    def self.bitcast(input, typeT: nil, type: nil, name: nil)
      self.execute("Bitcast", [input], T: typeT, type: type, name: name)
    end
  

    def self.bitwise_and(x, y, typeT: nil, name: nil)
      self.execute("BitwiseAnd", [x, y], T: typeT, name: name)
    end
  

    def self.bitwise_or(x, y, typeT: nil, name: nil)
      self.execute("BitwiseOr", [x, y], T: typeT, name: name)
    end
  

    def self.bitwise_xor(x, y, typeT: nil, name: nil)
      self.execute("BitwiseXor", [x, y], T: typeT, name: name)
    end
  

    def self.block_lstm(seq_len_max, x, cs_prev, h_prev, w, wci, wcf, wco, b, forget_bias: 1.0, cell_clip: 3.0, use_peephole: false, typeT: nil, name: nil)
    ...
    def self.block_lstm_grad(seq_len_max, x, cs_prev, h_prev, w, wci, wcf, wco, b, i, cs, f, o, ci, co, h, cs_grad, h_grad, use_peephole: nil, typeT: nil, name: nil)
    ...
    def self.block_lstm_grad_v2(seq_len_max, x, cs_prev, h_prev, w, wci, wcf, wco, b, i, cs, f, o, ci, co, h, cs_grad, h_grad, use_peephole: nil, typeT: nil, name: nil)
    ...
    def self.block_lstmv2(seq_len_max, x, cs_prev, h_prev, w, wci, wcf, wco, b, cell_clip: 0.0, use_peephole: false, typeT: nil, name: nil)
    ...
    def self.boosted_trees_aggregate_stats(node_ids, gradients, hessians, feature, max_splits: nil, num_buckets: nil, name: nil)
    ...
    def self.boosted_trees_bucketize(float_values, bucket_boundaries, num_features: nil, name: nil)
      self.execute("BoostedTreesBucketize", [float_values, bucket_boundaries], num_features: num_features, name: name)
    end
  

    def self.boosted_trees_calculate_best_feature_split(node_id_range, stats_summary, l1, l2, tree_complexity, min_node_weight, logits_dimension: nil, split_type: "inequality", name: nil)
    ...
    def self.boosted_trees_calculate_best_gains_per_feature(node_id_range, stats_summary_list, l1, l2, tree_complexity, min_node_weight, max_splits: nil, num_features: nil, name: nil)
    ...
    def self.boosted_trees_center_bias(tree_ensemble_handle, mean_gradients, mean_hessians, l1, l2, name: nil)
      self.execute("BoostedTreesCenterBias", [tree_ensemble_handle, mean_gradients, mean_hessians, l1, l2], name: name)
    end
  

    def self.boosted_trees_create_ensemble(tree_ensemble_handle, stamp_token, tree_ensemble_serialized, name: nil)
      self.execute("BoostedTreesCreateEnsemble", [tree_ensemble_handle, stamp_token, tree_ensemble_serialized], name: name)
    end
  

    def self.boosted_trees_create_quantile_stream_resource(quantile_stream_resource_handle, epsilon, num_streams, max_elements: 1099511627776, name: nil)
    ...
    def self.boosted_trees_deserialize_ensemble(tree_ensemble_handle, stamp_token, tree_ensemble_serialized, name: nil)
      self.execute("BoostedTreesDeserializeEnsemble", [tree_ensemble_handle, stamp_token, tree_ensemble_serialized], name: name)
    end
  

    def self.boosted_trees_ensemble_resource_handle_op(container: nil, shared_name: nil, name: nil)
      self.execute("BoostedTreesEnsembleResourceHandleOp", [], container: container, shared_name: shared_name, name: name)
    end
  

    def self.boosted_trees_example_debug_outputs(tree_ensemble_handle, bucketized_features, num_bucketized_features: nil, logits_dimension: nil, name: nil)
    ...
    def self.boosted_trees_flush_quantile_summaries(quantile_stream_resource_handle, num_features: nil, name: nil)
      self.execute("BoostedTreesFlushQuantileSummaries", [quantile_stream_resource_handle], num_features: num_features, name: name)
    end
  

    def self.boosted_trees_get_ensemble_states(tree_ensemble_handle, name: nil)
      self.execute("BoostedTreesGetEnsembleStates", [tree_ensemble_handle], name: name)
    end
  

    def self.boosted_trees_make_quantile_summaries(float_values, example_weights, epsilon, num_features: nil, name: nil)
      self.execute("BoostedTreesMakeQuantileSummaries", [float_values, example_weights, epsilon], num_features: num_features, name: name)
    end
  

    def self.boosted_trees_make_stats_summary(node_ids, gradients, hessians, bucketized_features_list, max_splits: nil, num_buckets: nil, num_features: nil, name: nil)
    ...
    def self.boosted_trees_predict(tree_ensemble_handle, bucketized_features, num_bucketized_features: nil, logits_dimension: nil, name: nil)
    ...
    def self.boosted_trees_quantile_stream_resource_add_summaries(quantile_stream_resource_handle, summaries, num_features: nil, name: nil)
    ...
    def self.boosted_trees_quantile_stream_resource_deserialize(quantile_stream_resource_handle, bucket_boundaries, num_streams: nil, name: nil)
    ...
    def self.boosted_trees_quantile_stream_resource_flush(quantile_stream_resource_handle, num_buckets, generate_quantiles: false, name: nil)
    ...
    def self.boosted_trees_quantile_stream_resource_get_bucket_boundaries(quantile_stream_resource_handle, num_features: nil, name: nil)
    ...
    def self.boosted_trees_quantile_stream_resource_handle_op(container: nil, shared_name: nil, name: nil)
      self.execute("BoostedTreesQuantileStreamResourceHandleOp", [], container: container, shared_name: shared_name, name: name)
    end
  

    def self.boosted_trees_serialize_ensemble(tree_ensemble_handle, name: nil)
      self.execute("BoostedTreesSerializeEnsemble", [tree_ensemble_handle], name: name)
    end
  

    def self.boosted_trees_sparse_aggregate_stats(node_ids, gradients, hessians, feature_indices, feature_values, feature_shape, max_splits: nil, num_buckets: nil, name: nil)
    ...
    def self.boosted_trees_sparse_calculate_best_feature_split(node_id_range, stats_summary_indices, stats_summary_values, stats_summary_shape, l1, l2, tree_complexity, min_node_weight, logits_dimension: nil, split_type: "inequality", name: nil)
    ...
    def self.boosted_trees_training_predict(tree_ensemble_handle, cached_tree_ids, cached_node_ids, bucketized_features, num_bucketized_features: nil, logits_dimension: nil, name: nil)
    ...
    def self.boosted_trees_update_ensemble(tree_ensemble_handle, feature_ids, node_ids, gains, thresholds, left_node_contribs, right_node_contribs, max_depth, learning_rate, pruning_mode: nil, num_features: nil, name: nil)
    ...
    def self.boosted_trees_update_ensemble_v2(tree_ensemble_handle, feature_ids, dimension_ids, node_ids, gains, thresholds, left_node_contribs, right_node_contribs, split_types, max_depth, learning_rate, pruning_mode, num_features: nil, logits_dimension: 1, name: nil)
    ...
    def self.broadcast_args(s0, s1, typeT: nil, name: nil)
      self.execute("BroadcastArgs", [s0, s1], T: typeT, name: name)
    end
  

    def self.broadcast_gradient_args(s0, s1, typeT: nil, name: nil)
      self.execute("BroadcastGradientArgs", [s0, s1], T: typeT, name: name)
    end
  

    def self.broadcast_to(input, shape, typeT: nil, tidx: nil, name: nil)
      self.execute("BroadcastTo", [input, shape], T: typeT, Tidx: tidx, name: name)
    end
  

    def self.bucketize(input, typeT: nil, boundaries: nil, name: nil)
      self.execute("Bucketize", [input], T: typeT, boundaries: boundaries, name: name)
    end
  

    def self.bytes_produced_stats_dataset(input_dataset, tag, output_types: nil, output_shapes: nil, name: nil)
      self.execute("BytesProducedStatsDataset", [input_dataset, tag], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.csr_sparse_matrix_components(csr_sparse_matrix, index, type: nil, name: nil)
      self.execute("CSRSparseMatrixComponents", [csr_sparse_matrix, index], type: type, name: name)
    end
  

    def self.csr_sparse_matrix_to_dense(sparse_input, type: nil, name: nil)
      self.execute("CSRSparseMatrixToDense", [sparse_input], type: type, name: name)
    end
  

    def self.csr_sparse_matrix_to_sparse_tensor(sparse_matrix, type: nil, name: nil)
      self.execute("CSRSparseMatrixToSparseTensor", [sparse_matrix], type: type, name: name)
    end
  

    def self.csv_dataset(filenames, compression_type, buffer_size, header, field_delim, use_quote_delim, na_value, select_cols, record_defaults, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.ctc_beam_search_decoder(inputs, sequence_length, beam_width: nil, top_paths: nil, merge_repeated: true, typeT: nil, name: nil)
    ...
    def self.ctc_greedy_decoder(inputs, sequence_length, merge_repeated: false, typeT: nil, name: nil)
      self.execute("CTCGreedyDecoder", [inputs, sequence_length], merge_repeated: merge_repeated, T: typeT, name: name)
    end
  

    def self.ctc_loss(inputs, labels_indices, labels_values, sequence_length, preprocess_collapse_repeated: false, ctc_merge_repeated: true, ignore_longer_outputs_than_inputs: false, typeT: nil, name: nil)
    ...
    def self.cache_dataset(input_dataset, filename, output_types: nil, output_shapes: nil, name: nil)
      self.execute("CacheDataset", [input_dataset, filename], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.cache_dataset_v2(input_dataset, filename, cache, output_types: nil, output_shapes: nil, name: nil)
      self.execute("CacheDatasetV2", [input_dataset, filename, cache], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.case(branch_index, input, tin: nil, tout: nil, branches: nil, output_shapes: [], name: nil)
      self.execute("Case", [branch_index, input], Tin: tin, Tout: tout, branches: branches, output_shapes: output_shapes, name: name)
    end
  

    def self.cast(x, srct: nil, dstt: nil, truncate: false, name: nil)
      self.execute("Cast", [x], SrcT: srct, DstT: dstt, Truncate: truncate, name: name)
    end
  

    def self.ceil(x, typeT: nil, name: nil)
      self.execute("Ceil", [x], T: typeT, name: name)
    end
  

    def self.check_numerics(tensor, typeT: nil, message: nil, name: nil)
      self.execute("CheckNumerics", [tensor], T: typeT, message: message, name: name)
    end
  

    def self.cholesky(input, typeT: nil, name: nil)
      self.execute("Cholesky", [input], T: typeT, name: name)
    end
  

    def self.cholesky_grad(l, grad, typeT: nil, name: nil)
      self.execute("CholeskyGrad", [l, grad], T: typeT, name: name)
    end
  

    def self.choose_fastest_branch_dataset(input_dataset, ratio_numerator, ratio_denominator, other_arguments, targuments: nil, num_elements_per_branch: nil, branches: nil, other_arguments_lengths: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.choose_fastest_dataset(input_datasets, n: nil, num_experiments: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.clip_by_value(t, clip_value_min, clip_value_max, typeT: nil, name: nil)
      self.execute("ClipByValue", [t, clip_value_min, clip_value_max], T: typeT, name: name)
    end
  

    def self.close_summary_writer(writer, name: nil)
      self.execute("CloseSummaryWriter", [writer], name: name)
    end
  

    def self.collective_bcast_recv(typeT: nil, group_size: nil, group_key: nil, instance_key: nil, shape: nil, communication_hint: "auto", name: nil)
    ...
    def self.collective_bcast_send(input, typeT: nil, group_size: nil, group_key: nil, instance_key: nil, shape: nil, communication_hint: "auto", name: nil)
    ...
    def self.collective_gather(input, typeT: nil, group_size: nil, group_key: nil, instance_key: nil, shape: nil, communication_hint: "auto", name: nil)
    ...
    def self.collective_permute(input, source_target_pairs, typeT: nil, name: nil)
      self.execute("CollectivePermute", [input, source_target_pairs], T: typeT, name: name)
    end
  

    def self.collective_reduce(input, typeT: nil, group_size: nil, group_key: nil, instance_key: nil, merge_op: nil, final_op: nil, subdiv_offsets: nil, wait_for: [], communication_hint: "auto", name: nil)
    ...
    def self.combined_non_max_suppression(boxes, scores, max_output_size_per_class, max_total_size, iou_threshold, score_threshold, pad_per_class: false, clip_boxes: true, name: nil)
    ...
    def self.compare_and_bitpack(input, threshold, typeT: nil, name: nil)
      self.execute("CompareAndBitpack", [input, threshold], T: typeT, name: name)
    end
  

    def self.complex(real, imag, typeT: nil, tout: nil, name: nil)
      self.execute("Complex", [real, imag], T: typeT, Tout: tout, name: name)
    end
  

    def self.complex_abs(x, typeT: nil, tout: nil, name: nil)
      self.execute("ComplexAbs", [x], T: typeT, Tout: tout, name: name)
    end
  

    def self.compute_accidental_hits(true_classes, sampled_candidates, num_true: nil, seed: 0, seed2: 0, name: nil)
      self.execute("ComputeAccidentalHits", [true_classes, sampled_candidates], num_true: num_true, seed: seed, seed2: seed2, name: name)
    end
  

    def self.concat(concat_dim, values, n: nil, typeT: nil, name: nil)
      self.execute("Concat", [concat_dim, values], N: n, T: typeT, name: name)
    end
  

    def self.concat_offset(concat_dim, shape, n: nil, name: nil)
      self.execute("ConcatOffset", [concat_dim, shape], N: n, name: name)
    end
  

    def self.concat_v2(values, axis, n: nil, typeT: nil, tidx: nil, name: nil)
      self.execute("ConcatV2", [values, axis], N: n, T: typeT, Tidx: tidx, name: name)
    end
  

    def self.concatenate_dataset(input_dataset, another_dataset, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.conditional_accumulator(dtype: nil, shape: nil, container: nil, shared_name: nil, reduction_type: "MEAN", name: nil)
    ...
    def self.configure_distributed_tpu(embedding_config: nil, tpu_embedding_config: nil, is_global_init: false, enable_whole_mesh_compilations: false, name: nil)
    ...
    def self.configure_tpu_embedding(config: nil, name: nil)
      self.execute("ConfigureTPUEmbedding", [], config: config, name: name)
    end
  

    def self.conj(input, typeT: nil, name: nil)
      self.execute("Conj", [input], T: typeT, name: name)
    end
  

    def self.conjugate_transpose(x, perm, typeT: nil, tperm: nil, name: nil)
      self.execute("ConjugateTranspose", [x, perm], T: typeT, Tperm: tperm, name: name)
    end
  

    def self.const(value: nil, dtype: nil, name: nil)
      self.execute("Const", [], value: value, dtype: dtype, name: name)
    end
  

    def self.consume_mutex_lock(mutex_lock, name: nil)
      self.execute("ConsumeMutexLock", [mutex_lock], name: name)
    end
  

    def self.control_trigger(name: nil)
      self.execute("ControlTrigger", [], name: name)
    end
  

    def self.conv2_d(input, filter, typeT: nil, strides: nil, use_cudnn_on_gpu: true, padding: nil, explicit_paddings: [], data_format: "NHWC", dilations: [], name: nil)
    ...
    def self.conv2_d_backprop_filter(input, filter_sizes, out_backprop, typeT: nil, strides: nil, use_cudnn_on_gpu: true, padding: nil, explicit_paddings: [], data_format: "NHWC", dilations: [], name: nil)
    ...
    def self.conv2_d_backprop_input(input_sizes, filter, out_backprop, typeT: nil, strides: nil, use_cudnn_on_gpu: true, padding: nil, explicit_paddings: [], data_format: "NHWC", dilations: [], name: nil)
    ...
    def self.conv3_d(input, filter, typeT: nil, strides: nil, padding: nil, data_format: "NDHWC", dilations: [], name: nil)
    ...
    def self.conv3_d_backprop_filter(input, filter, out_backprop, typeT: nil, strides: nil, padding: nil, dilations: [], name: nil)
    ...
    def self.conv3_d_backprop_filter_v2(input, filter_sizes, out_backprop, typeT: nil, strides: nil, padding: nil, data_format: "NDHWC", dilations: [], name: nil)
    ...
    def self.conv3_d_backprop_input(input, filter, out_backprop, typeT: nil, strides: nil, padding: nil, dilations: [], name: nil)
    ...
    def self.conv3_d_backprop_input_v2(input_sizes, filter, out_backprop, typeT: nil, strides: nil, padding: nil, data_format: "NDHWC", dilations: [], tshape: nil, name: nil)
    ...
    def self.copy(input, typeT: nil, tensor_name: nil, debug_ops_spec: [], name: nil)
      self.execute("Copy", [input], T: typeT, tensor_name: tensor_name, debug_ops_spec: debug_ops_spec, name: name)
    end
  

    def self.copy_host(input, typeT: nil, tensor_name: nil, debug_ops_spec: [], name: nil)
      self.execute("CopyHost", [input], T: typeT, tensor_name: tensor_name, debug_ops_spec: debug_ops_spec, name: name)
    end
  

    def self.cos(x, typeT: nil, name: nil)
      self.execute("Cos", [x], T: typeT, name: name)
    end
  

    def self.cosh(x, typeT: nil, name: nil)
      self.execute("Cosh", [x], T: typeT, name: name)
    end
  

    def self.count_up_to(ref, limit: nil, typeT: nil, name: nil)
      self.execute("CountUpTo", [ref], limit: limit, T: typeT, name: name)
    end
  

    def self.create_summary_db_writer(writer, db_uri, experiment_name, run_name, user_name, name: nil)
      self.execute("CreateSummaryDbWriter", [writer, db_uri, experiment_name, run_name, user_name], name: name)
    end
  

    def self.create_summary_file_writer(writer, logdir, max_queue, flush_millis, filename_suffix, name: nil)
      self.execute("CreateSummaryFileWriter", [writer, logdir, max_queue, flush_millis, filename_suffix], name: name)
    end
  

    def self.crop_and_resize(image, boxes, box_ind, crop_size, typeT: nil, method: "bilinear", extrapolation_value: 0.0, name: nil)
    ...
    def self.crop_and_resize_grad_boxes(grads, image, boxes, box_ind, typeT: nil, method: "bilinear", name: nil)
      self.execute("CropAndResizeGradBoxes", [grads, image, boxes, box_ind], T: typeT, method: method, name: name)
    end
  

    def self.crop_and_resize_grad_image(grads, boxes, box_ind, image_size, typeT: nil, method: "bilinear", name: nil)
      self.execute("CropAndResizeGradImage", [grads, boxes, box_ind, image_size], T: typeT, method: method, name: name)
    end
  

    def self.cross(a, b, typeT: nil, name: nil)
      self.execute("Cross", [a, b], T: typeT, name: name)
    end
  

    def self.cross_replica_sum(input, group_assignment, typeT: nil, name: nil)
      self.execute("CrossReplicaSum", [input, group_assignment], T: typeT, name: name)
    end
  

    def self.cudnn_rnn(input, input_h, input_c, params, typeT: nil, rnn_mode: "lstm", input_mode: "linear_input", direction: "unidirectional", dropout: 0.0, seed: 0, seed2: 0, is_training: true, name: nil)
    ...
    def self.cudnn_rnn_backprop(input, input_h, input_c, params, output, output_h, output_c, output_backprop, output_h_backprop, output_c_backprop, reserve_space, typeT: nil, rnn_mode: "lstm", input_mode: "linear_input", direction: "unidirectional", dropout: 0.0, seed: 0, seed2: 0, name: nil)
    ...
    def self.cudnn_rnn_backprop_v2(input, input_h, input_c, params, output, output_h, output_c, output_backprop, output_h_backprop, output_c_backprop, reserve_space, host_reserved, typeT: nil, rnn_mode: "lstm", input_mode: "linear_input", direction: "unidirectional", dropout: 0.0, seed: 0, seed2: 0, name: nil)
    ...
    def self.cudnn_rnn_canonical_to_params(num_layers, num_units, input_size, weights, biases, typeT: nil, num_params: nil, rnn_mode: "lstm", input_mode: "linear_input", direction: "unidirectional", dropout: 0.0, seed: 0, seed2: 0, name: nil)
    ...
    def self.cudnn_rnn_canonical_to_params_v2(num_layers, num_units, input_size, weights, biases, typeT: nil, num_params_weights: nil, num_params_biases: nil, rnn_mode: "lstm", input_mode: "linear_input", direction: "unidirectional", dropout: 0.0, seed: 0, seed2: 0, num_proj: 0, name: nil)
    ...
    def self.cudnn_rnn_params_size(num_layers, num_units, input_size, typeT: nil, s: nil, rnn_mode: "lstm", input_mode: "linear_input", direction: "unidirectional", dropout: 0.0, seed: 0, seed2: 0, num_proj: 0, name: nil)
    ...
    def self.cudnn_rnn_params_to_canonical(num_layers, num_units, input_size, params, typeT: nil, num_params: nil, rnn_mode: "lstm", input_mode: "linear_input", direction: "unidirectional", dropout: 0.0, seed: 0, seed2: 0, name: nil)
    ...
    def self.cudnn_rnn_params_to_canonical_v2(num_layers, num_units, input_size, params, typeT: nil, num_params_weights: nil, num_params_biases: nil, rnn_mode: "lstm", input_mode: "linear_input", direction: "unidirectional", dropout: 0.0, seed: 0, seed2: 0, num_proj: 0, name: nil)
    ...
    def self.cudnn_rnnv2(input, input_h, input_c, params, typeT: nil, rnn_mode: "lstm", input_mode: "linear_input", direction: "unidirectional", dropout: 0.0, seed: 0, seed2: 0, is_training: true, name: nil)
    ...
    def self.cudnn_rnnv3(input, input_h, input_c, params, sequence_lengths, typeT: nil, rnn_mode: "lstm", input_mode: "linear_input", direction: "unidirectional", dropout: 0.0, seed: 0, seed2: 0, num_proj: 0, is_training: true, time_major: true, name: nil)
    ...
    def self.cumprod(x, axis, exclusive: false, reverse: false, typeT: nil, tidx: nil, name: nil)
      self.execute("Cumprod", [x, axis], exclusive: exclusive, reverse: reverse, T: typeT, Tidx: tidx, name: name)
    end
  

    def self.cumsum(x, axis, exclusive: false, reverse: false, typeT: nil, tidx: nil, name: nil)
      self.execute("Cumsum", [x, axis], exclusive: exclusive, reverse: reverse, T: typeT, Tidx: tidx, name: name)
    end
  

    def self.cumulative_logsumexp(x, axis, exclusive: false, reverse: false, typeT: nil, tidx: nil, name: nil)
      self.execute("CumulativeLogsumexp", [x, axis], exclusive: exclusive, reverse: reverse, T: typeT, Tidx: tidx, name: name)
    end
  

    def self.data_format_dim_map(x, typeT: nil, src_format: "NHWC", dst_format: "NCHW", name: nil)
      self.execute("DataFormatDimMap", [x], T: typeT, src_format: src_format, dst_format: dst_format, name: name)
    end
  

    def self.data_format_vec_permute(x, typeT: nil, src_format: "NHWC", dst_format: "NCHW", name: nil)
      self.execute("DataFormatVecPermute", [x], T: typeT, src_format: src_format, dst_format: dst_format, name: name)
    end
  

    def self.dataset_cardinality(input_dataset, name: nil)
      self.execute("DatasetCardinality", [input_dataset], name: name)
    end
  

    def self.dataset_from_graph(graph_def, name: nil)
      self.execute("DatasetFromGraph", [graph_def], name: name)
    end
  

    def self.dataset_to_graph(input_dataset, stateful_whitelist: [], allow_stateful: false, strip_device_assignment: false, name: nil)
    ...
    def self.dataset_to_graph_v2(input_dataset, external_state_policy: 0, strip_device_assignment: false, name: nil)
    ...
    def self.dataset_to_single_element(dataset, output_types: nil, output_shapes: nil, name: nil)
      self.execute("DatasetToSingleElement", [dataset], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.dataset_to_tf_record(input_dataset, filename, compression_type, name: nil)
      self.execute("DatasetToTFRecord", [input_dataset, filename, compression_type], name: name)
    end
  

    def self.debug_gradient_identity(input, typeT: nil, name: nil)
      self.execute("DebugGradientIdentity", [input], T: typeT, name: name)
    end
  

    def self.debug_gradient_ref_identity(input, typeT: nil, name: nil)
      self.execute("DebugGradientRefIdentity", [input], T: typeT, name: name)
    end
  

    def self.debug_identity(input, typeT: nil, device_name: nil, tensor_name: nil, debug_urls: [], gated_grpc: false, name: nil)
    ...
    def self.debug_identity_v2(input, typeT: nil, tfdbg_context_id: nil, op_name: nil, output_slot: -1, tensor_debug_mode: -1, debug_urls: [], name: nil)
    ...
    def self.debug_nan_count(input, typeT: nil, device_name: nil, tensor_name: nil, debug_urls: [], gated_grpc: false, name: nil)
    ...
    def self.debug_numeric_summary(input, typeT: nil, device_name: nil, tensor_name: nil, debug_urls: [], lower_bound: -Infinity, upper_bound: Infinity, mute_if_healthy: false, gated_grpc: false, name: nil)
    ...
    def self.decode_and_crop_jpeg(contents, crop_window, channels: 0, ratio: 1, fancy_upscaling: true, try_recover_truncated: false, acceptable_fraction: 1.0, dct_method: nil, name: nil)
    ...
    def self.decode_base64(input, name: nil)
      self.execute("DecodeBase64", [input], name: name)
    end
  

    def self.decode_bmp(contents, channels: 0, name: nil)
      self.execute("DecodeBmp", [contents], channels: channels, name: name)
    end
  

    def self.decode_csv(records, record_defaults, out_type: nil, field_delim: ",", use_quote_delim: true, na_value: nil, select_cols: [], name: nil)
    ...
    def self.decode_compressed(bytes, compression_type: nil, name: nil)
      self.execute("DecodeCompressed", [bytes], compression_type: compression_type, name: name)
    end
  

    def self.decode_gif(contents, name: nil)
      self.execute("DecodeGif", [contents], name: name)
    end
  

    def self.decode_json_example(json_examples, name: nil)
      self.execute("DecodeJSONExample", [json_examples], name: name)
    end
  

    def self.decode_jpeg(contents, channels: 0, ratio: 1, fancy_upscaling: true, try_recover_truncated: false, acceptable_fraction: 1.0, dct_method: nil, name: nil)
    ...
    def self.decode_padded_raw(input_bytes, fixed_length, out_type: nil, little_endian: true, name: nil)
      self.execute("DecodePaddedRaw", [input_bytes, fixed_length], out_type: out_type, little_endian: little_endian, name: name)
    end
  

    def self.decode_png(contents, channels: 0, dtype: nil, name: nil)
      self.execute("DecodePng", [contents], channels: channels, dtype: dtype, name: name)
    end
  

    def self.decode_proto_v2(bytes, message_type: nil, field_names: nil, output_types: nil, descriptor_source: "local://", message_format: "binary", sanitize: false, name: nil)
    ...
    def self.decode_raw(bytes, out_type: nil, little_endian: true, name: nil)
      self.execute("DecodeRaw", [bytes], out_type: out_type, little_endian: little_endian, name: name)
    end
  

    def self.decode_wav(contents, desired_channels: -1, desired_samples: -1, name: nil)
      self.execute("DecodeWav", [contents], desired_channels: desired_channels, desired_samples: desired_samples, name: name)
    end
  

    def self.deep_copy(x, typeT: nil, name: nil)
      self.execute("DeepCopy", [x], T: typeT, name: name)
    end
  

    def self.delete_iterator(handle, deleter, name: nil)
      self.execute("DeleteIterator", [handle, deleter], name: name)
    end
  

    def self.delete_memory_cache(handle, deleter, name: nil)
      self.execute("DeleteMemoryCache", [handle, deleter], name: name)
    end
  

    def self.delete_multi_device_iterator(multi_device_iterator, iterators, deleter, n: nil, name: nil)
      self.execute("DeleteMultiDeviceIterator", [multi_device_iterator, iterators, deleter], N: n, name: name)
    end
  

    def self.delete_random_seed_generator(handle, deleter, name: nil)
      self.execute("DeleteRandomSeedGenerator", [handle, deleter], name: name)
    end
  

    def self.delete_session_tensor(handle, name: nil)
      self.execute("DeleteSessionTensor", [handle], name: name)
    end
  

    def self.dense_to_csr_sparse_matrix(dense_input, indices, typeT: nil, name: nil)
      self.execute("DenseToCSRSparseMatrix", [dense_input, indices], T: typeT, name: name)
    end
  

    def self.dense_to_dense_set_operation(set1, set2, set_operation: nil, validate_indices: true, typeT: nil, name: nil)
    ...
    def self.dense_to_sparse_batch_dataset(input_dataset, batch_size, row_shape, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.dense_to_sparse_set_operation(set1, set2_indices, set2_values, set2_shape, set_operation: nil, validate_indices: true, typeT: nil, name: nil)
    ...
    def self.depth_to_space(input, typeT: nil, block_size: nil, data_format: "NHWC", name: nil)
      self.execute("DepthToSpace", [input], T: typeT, block_size: block_size, data_format: data_format, name: name)
    end
  

    def self.depthwise_conv2d_native(input, filter, typeT: nil, strides: nil, padding: nil, data_format: "NHWC", dilations: [], name: nil)
    ...
    def self.depthwise_conv2d_native_backprop_filter(input, filter_sizes, out_backprop, typeT: nil, strides: nil, padding: nil, data_format: "NHWC", dilations: [], name: nil)
    ...
    def self.depthwise_conv2d_native_backprop_input(input_sizes, filter, out_backprop, typeT: nil, strides: nil, padding: nil, data_format: "NHWC", dilations: [], name: nil)
    ...
    def self.dequantize(input, min_range, max_range, typeT: nil, mode: "MIN_COMBINED", narrow_range: false, axis: -1, name: nil)
      self.execute("Dequantize", [input, min_range, max_range], T: typeT, mode: mode, narrow_range: narrow_range, axis: axis, name: name)
    end
  

    def self.deserialize_iterator(resource_handle, serialized, name: nil)
      self.execute("DeserializeIterator", [resource_handle, serialized], name: name)
    end
  

    def self.deserialize_many_sparse(serialized_sparse, dtype: nil, name: nil)
      self.execute("DeserializeManySparse", [serialized_sparse], dtype: dtype, name: name)
    end
  

    def self.deserialize_sparse(serialized_sparse, dtype: nil, tserialized: nil, name: nil)
      self.execute("DeserializeSparse", [serialized_sparse], dtype: dtype, Tserialized: tserialized, name: name)
    end
  

    def self.destroy_resource_op(resource, ignore_lookup_error: true, name: nil)
      self.execute("DestroyResourceOp", [resource], ignore_lookup_error: ignore_lookup_error, name: name)
    end
  

    def self.destroy_temporary_variable(ref, typeT: nil, var_name: nil, name: nil)
      self.execute("DestroyTemporaryVariable", [ref], T: typeT, var_name: var_name, name: name)
    end
  

    def self.diag(diagonal, typeT: nil, name: nil)
      self.execute("Diag", [diagonal], T: typeT, name: name)
    end
  

    def self.diag_part(input, typeT: nil, name: nil)
      self.execute("DiagPart", [input], T: typeT, name: name)
    end
  

    def self.digamma(x, typeT: nil, name: nil)
      self.execute("Digamma", [x], T: typeT, name: name)
    end
  

    def self.dilation2_d(input, filter, typeT: nil, strides: nil, rates: nil, padding: nil, name: nil)
      self.execute("Dilation2D", [input, filter], T: typeT, strides: strides, rates: rates, padding: padding, name: name)
    end
  

    def self.dilation2_d_backprop_filter(input, filter, out_backprop, typeT: nil, strides: nil, rates: nil, padding: nil, name: nil)
    ...
    def self.dilation2_d_backprop_input(input, filter, out_backprop, typeT: nil, strides: nil, rates: nil, padding: nil, name: nil)
    ...
    def self.directed_interleave_dataset(selector_input_dataset, data_input_datasets, output_types: nil, output_shapes: nil, n: nil, name: nil)
    ...
    def self.div(x, y, typeT: nil, name: nil)
      self.execute("Div", [x, y], T: typeT, name: name)
    end
  

    def self.div_no_nan(x, y, typeT: nil, name: nil)
      self.execute("DivNoNan", [x, y], T: typeT, name: name)
    end
  

    def self.draw_bounding_boxes(images, boxes, typeT: nil, name: nil)
      self.execute("DrawBoundingBoxes", [images, boxes], T: typeT, name: name)
    end
  

    def self.draw_bounding_boxes_v2(images, boxes, colors, typeT: nil, name: nil)
      self.execute("DrawBoundingBoxesV2", [images, boxes, colors], T: typeT, name: name)
    end
  

    def self.dynamic_partition(data, partitions, num_partitions: nil, typeT: nil, name: nil)
      self.execute("DynamicPartition", [data, partitions], num_partitions: num_partitions, T: typeT, name: name)
    end
  

    def self.dynamic_stitch(indices, data, n: nil, typeT: nil, name: nil)
      self.execute("DynamicStitch", [indices, data], N: n, T: typeT, name: name)
    end
  

    def self.eager_py_func(input, token: nil, is_async: false, tin: nil, tout: nil, name: nil)
      self.execute("EagerPyFunc", [input], token: token, is_async: is_async, Tin: tin, Tout: tout, name: name)
    end
  

    def self.edit_distance(hypothesis_indices, hypothesis_values, hypothesis_shape, truth_indices, truth_values, truth_shape, normalize: true, typeT: nil, name: nil)
    ...
    def self.eig(input, compute_v: true, typeT: nil, tout: nil, name: nil)
      self.execute("Eig", [input], compute_v: compute_v, T: typeT, Tout: tout, name: name)
    end
  

    def self.einsum(inputs, equation: nil, n: nil, typeT: nil, name: nil)
      self.execute("Einsum", [inputs], equation: equation, N: n, T: typeT, name: name)
    end
  

    def self.elu(features, typeT: nil, name: nil)
      self.execute("Elu", [features], T: typeT, name: name)
    end
  

    def self.elu_grad(gradients, outputs, typeT: nil, name: nil)
      self.execute("EluGrad", [gradients, outputs], T: typeT, name: name)
    end
  

    def self.empty(shape, dtype: nil, init: false, name: nil)
      self.execute("Empty", [shape], dtype: dtype, init: init, name: name)
    end
  

    def self.empty_tensor_list(element_shape, max_num_elements, element_dtype: nil, shape_type: nil, name: nil)
      self.execute("EmptyTensorList", [element_shape, max_num_elements], element_dtype: element_dtype, shape_type: shape_type, name: name)
    end
  

    def self.encode_base64(input, pad: false, name: nil)
      self.execute("EncodeBase64", [input], pad: pad, name: name)
    end
  

    def self.encode_jpeg(image, format: nil, quality: 95, progressive: false, optimize_size: false, chroma_downsampling: true, density_unit: "in", x_density: 300, y_density: 300, xmp_metadata: nil, name: nil)
    ...
    def self.encode_jpeg_variable_quality(images, quality, name: nil)
      self.execute("EncodeJpegVariableQuality", [images, quality], name: name)
    end
  

    def self.encode_png(image, compression: -1, typeT: nil, name: nil)
      self.execute("EncodePng", [image], compression: compression, T: typeT, name: name)
    end
  

    def self.encode_proto(sizes, values, field_names: nil, message_type: nil, descriptor_source: "local://", tinput_types: nil, name: nil)
    ...
    def self.encode_wav(audio, sample_rate, name: nil)
      self.execute("EncodeWav", [audio, sample_rate], name: name)
    end
  

    def self.enqueue_tpu_embedding_integer_batch(batch, mode_override, n: nil, device_ordinal: -1, name: nil)
      self.execute("EnqueueTPUEmbeddingIntegerBatch", [batch, mode_override], N: n, device_ordinal: device_ordinal, name: name)
    end
  

    def self.enqueue_tpu_embedding_sparse_batch(sample_indices, embedding_indices, aggregation_weights, mode_override, t1: nil, t2: nil, t3: nil, n: nil, device_ordinal: -1, combiners: [], name: nil)
    ...
    def self.enqueue_tpu_embedding_sparse_tensor_batch(sample_indices, embedding_indices, aggregation_weights, mode_override, t1: nil, t2: nil, t3: nil, n: nil, device_ordinal: -1, combiners: [], table_ids: nil, max_sequence_lengths: [], name: nil)
    ...
    def self.ensure_shape(input, shape: nil, typeT: nil, name: nil)
      self.execute("EnsureShape", [input], shape: shape, T: typeT, name: name)
    end
  

    def self.enter(data, typeT: nil, frame_name: nil, is_constant: false, parallel_iterations: 10, name: nil)
    ...
    def self.equal(x, y, typeT: nil, incompatible_shape_error: true, name: nil)
      self.execute("Equal", [x, y], T: typeT, incompatible_shape_error: incompatible_shape_error, name: name)
    end
  

    def self.erf(x, typeT: nil, name: nil)
      self.execute("Erf", [x], T: typeT, name: name)
    end
  

    def self.erfc(x, typeT: nil, name: nil)
      self.execute("Erfc", [x], T: typeT, name: name)
    end
  

    def self.erfinv(x, typeT: nil, name: nil)
      self.execute("Erfinv", [x], T: typeT, name: name)
    end
  

    def self.euclidean_norm(input, reduction_indices, keep_dims: false, typeT: nil, tidx: nil, name: nil)
      self.execute("EuclideanNorm", [input, reduction_indices], keep_dims: keep_dims, T: typeT, Tidx: tidx, name: name)
    end
  

    def self.exit(data, typeT: nil, name: nil)
      self.execute("Exit", [data], T: typeT, name: name)
    end
  

    def self.exp(x, typeT: nil, name: nil)
      self.execute("Exp", [x], T: typeT, name: name)
    end
  

    def self.expand_dims(input, dim, typeT: nil, tdim: nil, name: nil)
      self.execute("ExpandDims", [input, dim], T: typeT, Tdim: tdim, name: name)
    end
  

    def self.experimental_assert_next_dataset(input_dataset, transformations, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_auto_shard_dataset(input_dataset, num_workers, index, auto_shard_policy: 0, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_bytes_produced_stats_dataset(input_dataset, tag, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_csv_dataset(filenames, compression_type, buffer_size, header, field_delim, use_quote_delim, na_value, select_cols, record_defaults, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_choose_fastest_dataset(input_datasets, n: nil, num_experiments: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_dataset_cardinality(input_dataset, name: nil)
      self.execute("ExperimentalDatasetCardinality", [input_dataset], name: name)
    end
  

    def self.experimental_dataset_to_tf_record(input_dataset, filename, compression_type, name: nil)
      self.execute("ExperimentalDatasetToTFRecord", [input_dataset, filename, compression_type], name: name)
    end
  

    def self.experimental_dense_to_sparse_batch_dataset(input_dataset, batch_size, row_shape, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_directed_interleave_dataset(selector_input_dataset, data_input_datasets, output_types: nil, output_shapes: nil, n: nil, name: nil)
    ...
    def self.experimental_group_by_reducer_dataset(input_dataset, key_func_other_arguments, init_func_other_arguments, reduce_func_other_arguments, finalize_func_other_arguments, key_func: nil, init_func: nil, reduce_func: nil, finalize_func: nil, tkey_func_other_arguments: nil, tinit_func_other_arguments: nil, treduce_func_other_arguments: nil, tfinalize_func_other_arguments: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_group_by_window_dataset(input_dataset, key_func_other_arguments, reduce_func_other_arguments, window_size_func_other_arguments, key_func: nil, reduce_func: nil, window_size_func: nil, tkey_func_other_arguments: nil, treduce_func_other_arguments: nil, twindow_size_func_other_arguments: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_ignore_errors_dataset(input_dataset, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_iterator_get_device(resource, name: nil)
      self.execute("ExperimentalIteratorGetDevice", [resource], name: name)
    end
  

    def self.experimental_lmdb_dataset(filenames, output_types: nil, output_shapes: nil, name: nil)
      self.execute("ExperimentalLMDBDataset", [filenames], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.experimental_latency_stats_dataset(input_dataset, tag, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_map_and_batch_dataset(input_dataset, other_arguments, batch_size, num_parallel_calls, drop_remainder, f: nil, targuments: nil, output_types: nil, output_shapes: nil, preserve_cardinality: false, name: nil)
    ...
    def self.experimental_map_dataset(input_dataset, other_arguments, f: nil, targuments: nil, output_types: nil, output_shapes: nil, use_inter_op_parallelism: true, preserve_cardinality: false, name: nil)
    ...
    def self.experimental_matching_files_dataset(patterns, name: nil)
      self.execute("ExperimentalMatchingFilesDataset", [patterns], name: name)
    end
  

    def self.experimental_max_intra_op_parallelism_dataset(input_dataset, max_intra_op_parallelism, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_non_serializable_dataset(input_dataset, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_parallel_interleave_dataset(input_dataset, other_arguments, cycle_length, block_length, sloppy, buffer_output_elements, prefetch_input_elements, f: nil, targuments: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_parse_example_dataset(input_dataset, num_parallel_calls, dense_defaults, sparse_keys: nil, dense_keys: nil, sparse_types: nil, tdense: nil, dense_shapes: nil, output_types: nil, output_shapes: nil, sloppy: false, name: nil)
    ...
    def self.experimental_private_thread_pool_dataset(input_dataset, num_threads, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_random_dataset(seed, seed2, output_types: nil, output_shapes: nil, name: nil)
      self.execute("ExperimentalRandomDataset", [seed, seed2], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.experimental_rebatch_dataset(input_dataset, num_replicas, output_types: nil, output_shapes: nil, use_fallback: true, name: nil)
    ...
    def self.experimental_scan_dataset(input_dataset, initial_state, other_arguments, f: nil, tstate: nil, targuments: nil, output_types: nil, output_shapes: nil, preserve_cardinality: false, name: nil)
    ...
    def self.experimental_set_stats_aggregator_dataset(input_dataset, stats_aggregator, tag, counter_prefix, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_sleep_dataset(input_dataset, sleep_microseconds, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_sliding_window_dataset(input_dataset, window_size, window_shift, window_stride, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_sql_dataset(driver_name, data_source_name, query, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_stats_aggregator_handle(container: nil, shared_name: nil, name: nil)
      self.execute("ExperimentalStatsAggregatorHandle", [], container: container, shared_name: shared_name, name: name)
    end
  

    def self.experimental_stats_aggregator_summary(iterator, name: nil)
      self.execute("ExperimentalStatsAggregatorSummary", [iterator], name: name)
    end
  

    def self.experimental_take_while_dataset(input_dataset, other_arguments, predicate: nil, targuments: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_thread_pool_dataset(input_dataset, thread_pool, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.experimental_thread_pool_handle(num_threads: nil, max_intra_op_parallelism: 1, display_name: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.experimental_unbatch_dataset(input_dataset, output_types: nil, output_shapes: nil, name: nil)
      self.execute("ExperimentalUnbatchDataset", [input_dataset], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.experimental_unique_dataset(input_dataset, output_types: nil, output_shapes: nil, name: nil)
      self.execute("ExperimentalUniqueDataset", [input_dataset], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.expm1(x, typeT: nil, name: nil)
      self.execute("Expm1", [x], T: typeT, name: name)
    end
  

    def self.extract_glimpse(input, size, offsets, centered: true, normalized: true, uniform_noise: true, noise: "uniform", name: nil)
    ...
    def self.extract_image_patches(images, ksizes: nil, strides: nil, rates: nil, typeT: nil, padding: nil, name: nil)
      self.execute("ExtractImagePatches", [images], ksizes: ksizes, strides: strides, rates: rates, T: typeT, padding: padding, name: name)
    end
  

    def self.extract_jpeg_shape(contents, output_type: nil, name: nil)
      self.execute("ExtractJpegShape", [contents], output_type: output_type, name: name)
    end
  

    def self.extract_volume_patches(input, ksizes: nil, strides: nil, typeT: nil, padding: nil, name: nil)
      self.execute("ExtractVolumePatches", [input], ksizes: ksizes, strides: strides, T: typeT, padding: padding, name: name)
    end
  

    def self.fft(input, tcomplex: nil, name: nil)
      self.execute("FFT", [input], Tcomplex: tcomplex, name: name)
    end
  

    def self.fft2_d(input, tcomplex: nil, name: nil)
      self.execute("FFT2D", [input], Tcomplex: tcomplex, name: name)
    end
  

    def self.fft3_d(input, tcomplex: nil, name: nil)
      self.execute("FFT3D", [input], Tcomplex: tcomplex, name: name)
    end
  

    def self.fifo_queue(component_types: nil, shapes: [], capacity: -1, container: nil, shared_name: nil, name: nil)
    ...
    def self.fifo_queue_v2(component_types: nil, shapes: [], capacity: -1, container: nil, shared_name: nil, name: nil)
    ...
    def self.fact(name: nil)
      self.execute("Fact", [], name: name)
    end
  

    def self.fake_param(dtype: nil, shape: nil, name: nil)
      self.execute("FakeParam", [], dtype: dtype, shape: shape, name: name)
    end
  

    def self.fake_quant_with_min_max_args(inputs, min: -6.0, max: 6.0, num_bits: 8, narrow_range: false, name: nil)
      self.execute("FakeQuantWithMinMaxArgs", [inputs], min: min, max: max, num_bits: num_bits, narrow_range: narrow_range, name: name)
    end
  

    def self.fake_quant_with_min_max_args_gradient(gradients, inputs, min: -6.0, max: 6.0, num_bits: 8, narrow_range: false, name: nil)
    ...
    def self.fake_quant_with_min_max_vars(inputs, min, max, num_bits: 8, narrow_range: false, name: nil)
      self.execute("FakeQuantWithMinMaxVars", [inputs, min, max], num_bits: num_bits, narrow_range: narrow_range, name: name)
    end
  

    def self.fake_quant_with_min_max_vars_gradient(gradients, inputs, min, max, num_bits: 8, narrow_range: false, name: nil)
    ...
    def self.fake_quant_with_min_max_vars_per_channel(inputs, min, max, num_bits: 8, narrow_range: false, name: nil)
      self.execute("FakeQuantWithMinMaxVarsPerChannel", [inputs, min, max], num_bits: num_bits, narrow_range: narrow_range, name: name)
    end
  

    def self.fake_quant_with_min_max_vars_per_channel_gradient(gradients, inputs, min, max, num_bits: 8, narrow_range: false, name: nil)
    ...
    def self.fake_queue(resource, name: nil)
      self.execute("FakeQueue", [resource], name: name)
    end
  

    def self.fill(dims, value, typeT: nil, index_type: nil, name: nil)
      self.execute("Fill", [dims, value], T: typeT, index_type: index_type, name: name)
    end
  

    def self.filter_by_last_component_dataset(input_dataset, output_types: nil, output_shapes: nil, name: nil)
      self.execute("FilterByLastComponentDataset", [input_dataset], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.filter_dataset(input_dataset, other_arguments, predicate: nil, targuments: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.fingerprint(data, method, typeT: nil, name: nil)
      self.execute("Fingerprint", [data, method], T: typeT, name: name)
    end
  

    def self.fixed_length_record_dataset(filenames, header_bytes, record_bytes, footer_bytes, buffer_size, name: nil)
      self.execute("FixedLengthRecordDataset", [filenames, header_bytes, record_bytes, footer_bytes, buffer_size], name: name)
    end
  

    def self.fixed_length_record_dataset_v2(filenames, header_bytes, record_bytes, footer_bytes, buffer_size, compression_type, name: nil)
    ...
    def self.fixed_length_record_reader(header_bytes: 0, record_bytes: nil, footer_bytes: 0, hop_bytes: 0, container: nil, shared_name: nil, name: nil)
    ...
    def self.fixed_length_record_reader_v2(header_bytes: 0, record_bytes: nil, footer_bytes: 0, hop_bytes: 0, container: nil, shared_name: nil, encoding: nil, name: nil)
    ...
    def self.fixed_unigram_candidate_sampler(true_classes, num_true: nil, num_sampled: nil, unique: nil, range_max: nil, vocab_file: nil, distortion: 1.0, num_reserved_ids: 0, num_shards: 1, shard: 0, unigrams: [], seed: 0, seed2: 0, name: nil)
    ...
    def self.flat_map_dataset(input_dataset, other_arguments, f: nil, targuments: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.floor(x, typeT: nil, name: nil)
      self.execute("Floor", [x], T: typeT, name: name)
    end
  

    def self.floor_div(x, y, typeT: nil, name: nil)
      self.execute("FloorDiv", [x, y], T: typeT, name: name)
    end
  

    def self.floor_mod(x, y, typeT: nil, name: nil)
      self.execute("FloorMod", [x, y], T: typeT, name: name)
    end
  

    def self.flush_summary_writer(writer, name: nil)
      self.execute("FlushSummaryWriter", [writer], name: name)
    end
  

    def self.for(start, limit, delta, input, typeT: nil, body: nil, name: nil)
      self.execute("For", [start, limit, delta, input], T: typeT, body: body, name: name)
    end
  

    def self.fractional_avg_pool(value, pooling_ratio: nil, pseudo_random: false, overlapping: false, deterministic: false, seed: 0, seed2: 0, typeT: nil, name: nil)
    ...
    def self.fractional_avg_pool_grad(orig_input_tensor_shape, out_backprop, row_pooling_sequence, col_pooling_sequence, overlapping: false, typeT: nil, name: nil)
    ...
    def self.fractional_max_pool(value, pooling_ratio: nil, pseudo_random: false, overlapping: false, deterministic: false, seed: 0, seed2: 0, typeT: nil, name: nil)
    ...
    def self.fractional_max_pool_grad(orig_input, orig_output, out_backprop, row_pooling_sequence, col_pooling_sequence, overlapping: false, typeT: nil, name: nil)
    ...
    def self.fused_batch_norm(x, scale, offset, mean, variance, typeT: nil, epsilon: 9.999999747378752e-05, data_format: "NHWC", is_training: true, name: nil)
    ...
    def self.fused_batch_norm_grad(y_backprop, x, scale, reserve_space_1, reserve_space_2, typeT: nil, epsilon: 9.999999747378752e-05, data_format: "NHWC", is_training: true, name: nil)
    ...
    def self.fused_batch_norm_grad_v2(y_backprop, x, scale, reserve_space_1, reserve_space_2, typeT: nil, u: nil, epsilon: 9.999999747378752e-05, data_format: "NHWC", is_training: true, name: nil)
    ...
    def self.fused_batch_norm_grad_v3(y_backprop, x, scale, reserve_space_1, reserve_space_2, reserve_space_3, typeT: nil, u: nil, epsilon: 9.999999747378752e-05, data_format: "NHWC", is_training: true, name: nil)
    ...
    def self.fused_batch_norm_v2(x, scale, offset, mean, variance, typeT: nil, u: nil, epsilon: 9.999999747378752e-05, data_format: "NHWC", is_training: true, name: nil)
    ...
    def self.fused_batch_norm_v3(x, scale, offset, mean, variance, typeT: nil, u: nil, epsilon: 9.999999747378752e-05, data_format: "NHWC", is_training: true, name: nil)
    ...
    def self.fused_pad_conv2_d(input, paddings, filter, typeT: nil, mode: nil, strides: nil, padding: nil, name: nil)
      self.execute("FusedPadConv2D", [input, paddings, filter], T: typeT, mode: mode, strides: strides, padding: padding, name: name)
    end
  

    def self.fused_resize_and_pad_conv2_d(input, size, paddings, filter, typeT: nil, resize_align_corners: false, mode: nil, strides: nil, padding: nil, name: nil)
    ...
    def self.gru_block_cell(x, h_prev, w_ru, w_c, b_ru, b_c, typeT: nil, name: nil)
      self.execute("GRUBlockCell", [x, h_prev, w_ru, w_c, b_ru, b_c], T: typeT, name: name)
    end
  

    def self.gru_block_cell_grad(x, h_prev, w_ru, w_c, b_ru, b_c, r, u, c, d_h, typeT: nil, name: nil)
      self.execute("GRUBlockCellGrad", [x, h_prev, w_ru, w_c, b_ru, b_c, r, u, c, d_h], T: typeT, name: name)
    end
  

    def self.gather(params, indices, validate_indices: true, tparams: nil, tindices: nil, name: nil)
      self.execute("Gather", [params, indices], validate_indices: validate_indices, Tparams: tparams, Tindices: tindices, name: name)
    end
  

    def self.gather_nd(params, indices, tparams: nil, tindices: nil, name: nil)
      self.execute("GatherNd", [params, indices], Tparams: tparams, Tindices: tindices, name: name)
    end
  

    def self.gather_v2(params, indices, axis, batch_dims: 0, tparams: nil, tindices: nil, taxis: nil, name: nil)
      self.execute("GatherV2", [params, indices, axis], batch_dims: batch_dims, Tparams: tparams, Tindices: tindices, Taxis: taxis, name: name)
    end
  

    def self.generate_vocab_remapping(new_vocab_file, old_vocab_file, new_vocab_offset: nil, num_new_vocab: nil, old_vocab_size: -1, name: nil)
    ...
    def self.generator_dataset(init_func_other_args, next_func_other_args, finalize_func_other_args, init_func: nil, next_func: nil, finalize_func: nil, tinit_func_args: nil, tnext_func_args: nil, tfinalize_func_args: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.get_session_handle(value, typeT: nil, name: nil)
      self.execute("GetSessionHandle", [value], T: typeT, name: name)
    end
  

    def self.get_session_handle_v2(value, typeT: nil, name: nil)
      self.execute("GetSessionHandleV2", [value], T: typeT, name: name)
    end
  

    def self.get_session_tensor(handle, dtype: nil, name: nil)
      self.execute("GetSessionTensor", [handle], dtype: dtype, name: name)
    end
  

    def self.greater(x, y, typeT: nil, name: nil)
      self.execute("Greater", [x, y], T: typeT, name: name)
    end
  

    def self.greater_equal(x, y, typeT: nil, name: nil)
      self.execute("GreaterEqual", [x, y], T: typeT, name: name)
    end
  

    def self.group_by_reducer_dataset(input_dataset, key_func_other_arguments, init_func_other_arguments, reduce_func_other_arguments, finalize_func_other_arguments, key_func: nil, init_func: nil, reduce_func: nil, finalize_func: nil, tkey_func_other_arguments: nil, tinit_func_other_arguments: nil, treduce_func_other_arguments: nil, tfinalize_func_other_arguments: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.guarantee_const(input, typeT: nil, name: nil)
      self.execute("GuaranteeConst", [input], T: typeT, name: name)
    end
  

    def self.hsv_to_rgb(images, typeT: nil, name: nil)
      self.execute("HSVToRGB", [images], T: typeT, name: name)
    end
  

    def self.hash_table(container: nil, shared_name: nil, use_node_name_sharing: false, key_dtype: nil, value_dtype: nil, name: nil)
    ...
    def self.hash_table_v2(container: nil, shared_name: nil, use_node_name_sharing: false, key_dtype: nil, value_dtype: nil, name: nil)
    ...
    def self.initialize_table(table_handle, keys, values, tkey: nil, tval: nil, name: nil)
      self.execute("InitializeTable", [table_handle, keys, values], Tkey: tkey, Tval: tval, name: name)
    end
  

    def self.initialize_table_from_text_file(table_handle, filename, key_index: nil, value_index: nil, vocab_size: -1, delimiter: "	", name: nil)
    ...
    def self.initialize_table_from_text_file_v2(table_handle, filename, key_index: nil, value_index: nil, vocab_size: -1, delimiter: "	", name: nil)
    ...
    def self.initialize_table_v2(table_handle, keys, values, tkey: nil, tval: nil, name: nil)
      self.execute("InitializeTableV2", [table_handle, keys, values], Tkey: tkey, Tval: tval, name: name)
    end
  

    def self.inplace_add(x, i, v, typeT: nil, name: nil)
      self.execute("InplaceAdd", [x, i, v], T: typeT, name: name)
    end
  

    def self.inplace_sub(x, i, v, typeT: nil, name: nil)
      self.execute("InplaceSub", [x, i, v], T: typeT, name: name)
    end
  

    def self.inplace_update(x, i, v, typeT: nil, name: nil)
      self.execute("InplaceUpdate", [x, i, v], T: typeT, name: name)
    end
  

    def self.interleave_dataset(input_dataset, other_arguments, cycle_length, block_length, f: nil, targuments: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.inv(x, typeT: nil, name: nil)
      self.execute("Inv", [x], T: typeT, name: name)
    end
  

    def self.inv_grad(y, dy, typeT: nil, name: nil)
      self.execute("InvGrad", [y, dy], T: typeT, name: name)
    end
  

    def self.invert(x, typeT: nil, name: nil)
      self.execute("Invert", [x], T: typeT, name: name)
    end
  

    def self.invert_permutation(x, typeT: nil, name: nil)
      self.execute("InvertPermutation", [x], T: typeT, name: name)
    end
  

    def self.is_boosted_trees_ensemble_initialized(tree_ensemble_handle, name: nil)
      self.execute("IsBoostedTreesEnsembleInitialized", [tree_ensemble_handle], name: name)
    end
  

    def self.is_boosted_trees_quantile_stream_resource_initialized(quantile_stream_resource_handle, name: nil)
      self.execute("IsBoostedTreesQuantileStreamResourceInitialized", [quantile_stream_resource_handle], name: name)
    end
  

    def self.is_finite(x, typeT: nil, name: nil)
      self.execute("IsFinite", [x], T: typeT, name: name)
    end
  

    def self.is_inf(x, typeT: nil, name: nil)
      self.execute("IsInf", [x], T: typeT, name: name)
    end
  

    def self.is_nan(x, typeT: nil, name: nil)
      self.execute("IsNan", [x], T: typeT, name: name)
    end
  

    def self.is_variable_initialized(ref, dtype: nil, name: nil)
      self.execute("IsVariableInitialized", [ref], dtype: dtype, name: name)
    end
  

    def self.iterator(shared_name: nil, container: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.kmc2_chain_initialization(distances, seed, name: nil)
      self.execute("KMC2ChainInitialization", [distances, seed], name: name)
    end
  

    def self.kmeans_plus_plus_initialization(points, num_to_sample, seed, num_retries_per_sample, name: nil)
      self.execute("KmeansPlusPlusInitialization", [points, num_to_sample, seed, num_retries_per_sample], name: name)
    end
  

    def self.l2_loss(t, typeT: nil, name: nil)
      self.execute("L2Loss", [t], T: typeT, name: name)
    end
  

    def self.lmdb_dataset(filenames, output_types: nil, output_shapes: nil, name: nil)
      self.execute("LMDBDataset", [filenames], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.lmdb_reader(container: nil, shared_name: nil, name: nil)
      self.execute("LMDBReader", [], container: container, shared_name: shared_name, name: name)
    end
  

    def self.lrn(input, depth_radius: 5, bias: 1.0, alpha: 1.0, beta: 0.5, typeT: nil, name: nil)
      self.execute("LRN", [input], depth_radius: depth_radius, bias: bias, alpha: alpha, beta: beta, T: typeT, name: name)
    end
  

    def self.lrn_grad(input_grads, input_image, output_image, depth_radius: 5, bias: 1.0, alpha: 1.0, beta: 0.5, typeT: nil, name: nil)
    ...
    def self.lstm_block_cell(x, cs_prev, h_prev, w, wci, wcf, wco, b, forget_bias: 1.0, cell_clip: 3.0, use_peephole: false, typeT: nil, name: nil)
    ...
    def self.lstm_block_cell_grad(x, cs_prev, h_prev, w, wci, wcf, wco, b, i, cs, f, o, ci, co, cs_grad, h_grad, use_peephole: nil, typeT: nil, name: nil)
    ...
    def self.latency_stats_dataset(input_dataset, tag, output_types: nil, output_shapes: nil, name: nil)
      self.execute("LatencyStatsDataset", [input_dataset, tag], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.leaky_relu(features, alpha: 0.20000000298023224, typeT: nil, name: nil)
      self.execute("LeakyRelu", [features], alpha: alpha, T: typeT, name: name)
    end
  

    def self.leaky_relu_grad(gradients, features, alpha: 0.20000000298023224, typeT: nil, name: nil)
      self.execute("LeakyReluGrad", [gradients, features], alpha: alpha, T: typeT, name: name)
    end
  

    def self.learned_unigram_candidate_sampler(true_classes, num_true: nil, num_sampled: nil, unique: nil, range_max: nil, seed: 0, seed2: 0, name: nil)
    ...
    def self.left_shift(x, y, typeT: nil, name: nil)
      self.execute("LeftShift", [x, y], T: typeT, name: name)
    end
  

    def self.less(x, y, typeT: nil, name: nil)
      self.execute("Less", [x, y], T: typeT, name: name)
    end
  

    def self.less_equal(x, y, typeT: nil, name: nil)
      self.execute("LessEqual", [x, y], T: typeT, name: name)
    end
  

    def self.lgamma(x, typeT: nil, name: nil)
      self.execute("Lgamma", [x], T: typeT, name: name)
    end
  

    def self.lin_space(start, stop, num, typeT: nil, tidx: nil, name: nil)
      self.execute("LinSpace", [start, stop, num], T: typeT, Tidx: tidx, name: name)
    end
  

    def self.list_diff(x, y, typeT: nil, out_idx: nil, name: nil)
      self.execute("ListDiff", [x, y], T: typeT, out_idx: out_idx, name: name)
    end
  

    def self.load_and_remap_matrix(ckpt_path, old_tensor_name, row_remapping, col_remapping, initializing_values, num_rows: nil, num_cols: nil, max_rows_in_memory: -1, name: nil)
    ...
    def self.load_tpu_embedding_adam_parameters(parameters, momenta, velocities, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_adam_parameters_grad_accum_debug(parameters, momenta, velocities, gradient_accumulators, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_adadelta_parameters(parameters, accumulators, updates, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_adadelta_parameters_grad_accum_debug(parameters, accumulators, updates, gradient_accumulators, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_adagrad_parameters(parameters, accumulators, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_adagrad_parameters_grad_accum_debug(parameters, accumulators, gradient_accumulators, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_centered_rms_prop_parameters(parameters, ms, mom, mg, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_ftrl_parameters(parameters, accumulators, linears, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_ftrl_parameters_grad_accum_debug(parameters, accumulators, linears, gradient_accumulators, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_mdl_adagrad_light_parameters(parameters, accumulators, weights, benefits, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_momentum_parameters(parameters, momenta, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_momentum_parameters_grad_accum_debug(parameters, momenta, gradient_accumulators, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_proximal_adagrad_parameters(parameters, accumulators, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_proximal_adagrad_parameters_grad_accum_debug(parameters, accumulators, gradient_accumulators, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_rms_prop_parameters(parameters, ms, mom, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_rms_prop_parameters_grad_accum_debug(parameters, ms, mom, gradient_accumulators, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.load_tpu_embedding_stochastic_gradient_descent_parameters(parameters, table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.log(x, typeT: nil, name: nil)
      self.execute("Log", [x], T: typeT, name: name)
    end
  

    def self.log1p(x, typeT: nil, name: nil)
      self.execute("Log1p", [x], T: typeT, name: name)
    end
  

    def self.log_matrix_determinant(input, typeT: nil, name: nil)
      self.execute("LogMatrixDeterminant", [input], T: typeT, name: name)
    end
  

    def self.log_softmax(logits, typeT: nil, name: nil)
      self.execute("LogSoftmax", [logits], T: typeT, name: name)
    end
  

    def self.log_uniform_candidate_sampler(true_classes, num_true: nil, num_sampled: nil, unique: nil, range_max: nil, seed: 0, seed2: 0, name: nil)
    ...
    def self.logical_and(x, y, name: nil)
      self.execute("LogicalAnd", [x, y], name: name)
    end
  

    def self.logical_not(x, name: nil)
      self.execute("LogicalNot", [x], name: name)
    end
  

    def self.logical_or(x, y, name: nil)
      self.execute("LogicalOr", [x, y], name: name)
    end
  

    def self.lookup_table_export(table_handle, tkeys: nil, tvalues: nil, name: nil)
      self.execute("LookupTableExport", [table_handle], Tkeys: tkeys, Tvalues: tvalues, name: name)
    end
  

    def self.lookup_table_export_v2(table_handle, tkeys: nil, tvalues: nil, name: nil)
      self.execute("LookupTableExportV2", [table_handle], Tkeys: tkeys, Tvalues: tvalues, name: name)
    end
  

    def self.lookup_table_find(table_handle, keys, default_value, tin: nil, tout: nil, name: nil)
      self.execute("LookupTableFind", [table_handle, keys, default_value], Tin: tin, Tout: tout, name: name)
    end
  

    def self.lookup_table_find_v2(table_handle, keys, default_value, tin: nil, tout: nil, name: nil)
      self.execute("LookupTableFindV2", [table_handle, keys, default_value], Tin: tin, Tout: tout, name: name)
    end
  

    def self.lookup_table_import(table_handle, keys, values, tin: nil, tout: nil, name: nil)
      self.execute("LookupTableImport", [table_handle, keys, values], Tin: tin, Tout: tout, name: name)
    end
  

    def self.lookup_table_import_v2(table_handle, keys, values, tin: nil, tout: nil, name: nil)
      self.execute("LookupTableImportV2", [table_handle, keys, values], Tin: tin, Tout: tout, name: name)
    end
  

    def self.lookup_table_insert(table_handle, keys, values, tin: nil, tout: nil, name: nil)
      self.execute("LookupTableInsert", [table_handle, keys, values], Tin: tin, Tout: tout, name: name)
    end
  

    def self.lookup_table_insert_v2(table_handle, keys, values, tin: nil, tout: nil, name: nil)
      self.execute("LookupTableInsertV2", [table_handle, keys, values], Tin: tin, Tout: tout, name: name)
    end
  

    def self.lookup_table_remove_v2(table_handle, keys, tin: nil, name: nil)
      self.execute("LookupTableRemoveV2", [table_handle, keys], Tin: tin, name: name)
    end
  

    def self.lookup_table_size(table_handle, name: nil)
      self.execute("LookupTableSize", [table_handle], name: name)
    end
  

    def self.lookup_table_size_v2(table_handle, name: nil)
      self.execute("LookupTableSizeV2", [table_handle], name: name)
    end
  

    def self.loop_cond(input, name: nil)
      self.execute("LoopCond", [input], name: name)
    end
  

    def self.lower_bound(sorted_inputs, values, typeT: nil, out_type: nil, name: nil)
      self.execute("LowerBound", [sorted_inputs, values], T: typeT, out_type: out_type, name: name)
    end
  

    def self.lu(input, typeT: nil, output_idx_type: nil, name: nil)
      self.execute("Lu", [input], T: typeT, output_idx_type: output_idx_type, name: name)
    end
  

    def self.make_iterator(dataset, iterator, name: nil)
      self.execute("MakeIterator", [dataset, iterator], name: name)
    end
  

    def self.map_and_batch_dataset(input_dataset, other_arguments, batch_size, num_parallel_calls, drop_remainder, f: nil, targuments: nil, output_types: nil, output_shapes: nil, preserve_cardinality: false, name: nil)
    ...
    def self.map_clear(capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.map_dataset(input_dataset, other_arguments, f: nil, targuments: nil, output_types: nil, output_shapes: nil, use_inter_op_parallelism: true, preserve_cardinality: false, name: nil)
    ...
    def self.map_defun(arguments, captured_inputs, targuments: nil, tcaptured: [], output_types: nil, output_shapes: nil, f: nil, max_intra_op_parallelism: 1, name: nil)
    ...
    def self.map_incomplete_size(capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.map_peek(key, indices, capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.map_size(capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.map_stage(key, indices, values, capacity: 0, memory_limit: 0, dtypes: nil, fake_dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.map_unstage(key, indices, capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.map_unstage_no_key(indices, capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.mat_mul(a, b, transpose_a: false, transpose_b: false, typeT: nil, name: nil)
      self.execute("MatMul", [a, b], transpose_a: transpose_a, transpose_b: transpose_b, T: typeT, name: name)
    end
  

    def self.matching_files(pattern, name: nil)
      self.execute("MatchingFiles", [pattern], name: name)
    end
  

    def self.matching_files_dataset(patterns, name: nil)
      self.execute("MatchingFilesDataset", [patterns], name: name)
    end
  

    def self.matrix_band_part(input, num_lower, num_upper, typeT: nil, tindex: nil, name: nil)
      self.execute("MatrixBandPart", [input, num_lower, num_upper], T: typeT, Tindex: tindex, name: name)
    end
  

    def self.matrix_determinant(input, typeT: nil, name: nil)
      self.execute("MatrixDeterminant", [input], T: typeT, name: name)
    end
  

    def self.matrix_diag(diagonal, typeT: nil, name: nil)
      self.execute("MatrixDiag", [diagonal], T: typeT, name: name)
    end
  

    def self.matrix_diag_part(input, typeT: nil, name: nil)
      self.execute("MatrixDiagPart", [input], T: typeT, name: name)
    end
  

    def self.matrix_diag_part_v2(input, k, padding_value, typeT: nil, name: nil)
      self.execute("MatrixDiagPartV2", [input, k, padding_value], T: typeT, name: name)
    end
  

    def self.matrix_diag_v2(diagonal, k, num_rows, num_cols, padding_value, typeT: nil, name: nil)
      self.execute("MatrixDiagV2", [diagonal, k, num_rows, num_cols, padding_value], T: typeT, name: name)
    end
  

    def self.matrix_exponential(input, typeT: nil, name: nil)
      self.execute("MatrixExponential", [input], T: typeT, name: name)
    end
  

    def self.matrix_inverse(input, adjoint: false, typeT: nil, name: nil)
      self.execute("MatrixInverse", [input], adjoint: adjoint, T: typeT, name: name)
    end
  

    def self.matrix_logarithm(input, typeT: nil, name: nil)
      self.execute("MatrixLogarithm", [input], T: typeT, name: name)
    end
  

    def self.matrix_set_diag(input, diagonal, typeT: nil, name: nil)
      self.execute("MatrixSetDiag", [input, diagonal], T: typeT, name: name)
    end
  

    def self.matrix_set_diag_v2(input, diagonal, k, typeT: nil, name: nil)
      self.execute("MatrixSetDiagV2", [input, diagonal, k], T: typeT, name: name)
    end
  

    def self.matrix_solve(matrix, rhs, adjoint: false, typeT: nil, name: nil)
      self.execute("MatrixSolve", [matrix, rhs], adjoint: adjoint, T: typeT, name: name)
    end
  

    def self.matrix_solve_ls(matrix, rhs, l2_regularizer, typeT: nil, fast: true, name: nil)
      self.execute("MatrixSolveLs", [matrix, rhs, l2_regularizer], T: typeT, fast: fast, name: name)
    end
  

    def self.matrix_square_root(input, typeT: nil, name: nil)
      self.execute("MatrixSquareRoot", [input], T: typeT, name: name)
    end
  

    def self.matrix_triangular_solve(matrix, rhs, lower: true, adjoint: false, typeT: nil, name: nil)
      self.execute("MatrixTriangularSolve", [matrix, rhs], lower: lower, adjoint: adjoint, T: typeT, name: name)
    end
  

    def self.max(input, reduction_indices, keep_dims: false, typeT: nil, tidx: nil, name: nil)
      self.execute("Max", [input, reduction_indices], keep_dims: keep_dims, T: typeT, Tidx: tidx, name: name)
    end
  

    def self.max_intra_op_parallelism_dataset(input_dataset, max_intra_op_parallelism, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.max_pool(input, typeT: nil, ksize: nil, strides: nil, padding: nil, data_format: "NHWC", name: nil)
      self.execute("MaxPool", [input], T: typeT, ksize: ksize, strides: strides, padding: padding, data_format: data_format, name: name)
    end
  

    def self.max_pool3_d(input, ksize: nil, strides: nil, padding: nil, data_format: "NDHWC", typeT: nil, name: nil)
      self.execute("MaxPool3D", [input], ksize: ksize, strides: strides, padding: padding, data_format: data_format, T: typeT, name: name)
    end
  

    def self.max_pool3_d_grad(orig_input, orig_output, grad, ksize: nil, strides: nil, padding: nil, data_format: "NDHWC", typeT: nil, tinput: nil, name: nil)
    ...
    def self.max_pool3_d_grad_grad(orig_input, orig_output, grad, ksize: nil, strides: nil, padding: nil, data_format: "NDHWC", typeT: nil, name: nil)
    ...
    def self.max_pool_grad(orig_input, orig_output, grad, ksize: nil, strides: nil, padding: nil, data_format: "NHWC", typeT: nil, name: nil)
    ...
    def self.max_pool_grad_grad(orig_input, orig_output, grad, ksize: nil, strides: nil, padding: nil, data_format: "NHWC", typeT: nil, name: nil)
    ...
    def self.max_pool_grad_grad_v2(orig_input, orig_output, grad, ksize, strides, padding: nil, data_format: "NHWC", typeT: nil, name: nil)
    ...
    def self.max_pool_grad_grad_with_argmax(input, grad, argmax, ksize: nil, strides: nil, padding: nil, include_batch_in_index: false, targmax: nil, typeT: nil, name: nil)
    ...
    def self.max_pool_grad_v2(orig_input, orig_output, grad, ksize, strides, padding: nil, data_format: "NHWC", typeT: nil, name: nil)
    ...
    def self.max_pool_grad_with_argmax(input, grad, argmax, ksize: nil, strides: nil, padding: nil, include_batch_in_index: false, targmax: nil, typeT: nil, name: nil)
    ...
    def self.max_pool_v2(input, ksize, strides, typeT: nil, padding: nil, data_format: "NHWC", name: nil)
      self.execute("MaxPoolV2", [input, ksize, strides], T: typeT, padding: padding, data_format: data_format, name: name)
    end
  

    def self.max_pool_with_argmax(input, ksize: nil, strides: nil, targmax: nil, padding: nil, include_batch_in_index: false, typeT: nil, name: nil)
    ...
    def self.maximum(x, y, typeT: nil, name: nil)
      self.execute("Maximum", [x, y], T: typeT, name: name)
    end
  

    def self.mean(input, reduction_indices, keep_dims: false, typeT: nil, tidx: nil, name: nil)
      self.execute("Mean", [input, reduction_indices], keep_dims: keep_dims, T: typeT, Tidx: tidx, name: name)
    end
  

    def self.merge(inputs, typeT: nil, n: nil, name: nil)
      self.execute("Merge", [inputs], T: typeT, N: n, name: name)
    end
  

    def self.merge_summary(inputs, n: nil, name: nil)
      self.execute("MergeSummary", [inputs], N: n, name: name)
    end
  

    def self.merge_v2_checkpoints(checkpoint_prefixes, destination_prefix, delete_old_dirs: true, name: nil)
      self.execute("MergeV2Checkpoints", [checkpoint_prefixes, destination_prefix], delete_old_dirs: delete_old_dirs, name: name)
    end
  

    def self.mfcc(spectrogram, sample_rate, upper_frequency_limit: 4000.0, lower_frequency_limit: 20.0, filterbank_channel_count: 40, dct_coefficient_count: 13, name: nil)
    ...
    def self.min(input, reduction_indices, keep_dims: false, typeT: nil, tidx: nil, name: nil)
      self.execute("Min", [input, reduction_indices], keep_dims: keep_dims, T: typeT, Tidx: tidx, name: name)
    end
  

    def self.minimum(x, y, typeT: nil, name: nil)
      self.execute("Minimum", [x, y], T: typeT, name: name)
    end
  

    def self.mirror_pad(input, paddings, typeT: nil, tpaddings: nil, mode: nil, name: nil)
      self.execute("MirrorPad", [input, paddings], T: typeT, Tpaddings: tpaddings, mode: mode, name: name)
    end
  

    def self.mirror_pad_grad(input, paddings, typeT: nil, tpaddings: nil, mode: nil, name: nil)
      self.execute("MirrorPadGrad", [input, paddings], T: typeT, Tpaddings: tpaddings, mode: mode, name: name)
    end
  

    def self.mlir_passthrough_op(inputs, mlir_module: nil, tinputs: nil, toutputs: nil, name: nil)
      self.execute("MlirPassthroughOp", [inputs], mlir_module: mlir_module, Tinputs: tinputs, Toutputs: toutputs, name: name)
    end
  

    def self.mod(x, y, typeT: nil, name: nil)
      self.execute("Mod", [x, y], T: typeT, name: name)
    end
  

    def self.model_dataset(input_dataset, algorithm: 0, cpu_budget: 0, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.mul(x, y, typeT: nil, name: nil)
      self.execute("Mul", [x, y], T: typeT, name: name)
    end
  

    def self.mul_no_nan(x, y, typeT: nil, name: nil)
      self.execute("MulNoNan", [x, y], T: typeT, name: name)
    end
  

    def self.multi_device_iterator(devices: nil, shared_name: nil, container: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.multi_device_iterator_from_string_handle(string_handle, output_types: [], output_shapes: [], name: nil)
    ...
    def self.multi_device_iterator_get_next_from_shard(multi_device_iterator, shard_num, incarnation_id, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.multi_device_iterator_init(dataset, multi_device_iterator, max_buffer_size, name: nil)
      self.execute("MultiDeviceIteratorInit", [dataset, multi_device_iterator, max_buffer_size], name: name)
    end
  

    def self.multi_device_iterator_to_string_handle(multi_device_iterator, name: nil)
      self.execute("MultiDeviceIteratorToStringHandle", [multi_device_iterator], name: name)
    end
  

    def self.multinomial(logits, num_samples, seed: 0, seed2: 0, typeT: nil, output_dtype: nil, name: nil)
      self.execute("Multinomial", [logits, num_samples], seed: seed, seed2: seed2, T: typeT, output_dtype: output_dtype, name: name)
    end
  

    def self.mutable_dense_hash_table(empty_key, container: nil, shared_name: nil, use_node_name_sharing: false, key_dtype: nil, value_dtype: nil, value_shape: [], initial_num_buckets: 131072, max_load_factor: 0.800000011920929, name: nil)
    ...
    def self.mutable_dense_hash_table_v2(empty_key, deleted_key, container: nil, shared_name: nil, use_node_name_sharing: false, key_dtype: nil, value_dtype: nil, value_shape: [], initial_num_buckets: 131072, max_load_factor: 0.800000011920929, name: nil)
    ...
    def self.mutable_hash_table(container: nil, shared_name: nil, use_node_name_sharing: false, key_dtype: nil, value_dtype: nil, name: nil)
    ...
    def self.mutable_hash_table_of_tensors(container: nil, shared_name: nil, use_node_name_sharing: false, key_dtype: nil, value_dtype: nil, value_shape: [], name: nil)
    ...
    def self.mutable_hash_table_of_tensors_v2(container: nil, shared_name: nil, use_node_name_sharing: false, key_dtype: nil, value_dtype: nil, value_shape: [], name: nil)
    ...
    def self.mutable_hash_table_v2(container: nil, shared_name: nil, use_node_name_sharing: false, key_dtype: nil, value_dtype: nil, name: nil)
    ...
    def self.mutex_lock(mutex, name: nil)
      self.execute("MutexLock", [mutex], name: name)
    end
  

    def self.mutex_v2(container: nil, shared_name: nil, name: nil)
      self.execute("MutexV2", [], container: container, shared_name: shared_name, name: name)
    end
  

    def self.nccl_all_reduce(input, reduction: nil, typeT: nil, num_devices: nil, shared_name: nil, name: nil)
      self.execute("NcclAllReduce", [input], reduction: reduction, T: typeT, num_devices: num_devices, shared_name: shared_name, name: name)
    end
  

    def self.nccl_broadcast(input, typeT: nil, shape: nil, name: nil)
      self.execute("NcclBroadcast", [input], T: typeT, shape: shape, name: name)
    end
  

    def self.nccl_reduce(input, reduction: nil, typeT: nil, num_devices: nil, name: nil)
      self.execute("NcclReduce", [input], reduction: reduction, T: typeT, num_devices: num_devices, name: name)
    end
  

    def self.ndtri(x, typeT: nil, name: nil)
      self.execute("Ndtri", [x], T: typeT, name: name)
    end
  

    def self.nearest_neighbors(points, centers, k, name: nil)
      self.execute("NearestNeighbors", [points, centers, k], name: name)
    end
  

    def self.neg(x, typeT: nil, name: nil)
      self.execute("Neg", [x], T: typeT, name: name)
    end
  

    def self.neg_train(w_in, w_out, examples, labels, lr, vocab_count: nil, num_negative_samples: nil, name: nil)
    ...
    def self.next_after(x1, x2, typeT: nil, name: nil)
      self.execute("NextAfter", [x1, x2], T: typeT, name: name)
    end
  

    def self.next_iteration(data, typeT: nil, name: nil)
      self.execute("NextIteration", [data], T: typeT, name: name)
    end
  

    def self.no_op(name: nil)
      self.execute("NoOp", [], name: name)
    end
  

    def self.non_deterministic_ints(shape, dtype: nil, shape_dtype: nil, name: nil)
      self.execute("NonDeterministicInts", [shape], dtype: dtype, shape_dtype: shape_dtype, name: name)
    end
  

    def self.non_max_suppression(boxes, scores, max_output_size, iou_threshold: 0.5, name: nil)
      self.execute("NonMaxSuppression", [boxes, scores, max_output_size], iou_threshold: iou_threshold, name: name)
    end
  

    def self.non_max_suppression_v2(boxes, scores, max_output_size, iou_threshold, typeT: nil, t_threshold: nil, name: nil)
      self.execute("NonMaxSuppressionV2", [boxes, scores, max_output_size, iou_threshold], T: typeT, T_threshold: t_threshold, name: name)
    end
  

    def self.non_max_suppression_v3(boxes, scores, max_output_size, iou_threshold, score_threshold, typeT: nil, t_threshold: nil, name: nil)
    ...
    def self.non_max_suppression_v4(boxes, scores, max_output_size, iou_threshold, score_threshold, typeT: nil, t_threshold: nil, pad_to_max_output_size: false, name: nil)
    ...
    def self.non_max_suppression_v5(boxes, scores, max_output_size, iou_threshold, score_threshold, soft_nms_sigma, typeT: nil, pad_to_max_output_size: false, name: nil)
    ...
    def self.non_max_suppression_with_overlaps(overlaps, scores, max_output_size, overlap_threshold, score_threshold, name: nil)
      self.execute("NonMaxSuppressionWithOverlaps", [overlaps, scores, max_output_size, overlap_threshold, score_threshold], name: name)
    end
  

    def self.non_serializable_dataset(input_dataset, output_types: nil, output_shapes: nil, name: nil)
      self.execute("NonSerializableDataset", [input_dataset], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.not_equal(x, y, typeT: nil, incompatible_shape_error: true, name: nil)
      self.execute("NotEqual", [x, y], T: typeT, incompatible_shape_error: incompatible_shape_error, name: name)
    end
  

    def self.nth_element(input, n, reverse: false, typeT: nil, name: nil)
      self.execute("NthElement", [input, n], reverse: reverse, T: typeT, name: name)
    end
  

    def self.one_hot(indices, depth, on_value, off_value, axis: -1, typeT: nil, ti: nil, name: nil)
      self.execute("OneHot", [indices, depth, on_value, off_value], axis: axis, T: typeT, TI: ti, name: name)
    end
  

    def self.one_shot_iterator(dataset_factory: nil, output_types: nil, output_shapes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.ones_like(x, typeT: nil, name: nil)
      self.execute("OnesLike", [x], T: typeT, name: name)
    end
  

    def self.optimize_dataset(input_dataset, optimizations, output_types: nil, output_shapes: nil, optimization_configs: [], name: nil)
    ...
    def self.optional_from_value(components, toutput_types: nil, name: nil)
      self.execute("OptionalFromValue", [components], Toutput_types: toutput_types, name: name)
    end
  

    def self.optional_get_value(optional, output_types: nil, output_shapes: nil, name: nil)
      self.execute("OptionalGetValue", [optional], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.optional_has_value(optional, name: nil)
      self.execute("OptionalHasValue", [optional], name: name)
    end
  

    def self.optional_none(name: nil)
      self.execute("OptionalNone", [], name: name)
    end
  

    def self.ordered_map_clear(capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.ordered_map_incomplete_size(capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.ordered_map_peek(key, indices, capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.ordered_map_size(capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.ordered_map_stage(key, indices, values, capacity: 0, memory_limit: 0, dtypes: nil, fake_dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.ordered_map_unstage(key, indices, capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.ordered_map_unstage_no_key(indices, capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.outfeed_dequeue(dtype: nil, shape: nil, device_ordinal: -1, name: nil)
      self.execute("OutfeedDequeue", [], dtype: dtype, shape: shape, device_ordinal: device_ordinal, name: name)
    end
  

    def self.outfeed_dequeue_tuple(dtypes: nil, shapes: nil, device_ordinal: -1, name: nil)
      self.execute("OutfeedDequeueTuple", [], dtypes: dtypes, shapes: shapes, device_ordinal: device_ordinal, name: name)
    end
  

    def self.outfeed_enqueue(input, dtype: nil, name: nil)
      self.execute("OutfeedEnqueue", [input], dtype: dtype, name: name)
    end
  

    def self.outfeed_enqueue_tuple(inputs, dtypes: nil, name: nil)
      self.execute("OutfeedEnqueueTuple", [inputs], dtypes: dtypes, name: name)
    end
  

    def self.pack(values, n: nil, typeT: nil, axis: 0, name: nil)
      self.execute("Pack", [values], N: n, T: typeT, axis: axis, name: name)
    end
  

    def self.pad(input, paddings, typeT: nil, tpaddings: nil, name: nil)
      self.execute("Pad", [input, paddings], T: typeT, Tpaddings: tpaddings, name: name)
    end
  

    def self.pad_v2(input, paddings, constant_values, typeT: nil, tpaddings: nil, name: nil)
      self.execute("PadV2", [input, paddings, constant_values], T: typeT, Tpaddings: tpaddings, name: name)
    end
  

    def self.padded_batch_dataset(input_dataset, batch_size, padded_shapes, padding_values, toutput_types: nil, output_shapes: nil, n: nil, name: nil)
    ...
    def self.padded_batch_dataset_v2(input_dataset, batch_size, padded_shapes, padding_values, drop_remainder, parallel_copy: false, toutput_types: nil, output_shapes: nil, n: nil, name: nil)
    ...
    def self.padding_fifo_queue(component_types: nil, shapes: [], capacity: -1, container: nil, shared_name: nil, name: nil)
    ...
    def self.padding_fifo_queue_v2(component_types: nil, shapes: [], capacity: -1, container: nil, shared_name: nil, name: nil)
    ...
    def self.parallel_concat(values, n: nil, typeT: nil, shape: nil, name: nil)
      self.execute("ParallelConcat", [values], N: n, T: typeT, shape: shape, name: name)
    end
  

    def self.parallel_dynamic_stitch(indices, data, n: nil, typeT: nil, name: nil)
      self.execute("ParallelDynamicStitch", [indices, data], N: n, T: typeT, name: name)
    end
  

    def self.parallel_interleave_dataset(input_dataset, other_arguments, cycle_length, block_length, sloppy, buffer_output_elements, prefetch_input_elements, f: nil, targuments: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.parallel_interleave_dataset_v2(input_dataset, other_arguments, cycle_length, block_length, num_parallel_calls, f: nil, targuments: nil, output_types: nil, output_shapes: nil, sloppy: false, name: nil)
    ...
    def self.parallel_map_dataset(input_dataset, other_arguments, num_parallel_calls, f: nil, targuments: nil, output_types: nil, output_shapes: nil, use_inter_op_parallelism: true, sloppy: false, preserve_cardinality: false, name: nil)
    ...
    def self.parameterized_truncated_normal(shape, means, stdevs, minvals, maxvals, seed: 0, seed2: 0, dtype: nil, typeT: nil, name: nil)
    ...
    def self.parse_example(serialized, names, sparse_keys, dense_keys, dense_defaults, nsparse: nil, ndense: nil, sparse_types: nil, tdense: nil, dense_shapes: nil, name: nil)
    ...
    def self.parse_example_dataset(input_dataset, num_parallel_calls, dense_defaults, sparse_keys: nil, dense_keys: nil, sparse_types: nil, tdense: nil, dense_shapes: nil, output_types: nil, output_shapes: nil, sloppy: false, ragged_keys: [], ragged_value_types: [], ragged_split_types: [], name: nil)
    ...
    def self.parse_example_v2(serialized, names, sparse_keys, dense_keys, ragged_keys, dense_defaults, tdense: nil, num_sparse: nil, sparse_types: nil, ragged_value_types: nil, ragged_split_types: nil, dense_shapes: nil, name: nil)
    ...
    def self.parse_single_example(serialized, dense_defaults, num_sparse: nil, sparse_keys: nil, dense_keys: nil, sparse_types: nil, tdense: nil, dense_shapes: nil, name: nil)
    ...
    def self.parse_tensor(serialized, out_type: nil, name: nil)
      self.execute("ParseTensor", [serialized], out_type: out_type, name: name)
    end
  

    def self.partitioned_call(args, tin: nil, tout: nil, f: nil, config: nil, config_proto: nil, executor_type: nil, name: nil)
    ...
    def self.placeholder_v2(dtype: nil, shape: nil, name: nil)
      self.execute("PlaceholderV2", [], dtype: dtype, shape: shape, name: name)
    end
  

    def self.placeholder_with_default(input, dtype: nil, shape: nil, name: nil)
      self.execute("PlaceholderWithDefault", [input], dtype: dtype, shape: shape, name: name)
    end
  

    def self.polygamma(a, x, typeT: nil, name: nil)
      self.execute("Polygamma", [a, x], T: typeT, name: name)
    end
  

    def self.population_count(x, typeT: nil, name: nil)
      self.execute("PopulationCount", [x], T: typeT, name: name)
    end
  

    def self.pow(x, y, typeT: nil, name: nil)
      self.execute("Pow", [x, y], T: typeT, name: name)
    end
  

    def self.prefetch_dataset(input_dataset, buffer_size, output_types: nil, output_shapes: nil, slack_period: 0, legacy_autotune: true, name: nil)
    ...
    def self.prelinearize(input, dtype: nil, shape: [], layout: [], name: nil)
      self.execute("Prelinearize", [input], dtype: dtype, shape: shape, layout: layout, name: name)
    end
  

    def self.prelinearize_tuple(inputs, dtypes: nil, shapes: nil, layouts: [], name: nil)
      self.execute("PrelinearizeTuple", [inputs], dtypes: dtypes, shapes: shapes, layouts: layouts, name: name)
    end
  

    def self.prevent_gradient(input, typeT: nil, message: nil, name: nil)
      self.execute("PreventGradient", [input], T: typeT, message: message, name: name)
    end
  

    def self.print(input, data, typeT: nil, u: nil, message: nil, first_n: -1, summarize: 3, name: nil)
...
", name: nil)
    ...
    def self.priority_queue(component_types: [], shapes: nil, capacity: -1, container: nil, shared_name: nil, name: nil)
    ...
    def self.priority_queue_v2(component_types: [], shapes: nil, capacity: -1, container: nil, shared_name: nil, name: nil)
    ...
    def self.private_thread_pool_dataset(input_dataset, num_threads, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.prod(input, reduction_indices, keep_dims: false, typeT: nil, tidx: nil, name: nil)
      self.execute("Prod", [input, reduction_indices], keep_dims: keep_dims, T: typeT, Tidx: tidx, name: name)
    end
  

    def self.py_func(input, token: nil, tin: nil, tout: nil, name: nil)
      self.execute("PyFunc", [input], token: token, Tin: tin, Tout: tout, name: name)
    end
  

    def self.py_func_stateless(input, token: nil, tin: nil, tout: nil, name: nil)
      self.execute("PyFuncStateless", [input], token: token, Tin: tin, Tout: tout, name: name)
    end
  

    def self.qr(input, full_matrices: false, typeT: nil, name: nil)
      self.execute("Qr", [input], full_matrices: full_matrices, T: typeT, name: name)
    end
  

    def self.quantize_and_dequantize(input, signed_input: true, num_bits: 8, range_given: false, input_min: 0.0, input_max: 0.0, typeT: nil, name: nil)
    ...
    def self.quantize_and_dequantize_v2(input, input_min, input_max, signed_input: true, num_bits: 8, range_given: false, typeT: nil, round_mode: "HALF_TO_EVEN", narrow_range: false, axis: -1, name: nil)
    ...
    def self.quantize_and_dequantize_v3(input, input_min, input_max, num_bits, signed_input: true, range_given: true, typeT: nil, narrow_range: false, axis: -1, name: nil)
    ...
    def self.quantize_down_and_shrink_range(input, input_min, input_max, tinput: nil, out_type: nil, name: nil)
      self.execute("QuantizeDownAndShrinkRange", [input, input_min, input_max], Tinput: tinput, out_type: out_type, name: name)
    end
  

    def self.quantize_v2(input, min_range, max_range, typeT: nil, mode: "MIN_COMBINED", round_mode: "HALF_AWAY_FROM_ZERO", narrow_range: false, axis: -1, ensure_minimum_range: 0.009999999776482582, name: nil)
    ...
    def self.quantized_add(x, y, min_x, max_x, min_y, max_y, t1: nil, t2: nil, toutput: nil, name: nil)
      self.execute("QuantizedAdd", [x, y, min_x, max_x, min_y, max_y], T1: t1, T2: t2, Toutput: toutput, name: name)
    end
  

    def self.quantized_avg_pool(input, min_input, max_input, typeT: nil, ksize: nil, strides: nil, padding: nil, name: nil)
      self.execute("QuantizedAvgPool", [input, min_input, max_input], T: typeT, ksize: ksize, strides: strides, padding: padding, name: name)
    end
  

    def self.quantized_batch_norm_with_global_normalization(t, t_min, t_max, m, m_min, m_max, v, v_min, v_max, beta, beta_min, beta_max, gamma, gamma_min, gamma_max, tinput: nil, out_type: nil, variance_epsilon: nil, scale_after_normalization: nil, name: nil)
    ...
    def self.quantized_bias_add(input, bias, min_input, max_input, min_bias, max_bias, t1: nil, t2: nil, out_type: nil, name: nil)
      self.execute("QuantizedBiasAdd", [input, bias, min_input, max_input, min_bias, max_bias], T1: t1, T2: t2, out_type: out_type, name: name)
    end
  

    def self.quantized_concat(concat_dim, values, input_mins, input_maxes, n: nil, typeT: nil, name: nil)
      self.execute("QuantizedConcat", [concat_dim, values, input_mins, input_maxes], N: n, T: typeT, name: name)
    end
  

    def self.quantized_conv2_d(input, filter, min_input, max_input, min_filter, max_filter, tinput: nil, tfilter: nil, out_type: nil, strides: nil, padding: nil, dilations: [], name: nil)
    ...
    def self.quantized_conv2_d_and_relu(input, filter, min_input, max_input, min_filter, max_filter, tinput: nil, tfilter: nil, out_type: nil, strides: nil, padding: nil, dilations: [], padding_list: [], name: nil)
    ...
    def self.quantized_conv2_d_and_relu_and_requantize(input, filter, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, tinput: nil, tfilter: nil, out_type: nil, strides: nil, padding: nil, dilations: [], padding_list: [], name: nil)
    ...
    def self.quantized_conv2_d_and_requantize(input, filter, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, tinput: nil, tfilter: nil, out_type: nil, strides: nil, padding: nil, dilations: [], padding_list: [], name: nil)
    ...
    def self.quantized_conv2_d_per_channel(input, filter, min_input, max_input, min_filter, max_filter, tinput: nil, tfilter: nil, out_type: nil, strides: nil, padding: nil, dilations: [], name: nil)
    ...
    def self.quantized_conv2_d_with_bias(input, filter, bias, min_input, max_input, min_filter, max_filter, tinput: nil, tfilter: nil, out_type: nil, strides: nil, padding: nil, dilations: [], padding_list: [], name: nil)
    ...
    def self.quantized_conv2_d_with_bias_and_relu(input, filter, bias, min_input, max_input, min_filter, max_filter, tinput: nil, tfilter: nil, out_type: nil, strides: nil, padding: nil, dilations: [], padding_list: [], name: nil)
    ...
    def self.quantized_conv2_d_with_bias_and_relu_and_requantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, tinput: nil, tfilter: nil, tbias: nil, out_type: nil, strides: nil, padding: nil, dilations: [], padding_list: [], name: nil)
    ...
    def self.quantized_conv2_d_with_bias_and_requantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, tinput: nil, tfilter: nil, tbias: nil, out_type: nil, strides: nil, padding: nil, dilations: [], padding_list: [], name: nil)
    ...
    def self.quantized_conv2_d_with_bias_sum_and_relu(input, filter, bias, min_input, max_input, min_filter, max_filter, summand, tinput: nil, tfilter: nil, out_type: nil, strides: nil, padding: nil, dilations: [], padding_list: [], name: nil)
    ...
    def self.quantized_depthwise_conv2_d(input, filter, min_input, max_input, min_filter, max_filter, tinput: nil, tfilter: nil, out_type: nil, strides: nil, padding: nil, dilations: [], name: nil)
    ...
    def self.quantized_depthwise_conv2_d_with_bias(input, filter, bias, min_input, max_input, min_filter, max_filter, tinput: nil, tfilter: nil, out_type: nil, strides: nil, padding: nil, dilations: [], name: nil)
    ...
    def self.quantized_depthwise_conv2_d_with_bias_and_relu(input, filter, bias, min_input, max_input, min_filter, max_filter, tinput: nil, tfilter: nil, out_type: nil, strides: nil, padding: nil, dilations: [], name: nil)
    ...
    def self.quantized_depthwise_conv2_d_with_bias_and_relu_and_requantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, tinput: nil, tfilter: nil, tbias: nil, out_type: nil, strides: nil, padding: nil, dilations: [], name: nil)
    ...
    def self.quantized_instance_norm(x, x_min, x_max, typeT: nil, output_range_given: false, given_y_min: 0.0, given_y_max: 0.0, variance_epsilon: 9.999999747378752e-06, min_separation: 0.0010000000474974513, name: nil)
    ...
    def self.quantized_mat_mul(a, b, min_a, max_a, min_b, max_b, t1: nil, t2: nil, toutput: nil, transpose_a: false, transpose_b: false, tactivation: nil, name: nil)
    ...
    def self.quantized_mat_mul_with_bias(a, b, bias, min_a, max_a, min_b, max_b, t1: nil, t2: nil, tbias: nil, toutput: nil, transpose_a: false, transpose_b: false, input_quant_mode: "MIN_FIRST", name: nil)
    ...
    def self.quantized_mat_mul_with_bias_and_relu(a, b, bias, min_a, max_a, min_b, max_b, t1: nil, t2: nil, toutput: nil, transpose_a: false, transpose_b: false, input_quant_mode: "MIN_FIRST", name: nil)
    ...
    def self.quantized_mat_mul_with_bias_and_relu_and_requantize(a, b, bias, min_a, max_a, min_b, max_b, min_freezed_output, max_freezed_output, t1: nil, t2: nil, tbias: nil, toutput: nil, transpose_a: false, transpose_b: false, input_quant_mode: "MIN_FIRST", name: nil)
    ...
    def self.quantized_max_pool(input, min_input, max_input, typeT: nil, ksize: nil, strides: nil, padding: nil, name: nil)
      self.execute("QuantizedMaxPool", [input, min_input, max_input], T: typeT, ksize: ksize, strides: strides, padding: padding, name: name)
    end
  

    def self.quantized_mul(x, y, min_x, max_x, min_y, max_y, t1: nil, t2: nil, toutput: nil, name: nil)
      self.execute("QuantizedMul", [x, y, min_x, max_x, min_y, max_y], T1: t1, T2: t2, Toutput: toutput, name: name)
    end
  

    def self.quantized_relu(features, min_features, max_features, tinput: nil, out_type: nil, name: nil)
      self.execute("QuantizedRelu", [features, min_features, max_features], Tinput: tinput, out_type: out_type, name: name)
    end
  

    def self.quantized_relu6(features, min_features, max_features, tinput: nil, out_type: nil, name: nil)
      self.execute("QuantizedRelu6", [features, min_features, max_features], Tinput: tinput, out_type: out_type, name: name)
    end
  

    def self.quantized_relu_x(features, max_value, min_features, max_features, tinput: nil, out_type: nil, name: nil)
      self.execute("QuantizedReluX", [features, max_value, min_features, max_features], Tinput: tinput, out_type: out_type, name: name)
    end
  

    def self.quantized_reshape(tensor, shape, input_min, input_max, typeT: nil, tshape: nil, name: nil)
      self.execute("QuantizedReshape", [tensor, shape, input_min, input_max], T: typeT, Tshape: tshape, name: name)
    end
  

    def self.quantized_resize_bilinear(images, size, min, max, typeT: nil, align_corners: false, half_pixel_centers: false, name: nil)
    ...
    def self.ragged_range(starts, limits, deltas, typeT: nil, tsplits: nil, name: nil)
      self.execute("RaggedRange", [starts, limits, deltas], T: typeT, Tsplits: tsplits, name: name)
    end
  

    def self.ragged_tensor_from_variant(encoded_ragged, input_ragged_rank: nil, output_ragged_rank: nil, tvalues: nil, tsplits: nil, name: nil)
    ...
    def self.ragged_tensor_to_sparse(rt_nested_splits, rt_dense_values, ragged_rank: nil, typeT: nil, tsplits: nil, name: nil)
    ...
    def self.ragged_tensor_to_tensor(shape, values, default_value, row_partition_tensors, typeT: nil, tindex: nil, tshape: nil, num_row_partition_tensors: nil, row_partition_types: nil, name: nil)
    ...
    def self.ragged_tensor_to_variant(rt_nested_splits, rt_dense_values, ragged_rank: nil, tvalues: nil, tsplits: nil, batched_input: nil, name: nil)
    ...
    def self.random_crop(image, size, typeT: nil, seed: 0, seed2: 0, name: nil)
      self.execute("RandomCrop", [image, size], T: typeT, seed: seed, seed2: seed2, name: name)
    end
  

    def self.random_dataset(seed, seed2, output_types: nil, output_shapes: nil, name: nil)
      self.execute("RandomDataset", [seed, seed2], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.random_gamma(shape, alpha, seed: 0, seed2: 0, s: nil, typeT: nil, name: nil)
      self.execute("RandomGamma", [shape, alpha], seed: seed, seed2: seed2, S: s, T: typeT, name: name)
    end
  

    def self.random_gamma_grad(alpha, sample, typeT: nil, name: nil)
      self.execute("RandomGammaGrad", [alpha, sample], T: typeT, name: name)
    end
  

    def self.random_poisson(shape, rate, seed: 0, seed2: 0, s: nil, dtype: nil, name: nil)
      self.execute("RandomPoisson", [shape, rate], seed: seed, seed2: seed2, S: s, dtype: dtype, name: name)
    end
  

    def self.random_poisson_v2(shape, rate, seed: 0, seed2: 0, s: nil, r: nil, dtype: nil, name: nil)
      self.execute("RandomPoissonV2", [shape, rate], seed: seed, seed2: seed2, S: s, R: r, dtype: dtype, name: name)
    end
  

    def self.random_shuffle(value, seed: 0, seed2: 0, typeT: nil, name: nil)
      self.execute("RandomShuffle", [value], seed: seed, seed2: seed2, T: typeT, name: name)
    end
  

    def self.random_shuffle_queue(component_types: nil, shapes: [], capacity: -1, min_after_dequeue: 0, seed: 0, seed2: 0, container: nil, shared_name: nil, name: nil)
    ...
    def self.random_shuffle_queue_v2(component_types: nil, shapes: [], capacity: -1, min_after_dequeue: 0, seed: 0, seed2: 0, container: nil, shared_name: nil, name: nil)
    ...
    def self.random_standard_normal(shape, seed: 0, seed2: 0, dtype: nil, typeT: nil, name: nil)
      self.execute("RandomStandardNormal", [shape], seed: seed, seed2: seed2, dtype: dtype, T: typeT, name: name)
    end
  

    def self.random_uniform(shape, seed: 0, seed2: 0, dtype: nil, typeT: nil, name: nil)
      self.execute("RandomUniform", [shape], seed: seed, seed2: seed2, dtype: dtype, T: typeT, name: name)
    end
  

    def self.random_uniform_int(shape, minval, maxval, seed: 0, seed2: 0, tout: nil, typeT: nil, name: nil)
      self.execute("RandomUniformInt", [shape, minval, maxval], seed: seed, seed2: seed2, Tout: tout, T: typeT, name: name)
    end
  

    def self.range(start, limit, delta, tidx: nil, name: nil)
      self.execute("Range", [start, limit, delta], Tidx: tidx, name: name)
    end
  

    def self.range_dataset(start, stop, step, output_types: nil, output_shapes: nil, name: nil)
      self.execute("RangeDataset", [start, stop, step], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.rank(input, typeT: nil, name: nil)
      self.execute("Rank", [input], T: typeT, name: name)
    end
  

    def self.read_file(filename, name: nil)
      self.execute("ReadFile", [filename], name: name)
    end
  

    def self.read_variable_op(resource, dtype: nil, name: nil)
      self.execute("ReadVariableOp", [resource], dtype: dtype, name: name)
    end
  

    def self.reader_num_records_produced(reader_handle, name: nil)
      self.execute("ReaderNumRecordsProduced", [reader_handle], name: name)
    end
  

    def self.reader_num_records_produced_v2(reader_handle, name: nil)
      self.execute("ReaderNumRecordsProducedV2", [reader_handle], name: name)
    end
  

    def self.reader_num_work_units_completed(reader_handle, name: nil)
      self.execute("ReaderNumWorkUnitsCompleted", [reader_handle], name: name)
    end
  

    def self.reader_num_work_units_completed_v2(reader_handle, name: nil)
      self.execute("ReaderNumWorkUnitsCompletedV2", [reader_handle], name: name)
    end
  

    def self.reader_read(reader_handle, queue_handle, name: nil)
      self.execute("ReaderRead", [reader_handle, queue_handle], name: name)
    end
  

    def self.reader_read_up_to(reader_handle, queue_handle, num_records, name: nil)
      self.execute("ReaderReadUpTo", [reader_handle, queue_handle, num_records], name: name)
    end
  

    def self.reader_read_up_to_v2(reader_handle, queue_handle, num_records, name: nil)
      self.execute("ReaderReadUpToV2", [reader_handle, queue_handle, num_records], name: name)
    end
  

    def self.reader_read_v2(reader_handle, queue_handle, name: nil)
      self.execute("ReaderReadV2", [reader_handle, queue_handle], name: name)
    end
  

    def self.reader_reset(reader_handle, name: nil)
      self.execute("ReaderReset", [reader_handle], name: name)
    end
  

    def self.reader_reset_v2(reader_handle, name: nil)
      self.execute("ReaderResetV2", [reader_handle], name: name)
    end
  

    def self.reader_restore_state(reader_handle, state, name: nil)
      self.execute("ReaderRestoreState", [reader_handle, state], name: name)
    end
  

    def self.reader_restore_state_v2(reader_handle, state, name: nil)
      self.execute("ReaderRestoreStateV2", [reader_handle, state], name: name)
    end
  

    def self.reader_serialize_state(reader_handle, name: nil)
      self.execute("ReaderSerializeState", [reader_handle], name: name)
    end
  

    def self.reader_serialize_state_v2(reader_handle, name: nil)
      self.execute("ReaderSerializeStateV2", [reader_handle], name: name)
    end
  

    def self.real(input, typeT: nil, tout: nil, name: nil)
      self.execute("Real", [input], T: typeT, Tout: tout, name: name)
    end
  

    def self.real_div(x, y, typeT: nil, name: nil)
      self.execute("RealDiv", [x, y], T: typeT, name: name)
    end
  

    def self.rebatch_dataset(input_dataset, num_replicas, output_types: nil, output_shapes: nil, use_fallback: true, name: nil)
    ...
    def self.reciprocal(x, typeT: nil, name: nil)
      self.execute("Reciprocal", [x], T: typeT, name: name)
    end
  

    def self.reciprocal_grad(y, dy, typeT: nil, name: nil)
      self.execute("ReciprocalGrad", [y, dy], T: typeT, name: name)
    end
  

    def self.record_input(file_pattern: nil, file_random_seed: 301, file_shuffle_shift_ratio: 0.0, file_buffer_size: 10000, file_parallelism: 16, batch_size: 32, compression_type: nil, name: nil)
    ...
    def self.recv(tensor_type: nil, tensor_name: nil, send_device: nil, send_device_incarnation: nil, recv_device: nil, client_terminated: false, name: nil)
    ...
    def self.recv_tpu_embedding_activations(num_outputs: nil, config: nil, name: nil)
      self.execute("RecvTPUEmbeddingActivations", [], num_outputs: num_outputs, config: config, name: name)
    end
  

    def self.reduce_dataset(input_dataset, initial_state, other_arguments, f: nil, tstate: nil, targuments: nil, output_types: nil, output_shapes: nil, use_inter_op_parallelism: true, name: nil)
    ...
    def self.reduce_join(inputs, reduction_indices, keep_dims: false, separator: nil, name: nil)
      self.execute("ReduceJoin", [inputs, reduction_indices], keep_dims: keep_dims, separator: separator, name: name)
    end
  

    def self.ref_enter(data, typeT: nil, frame_name: nil, is_constant: false, parallel_iterations: 10, name: nil)
    ...
    def self.ref_exit(data, typeT: nil, name: nil)
      self.execute("RefExit", [data], T: typeT, name: name)
    end
  

    def self.ref_identity(input, typeT: nil, name: nil)
      self.execute("RefIdentity", [input], T: typeT, name: name)
    end
  

    def self.ref_merge(inputs, typeT: nil, n: nil, name: nil)
      self.execute("RefMerge", [inputs], T: typeT, N: n, name: name)
    end
  

    def self.ref_next_iteration(data, typeT: nil, name: nil)
      self.execute("RefNextIteration", [data], T: typeT, name: name)
    end
  

    def self.ref_select(index, inputs, typeT: nil, n: nil, name: nil)
      self.execute("RefSelect", [index, inputs], T: typeT, N: n, name: name)
    end
  

    def self.ref_switch(data, pred, typeT: nil, name: nil)
      self.execute("RefSwitch", [data, pred], T: typeT, name: name)
    end
  

    def self.regex_full_match(input, pattern, name: nil)
      self.execute("RegexFullMatch", [input, pattern], name: name)
    end
  

    def self.regex_replace(input, pattern, rewrite, replace_global: true, name: nil)
      self.execute("RegexReplace", [input, pattern, rewrite], replace_global: replace_global, name: name)
    end
  

    def self.relu(features, typeT: nil, name: nil)
      self.execute("Relu", [features], T: typeT, name: name)
    end
  

    def self.relu6(features, typeT: nil, name: nil)
      self.execute("Relu6", [features], T: typeT, name: name)
    end
  

    def self.relu6_grad(gradients, features, typeT: nil, name: nil)
      self.execute("Relu6Grad", [gradients, features], T: typeT, name: name)
    end
  

    def self.relu_grad(gradients, features, typeT: nil, name: nil)
      self.execute("ReluGrad", [gradients, features], T: typeT, name: name)
    end
  

    def self.remote_call(target, args, tin: nil, tout: nil, f: nil, name: nil)
      self.execute("RemoteCall", [target, args], Tin: tin, Tout: tout, f: f, name: name)
    end
  

    def self.remote_fused_graph_execute(inputs, tinputs: nil, toutputs: nil, serialized_remote_fused_graph_execute_info: nil, name: nil)
    ...
    def self.repeat_dataset(input_dataset, count, output_types: nil, output_shapes: nil, name: nil)
      self.execute("RepeatDataset", [input_dataset, count], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.requantization_range(input, input_min, input_max, tinput: nil, name: nil)
      self.execute("RequantizationRange", [input, input_min, input_max], Tinput: tinput, name: name)
    end
  

    def self.requantization_range_per_channel(input, input_min, input_max, typeT: nil, clip_value_max: nil, name: nil)
      self.execute("RequantizationRangePerChannel", [input, input_min, input_max], T: typeT, clip_value_max: clip_value_max, name: name)
    end
  

    def self.requantize(input, input_min, input_max, requested_output_min, requested_output_max, tinput: nil, out_type: nil, name: nil)
    ...
    def self.requantize_per_channel(input, input_min, input_max, requested_output_min, requested_output_max, typeT: nil, out_type: nil, name: nil)
    ...
    def self.reshape(tensor, shape, typeT: nil, tshape: nil, name: nil)
      self.execute("Reshape", [tensor, shape], T: typeT, Tshape: tshape, name: name)
    end
  

    def self.resize_area(images, size, typeT: nil, align_corners: false, name: nil)
      self.execute("ResizeArea", [images, size], T: typeT, align_corners: align_corners, name: name)
    end
  

    def self.resize_bicubic(images, size, typeT: nil, align_corners: false, half_pixel_centers: false, name: nil)
    ...
    def self.resize_bicubic_grad(grads, original_image, typeT: nil, align_corners: false, half_pixel_centers: false, name: nil)
    ...
    def self.resize_bilinear(images, size, typeT: nil, align_corners: false, half_pixel_centers: false, name: nil)
    ...
    def self.resize_bilinear_grad(grads, original_image, typeT: nil, align_corners: false, half_pixel_centers: false, name: nil)
    ...
    def self.resize_nearest_neighbor(images, size, typeT: nil, align_corners: false, half_pixel_centers: false, name: nil)
    ...
    def self.resize_nearest_neighbor_grad(grads, size, typeT: nil, align_corners: false, half_pixel_centers: false, name: nil)
    ...
    def self.resource_accumulator_apply_gradient(handle, local_step, gradient, dtype: nil, name: nil)
      self.execute("ResourceAccumulatorApplyGradient", [handle, local_step, gradient], dtype: dtype, name: name)
    end
  

    def self.resource_accumulator_num_accumulated(handle, name: nil)
      self.execute("ResourceAccumulatorNumAccumulated", [handle], name: name)
    end
  

    def self.resource_accumulator_set_global_step(handle, new_global_step, name: nil)
      self.execute("ResourceAccumulatorSetGlobalStep", [handle, new_global_step], name: name)
    end
  

    def self.resource_accumulator_take_gradient(handle, num_required, dtype: nil, name: nil)
      self.execute("ResourceAccumulatorTakeGradient", [handle, num_required], dtype: dtype, name: name)
    end
  

    def self.resource_apply_ada_max(var, m, v, beta1_power, lr, beta1, beta2, epsilon, grad, typeT: nil, use_locking: false, name: nil)
    ...
    def self.resource_apply_adadelta(var, accum, accum_update, lr, rho, epsilon, grad, typeT: nil, use_locking: false, name: nil)
      self.execute("ResourceApplyAdadelta", [var, accum, accum_update, lr, rho, epsilon, grad], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.resource_apply_adagrad(var, accum, lr, grad, typeT: nil, use_locking: false, update_slots: true, name: nil)
      self.execute("ResourceApplyAdagrad", [var, accum, lr, grad], T: typeT, use_locking: use_locking, update_slots: update_slots, name: name)
    end
  

    def self.resource_apply_adagrad_da(var, gradient_accumulator, gradient_squared_accumulator, grad, lr, l1, l2, global_step, typeT: nil, use_locking: false, name: nil)
    ...
    def self.resource_apply_adagrad_v2(var, accum, lr, epsilon, grad, typeT: nil, use_locking: false, update_slots: true, name: nil)
    ...
    def self.resource_apply_adam(var, m, v, beta1_power, beta2_power, lr, beta1, beta2, epsilon, grad, typeT: nil, use_locking: false, use_nesterov: false, name: nil)
    ...
    def self.resource_apply_adam_with_amsgrad(var, m, v, vhat, beta1_power, beta2_power, lr, beta1, beta2, epsilon, grad, typeT: nil, use_locking: false, name: nil)
    ...
    def self.resource_apply_add_sign(var, m, lr, alpha, sign_decay, beta, grad, typeT: nil, use_locking: false, name: nil)
      self.execute("ResourceApplyAddSign", [var, m, lr, alpha, sign_decay, beta, grad], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.resource_apply_centered_rms_prop(var, mg, ms, mom, lr, rho, momentum, epsilon, grad, typeT: nil, use_locking: false, name: nil)
    ...
    def self.resource_apply_ftrl(var, accum, linear, grad, lr, l1, l2, lr_power, typeT: nil, use_locking: false, name: nil)
      self.execute("ResourceApplyFtrl", [var, accum, linear, grad, lr, l1, l2, lr_power], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.resource_apply_ftrl_v2(var, accum, linear, grad, lr, l1, l2, l2_shrinkage, lr_power, typeT: nil, use_locking: false, name: nil)
    ...
    def self.resource_apply_gradient_descent(var, alpha, delta, typeT: nil, use_locking: false, name: nil)
      self.execute("ResourceApplyGradientDescent", [var, alpha, delta], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.resource_apply_keras_momentum(var, accum, lr, grad, momentum, typeT: nil, use_locking: false, use_nesterov: false, name: nil)
    ...
    def self.resource_apply_momentum(var, accum, lr, grad, momentum, typeT: nil, use_locking: false, use_nesterov: false, name: nil)
    ...
    def self.resource_apply_power_sign(var, m, lr, logbase, sign_decay, beta, grad, typeT: nil, use_locking: false, name: nil)
      self.execute("ResourceApplyPowerSign", [var, m, lr, logbase, sign_decay, beta, grad], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.resource_apply_proximal_adagrad(var, accum, lr, l1, l2, grad, typeT: nil, use_locking: false, name: nil)
      self.execute("ResourceApplyProximalAdagrad", [var, accum, lr, l1, l2, grad], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.resource_apply_proximal_gradient_descent(var, alpha, l1, l2, delta, typeT: nil, use_locking: false, name: nil)
      self.execute("ResourceApplyProximalGradientDescent", [var, alpha, l1, l2, delta], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.resource_apply_rms_prop(var, ms, mom, lr, rho, momentum, epsilon, grad, typeT: nil, use_locking: false, name: nil)
      self.execute("ResourceApplyRMSProp", [var, ms, mom, lr, rho, momentum, epsilon, grad], T: typeT, use_locking: use_locking, name: name)
    end
  

    def self.resource_conditional_accumulator(dtype: nil, shape: nil, container: nil, shared_name: nil, reduction_type: "MEAN", name: nil)
    ...
    def self.resource_count_up_to(resource, limit: nil, typeT: nil, name: nil)
      self.execute("ResourceCountUpTo", [resource], limit: limit, T: typeT, name: name)
    end
  

    def self.resource_gather(resource, indices, batch_dims: 0, validate_indices: true, dtype: nil, tindices: nil, name: nil)
    ...
    def self.resource_gather_nd(resource, indices, dtype: nil, tindices: nil, name: nil)
      self.execute("ResourceGatherNd", [resource, indices], dtype: dtype, Tindices: tindices, name: name)
    end
  

    def self.resource_scatter_add(resource, indices, updates, dtype: nil, tindices: nil, name: nil)
      self.execute("ResourceScatterAdd", [resource, indices, updates], dtype: dtype, Tindices: tindices, name: name)
    end
  

    def self.resource_scatter_div(resource, indices, updates, dtype: nil, tindices: nil, name: nil)
      self.execute("ResourceScatterDiv", [resource, indices, updates], dtype: dtype, Tindices: tindices, name: name)
    end
  

    def self.resource_scatter_max(resource, indices, updates, dtype: nil, tindices: nil, name: nil)
      self.execute("ResourceScatterMax", [resource, indices, updates], dtype: dtype, Tindices: tindices, name: name)
    end
  

    def self.resource_scatter_min(resource, indices, updates, dtype: nil, tindices: nil, name: nil)
      self.execute("ResourceScatterMin", [resource, indices, updates], dtype: dtype, Tindices: tindices, name: name)
    end
  

    def self.resource_scatter_mul(resource, indices, updates, dtype: nil, tindices: nil, name: nil)
      self.execute("ResourceScatterMul", [resource, indices, updates], dtype: dtype, Tindices: tindices, name: name)
    end
  

    def self.resource_scatter_nd_add(ref, indices, updates, typeT: nil, tindices: nil, use_locking: true, name: nil)
      self.execute("ResourceScatterNdAdd", [ref, indices, updates], T: typeT, Tindices: tindices, use_locking: use_locking, name: name)
    end
  

    def self.resource_scatter_nd_sub(ref, indices, updates, typeT: nil, tindices: nil, use_locking: true, name: nil)
      self.execute("ResourceScatterNdSub", [ref, indices, updates], T: typeT, Tindices: tindices, use_locking: use_locking, name: name)
    end
  

    def self.resource_scatter_nd_update(ref, indices, updates, typeT: nil, tindices: nil, use_locking: true, name: nil)
      self.execute("ResourceScatterNdUpdate", [ref, indices, updates], T: typeT, Tindices: tindices, use_locking: use_locking, name: name)
    end
  

    def self.resource_scatter_sub(resource, indices, updates, dtype: nil, tindices: nil, name: nil)
      self.execute("ResourceScatterSub", [resource, indices, updates], dtype: dtype, Tindices: tindices, name: name)
    end
  

    def self.resource_scatter_update(resource, indices, updates, dtype: nil, tindices: nil, name: nil)
      self.execute("ResourceScatterUpdate", [resource, indices, updates], dtype: dtype, Tindices: tindices, name: name)
    end
  

    def self.resource_sparse_apply_adadelta(var, accum, accum_update, lr, rho, epsilon, grad, indices, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.resource_sparse_apply_adagrad(var, accum, lr, grad, indices, typeT: nil, tindices: nil, use_locking: false, update_slots: true, name: nil)
    ...
    def self.resource_sparse_apply_adagrad_da(var, gradient_accumulator, gradient_squared_accumulator, grad, indices, lr, l1, l2, global_step, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.resource_sparse_apply_adagrad_v2(var, accum, lr, epsilon, grad, indices, typeT: nil, tindices: nil, use_locking: false, update_slots: true, name: nil)
    ...
    def self.resource_sparse_apply_centered_rms_prop(var, mg, ms, mom, lr, rho, momentum, epsilon, grad, indices, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.resource_sparse_apply_ftrl(var, accum, linear, grad, indices, lr, l1, l2, lr_power, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.resource_sparse_apply_ftrl_v2(var, accum, linear, grad, indices, lr, l1, l2, l2_shrinkage, lr_power, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.resource_sparse_apply_keras_momentum(var, accum, lr, grad, indices, momentum, typeT: nil, tindices: nil, use_locking: false, use_nesterov: false, name: nil)
    ...
    def self.resource_sparse_apply_momentum(var, accum, lr, grad, indices, momentum, typeT: nil, tindices: nil, use_locking: false, use_nesterov: false, name: nil)
    ...
    def self.resource_sparse_apply_proximal_adagrad(var, accum, lr, l1, l2, grad, indices, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.resource_sparse_apply_proximal_gradient_descent(var, alpha, l1, l2, grad, indices, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.resource_sparse_apply_rms_prop(var, ms, mom, lr, rho, momentum, epsilon, grad, indices, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.resource_strided_slice_assign(ref, start, stop, strides, value, typeT: nil, index: nil, begin_mask: 0, end_mask: 0, ellipsis_mask: 0, new_axis_mask: 0, shrink_axis_mask: 0, name: nil)
    ...
    def self.restore(file_pattern, tensor_name, dt: nil, preferred_shard: -1, name: nil)
      self.execute("Restore", [file_pattern, tensor_name], dt: dt, preferred_shard: preferred_shard, name: name)
    end
  

    def self.restore_slice(file_pattern, tensor_name, shape_and_slice, dt: nil, preferred_shard: -1, name: nil)
      self.execute("RestoreSlice", [file_pattern, tensor_name, shape_and_slice], dt: dt, preferred_shard: preferred_shard, name: name)
    end
  

    def self.restore_v2(prefix, tensor_names, shape_and_slices, dtypes: nil, name: nil)
      self.execute("RestoreV2", [prefix, tensor_names, shape_and_slices], dtypes: dtypes, name: name)
    end
  

    def self.retrieve_tpu_embedding_adam_parameters(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_adam_parameters_grad_accum_debug(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_adadelta_parameters(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_adadelta_parameters_grad_accum_debug(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_adagrad_parameters(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_adagrad_parameters_grad_accum_debug(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_centered_rms_prop_parameters(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_ftrl_parameters(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_ftrl_parameters_grad_accum_debug(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_mdl_adagrad_light_parameters(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_momentum_parameters(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_momentum_parameters_grad_accum_debug(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_proximal_adagrad_parameters(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_proximal_adagrad_parameters_grad_accum_debug(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_rms_prop_parameters(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_rms_prop_parameters_grad_accum_debug(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.retrieve_tpu_embedding_stochastic_gradient_descent_parameters(table_id: -1, table_name: nil, num_shards: nil, shard_id: nil, config: nil, name: nil)
    ...
    def self.reverse(tensor, dims, typeT: nil, name: nil)
      self.execute("Reverse", [tensor, dims], T: typeT, name: name)
    end
  

    def self.reverse_sequence(input, seq_lengths, seq_dim: nil, batch_dim: 0, typeT: nil, tlen: nil, name: nil)
      self.execute("ReverseSequence", [input, seq_lengths], seq_dim: seq_dim, batch_dim: batch_dim, T: typeT, Tlen: tlen, name: name)
    end
  

    def self.reverse_v2(tensor, axis, tidx: nil, typeT: nil, name: nil)
      self.execute("ReverseV2", [tensor, axis], Tidx: tidx, T: typeT, name: name)
    end
  

    def self.right_shift(x, y, typeT: nil, name: nil)
      self.execute("RightShift", [x, y], T: typeT, name: name)
    end
  

    def self.rint(x, typeT: nil, name: nil)
      self.execute("Rint", [x], T: typeT, name: name)
    end
  

    def self.rng_skip(resource, algorithm, delta, name: nil)
      self.execute("RngSkip", [resource, algorithm, delta], name: name)
    end
  

    def self.roll(input, shift, axis, typeT: nil, tshift: nil, taxis: nil, name: nil)
      self.execute("Roll", [input, shift, axis], T: typeT, Tshift: tshift, Taxis: taxis, name: name)
    end
  

    def self.round(x, typeT: nil, name: nil)
      self.execute("Round", [x], T: typeT, name: name)
    end
  

    def self.rpc(address, method, request, protocol: nil, fail_fast: true, timeout_in_ms: 0, name: nil)
      self.execute("Rpc", [address, method, request], protocol: protocol, fail_fast: fail_fast, timeout_in_ms: timeout_in_ms, name: name)
    end
  

    def self.rsqrt(x, typeT: nil, name: nil)
      self.execute("Rsqrt", [x], T: typeT, name: name)
    end
  

    def self.rsqrt_grad(y, dy, typeT: nil, name: nil)
      self.execute("RsqrtGrad", [y, dy], T: typeT, name: name)
    end
  

    def self.sample_distorted_bounding_box(image_size, bounding_boxes, typeT: nil, seed: 0, seed2: 0, min_object_covered: 0.10000000149011612, aspect_ratio_range: [], area_range: [], max_attempts: 100, use_image_if_no_bounding_boxes: false, name: nil)
    ...
    def self.sample_distorted_bounding_box_v2(image_size, bounding_boxes, min_object_covered, typeT: nil, seed: 0, seed2: 0, aspect_ratio_range: [], area_range: [], max_attempts: 100, use_image_if_no_bounding_boxes: false, name: nil)
    ...
    def self.sampling_dataset(input_dataset, rate, seed, seed2, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.save(filename, tensor_names, data, typeT: nil, name: nil)
      self.execute("Save", [filename, tensor_names, data], T: typeT, name: name)
    end
  

    def self.save_slices(filename, tensor_names, shapes_and_slices, data, typeT: nil, name: nil)
      self.execute("SaveSlices", [filename, tensor_names, shapes_and_slices, data], T: typeT, name: name)
    end
  

    def self.save_v2(prefix, tensor_names, shape_and_slices, tensors, dtypes: nil, name: nil)
      self.execute("SaveV2", [prefix, tensor_names, shape_and_slices, tensors], dtypes: dtypes, name: name)
    end
  

    def self.scalar_summary(tags, values, typeT: nil, name: nil)
      self.execute("ScalarSummary", [tags, values], T: typeT, name: name)
    end
  

    def self.scale_and_translate(images, size, scale, translation, typeT: nil, kernel_type: "lanczos3", antialias: true, name: nil)
    ...
    def self.scale_and_translate_grad(grads, original_image, scale, translation, typeT: nil, kernel_type: "lanczos3", antialias: true, name: nil)
    ...
    def self.scan_dataset(input_dataset, initial_state, other_arguments, f: nil, tstate: nil, targuments: nil, output_types: nil, output_shapes: nil, preserve_cardinality: false, use_default_device: true, name: nil)
    ...
    def self.sdca_shrink_l1(weights, num_features: nil, l1: nil, l2: nil, name: nil)
      self.execute("SdcaShrinkL1", [weights], num_features: num_features, l1: l1, l2: l2, name: name)
    end
  

    def self.segment_max(data, segment_ids, typeT: nil, tindices: nil, name: nil)
      self.execute("SegmentMax", [data, segment_ids], T: typeT, Tindices: tindices, name: name)
    end
  

    def self.segment_mean(data, segment_ids, typeT: nil, tindices: nil, name: nil)
      self.execute("SegmentMean", [data, segment_ids], T: typeT, Tindices: tindices, name: name)
    end
  

    def self.segment_min(data, segment_ids, typeT: nil, tindices: nil, name: nil)
      self.execute("SegmentMin", [data, segment_ids], T: typeT, Tindices: tindices, name: name)
    end
  

    def self.segment_prod(data, segment_ids, typeT: nil, tindices: nil, name: nil)
      self.execute("SegmentProd", [data, segment_ids], T: typeT, Tindices: tindices, name: name)
    end
  

    def self.segment_sum(data, segment_ids, typeT: nil, tindices: nil, name: nil)
      self.execute("SegmentSum", [data, segment_ids], T: typeT, Tindices: tindices, name: name)
    end
  

    def self.select(condition, t, e, typeT: nil, name: nil)
      self.execute("Select", [condition, t, e], T: typeT, name: name)
    end
  

    def self.select_v2(condition, t, e, typeT: nil, name: nil)
      self.execute("SelectV2", [condition, t, e], T: typeT, name: name)
    end
  

    def self.self_adjoint_eig(input, typeT: nil, name: nil)
      self.execute("SelfAdjointEig", [input], T: typeT, name: name)
    end
  

    def self.self_adjoint_eig_v2(input, compute_v: true, typeT: nil, name: nil)
      self.execute("SelfAdjointEigV2", [input], compute_v: compute_v, T: typeT, name: name)
    end
  

    def self.selu(features, typeT: nil, name: nil)
      self.execute("Selu", [features], T: typeT, name: name)
    end
  

    def self.selu_grad(gradients, outputs, typeT: nil, name: nil)
      self.execute("SeluGrad", [gradients, outputs], T: typeT, name: name)
    end
  

    def self.send(tensor, typeT: nil, tensor_name: nil, send_device: nil, send_device_incarnation: nil, recv_device: nil, client_terminated: false, name: nil)
    ...
    def self.send_tpu_embedding_gradients(inputs, learning_rates, n: nil, nn: 0, config: nil, name: nil)
      self.execute("SendTPUEmbeddingGradients", [inputs, learning_rates], N: n, NN: nn, config: config, name: name)
    end
  

    def self.serialize_iterator(resource_handle, name: nil)
      self.execute("SerializeIterator", [resource_handle], name: name)
    end
  

    def self.serialize_many_sparse(sparse_indices, sparse_values, sparse_shape, typeT: nil, out_type: nil, name: nil)
      self.execute("SerializeManySparse", [sparse_indices, sparse_values, sparse_shape], T: typeT, out_type: out_type, name: name)
    end
  

    def self.serialize_sparse(sparse_indices, sparse_values, sparse_shape, typeT: nil, out_type: nil, name: nil)
      self.execute("SerializeSparse", [sparse_indices, sparse_values, sparse_shape], T: typeT, out_type: out_type, name: name)
    end
  

    def self.serialize_tensor(tensor, typeT: nil, name: nil)
      self.execute("SerializeTensor", [tensor], T: typeT, name: name)
    end
  

    def self.set_size(set_indices, set_values, set_shape, validate_indices: true, typeT: nil, name: nil)
      self.execute("SetSize", [set_indices, set_values, set_shape], validate_indices: validate_indices, T: typeT, name: name)
    end
  

    def self.set_stats_aggregator_dataset(input_dataset, stats_aggregator, tag, counter_prefix, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.shape(input, typeT: nil, out_type: nil, name: nil)
      self.execute("Shape", [input], T: typeT, out_type: out_type, name: name)
    end
  

    def self.shape_n(input, n: nil, typeT: nil, out_type: nil, name: nil)
      self.execute("ShapeN", [input], N: n, T: typeT, out_type: out_type, name: name)
    end
  

    def self.shard_dataset(input_dataset, num_shards, index, require_non_empty: false, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.sharded_filename(basename, shard, num_shards, name: nil)
      self.execute("ShardedFilename", [basename, shard, num_shards], name: name)
    end
  

    def self.sharded_filespec(basename, num_shards, name: nil)
      self.execute("ShardedFilespec", [basename, num_shards], name: name)
    end
  

    def self.shuffle_and_repeat_dataset(input_dataset, buffer_size, seed, seed2, count, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.shuffle_dataset(input_dataset, buffer_size, seed, seed2, reshuffle_each_iteration: true, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.shuffle_dataset_v2(input_dataset, buffer_size, seed_generator, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.shutdown_distributed_tpu(name: nil)
      self.execute("ShutdownDistributedTPU", [], name: name)
    end
  

    def self.sigmoid(x, typeT: nil, name: nil)
      self.execute("Sigmoid", [x], T: typeT, name: name)
    end
  

    def self.sigmoid_grad(y, dy, typeT: nil, name: nil)
      self.execute("SigmoidGrad", [y, dy], T: typeT, name: name)
    end
  

    def self.sign(x, typeT: nil, name: nil)
      self.execute("Sign", [x], T: typeT, name: name)
    end
  

    def self.sin(x, typeT: nil, name: nil)
      self.execute("Sin", [x], T: typeT, name: name)
    end
  

    def self.sinh(x, typeT: nil, name: nil)
      self.execute("Sinh", [x], T: typeT, name: name)
    end
  

    def self.size(input, typeT: nil, out_type: nil, name: nil)
      self.execute("Size", [input], T: typeT, out_type: out_type, name: name)
    end
  

    def self.skip_dataset(input_dataset, count, output_types: nil, output_shapes: nil, name: nil)
      self.execute("SkipDataset", [input_dataset, count], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.skipgram(filename: nil, batch_size: nil, window_size: 5, min_count: 5, subsample: 0.0010000000474974513, name: nil)
    ...
    def self.sleep_dataset(input_dataset, sleep_microseconds, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.slice(input, start, size, typeT: nil, index: nil, name: nil)
      self.execute("Slice", [input, start, size], T: typeT, Index: index, name: name)
    end
  

    def self.sliding_window_dataset(input_dataset, window_size, window_shift, window_stride, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.snapshot(input, typeT: nil, name: nil)
    ...
    def self.softmax(logits, typeT: nil, name: nil)
      self.execute("Softmax", [logits], T: typeT, name: name)
    end
  

    def self.softmax_cross_entropy_with_logits(features, labels, typeT: nil, name: nil)
      self.execute("SoftmaxCrossEntropyWithLogits", [features, labels], T: typeT, name: name)
    end
  

    def self.softplus(features, typeT: nil, name: nil)
      self.execute("Softplus", [features], T: typeT, name: name)
    end
  

    def self.softplus_grad(gradients, features, typeT: nil, name: nil)
      self.execute("SoftplusGrad", [gradients, features], T: typeT, name: name)
    end
  

    def self.softsign(features, typeT: nil, name: nil)
      self.execute("Softsign", [features], T: typeT, name: name)
    end
  

    def self.softsign_grad(gradients, features, typeT: nil, name: nil)
      self.execute("SoftsignGrad", [gradients, features], T: typeT, name: name)
    end
  

    def self.space_to_batch(input, paddings, typeT: nil, tpaddings: nil, block_size: nil, name: nil)
      self.execute("SpaceToBatch", [input, paddings], T: typeT, Tpaddings: tpaddings, block_size: block_size, name: name)
    end
  

    def self.space_to_batch_nd(input, block_shape, paddings, typeT: nil, tblock_shape: nil, tpaddings: nil, name: nil)
      self.execute("SpaceToBatchND", [input, block_shape, paddings], T: typeT, Tblock_shape: tblock_shape, Tpaddings: tpaddings, name: name)
    end
  

    def self.space_to_depth(input, typeT: nil, block_size: nil, data_format: "NHWC", name: nil)
      self.execute("SpaceToDepth", [input], T: typeT, block_size: block_size, data_format: data_format, name: name)
    end
  

    def self.sparse_accumulator_apply_gradient(handle, local_step, gradient_indices, gradient_values, gradient_shape, dtype: nil, has_known_shape: nil, name: nil)
    ...
    def self.sparse_accumulator_take_gradient(handle, num_required, dtype: nil, name: nil)
      self.execute("SparseAccumulatorTakeGradient", [handle, num_required], dtype: dtype, name: name)
    end
  

    def self.sparse_add(a_indices, a_values, a_shape, b_indices, b_values, b_shape, thresh, typeT: nil, treal: nil, name: nil)
      self.execute("SparseAdd", [a_indices, a_values, a_shape, b_indices, b_values, b_shape, thresh], T: typeT, Treal: treal, name: name)
    end
  

    def self.sparse_add_grad(backprop_val_grad, a_indices, b_indices, sum_indices, typeT: nil, name: nil)
      self.execute("SparseAddGrad", [backprop_val_grad, a_indices, b_indices, sum_indices], T: typeT, name: name)
    end
  

    def self.sparse_apply_adadelta(var, accum, accum_update, lr, rho, epsilon, grad, indices, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.sparse_apply_adagrad(var, accum, lr, grad, indices, typeT: nil, tindices: nil, use_locking: false, update_slots: true, name: nil)
    ...
    def self.sparse_apply_adagrad_da(var, gradient_accumulator, gradient_squared_accumulator, grad, indices, lr, l1, l2, global_step, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.sparse_apply_adagrad_v2(var, accum, lr, epsilon, grad, indices, typeT: nil, tindices: nil, use_locking: false, update_slots: true, name: nil)
    ...
    def self.sparse_apply_centered_rms_prop(var, mg, ms, mom, lr, rho, momentum, epsilon, grad, indices, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.sparse_apply_ftrl(var, accum, linear, grad, indices, lr, l1, l2, lr_power, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.sparse_apply_ftrl_v2(var, accum, linear, grad, indices, lr, l1, l2, l2_shrinkage, lr_power, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.sparse_apply_momentum(var, accum, lr, grad, indices, momentum, typeT: nil, tindices: nil, use_locking: false, use_nesterov: false, name: nil)
    ...
    def self.sparse_apply_proximal_adagrad(var, accum, lr, l1, l2, grad, indices, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.sparse_apply_proximal_gradient_descent(var, alpha, l1, l2, grad, indices, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.sparse_apply_rms_prop(var, ms, mom, lr, rho, momentum, epsilon, grad, indices, typeT: nil, tindices: nil, use_locking: false, name: nil)
    ...
    def self.sparse_concat(indices, values, shapes, concat_dim: nil, n: nil, typeT: nil, name: nil)
      self.execute("SparseConcat", [indices, values, shapes], concat_dim: concat_dim, N: n, T: typeT, name: name)
    end
  

    def self.sparse_conditional_accumulator(dtype: nil, shape: nil, container: nil, shared_name: nil, reduction_type: "MEAN", name: nil)
    ...
    def self.sparse_cross(indices, values, shapes, dense_inputs, n: nil, hashed_output: nil, num_buckets: nil, hash_key: nil, sparse_types: nil, dense_types: nil, out_type: nil, internal_type: nil, name: nil)
    ...
    def self.sparse_dense_cwise_add(sp_indices, sp_values, sp_shape, dense, typeT: nil, name: nil)
      self.execute("SparseDenseCwiseAdd", [sp_indices, sp_values, sp_shape, dense], T: typeT, name: name)
    end
  

    def self.sparse_dense_cwise_div(sp_indices, sp_values, sp_shape, dense, typeT: nil, name: nil)
      self.execute("SparseDenseCwiseDiv", [sp_indices, sp_values, sp_shape, dense], T: typeT, name: name)
    end
  

    def self.sparse_dense_cwise_mul(sp_indices, sp_values, sp_shape, dense, typeT: nil, name: nil)
      self.execute("SparseDenseCwiseMul", [sp_indices, sp_values, sp_shape, dense], T: typeT, name: name)
    end
  

    def self.sparse_fill_empty_rows(indices, values, dense_shape, default_value, typeT: nil, name: nil)
      self.execute("SparseFillEmptyRows", [indices, values, dense_shape, default_value], T: typeT, name: name)
    end
  

    def self.sparse_fill_empty_rows_grad(reverse_index_map, grad_values, typeT: nil, name: nil)
      self.execute("SparseFillEmptyRowsGrad", [reverse_index_map, grad_values], T: typeT, name: name)
    end
  

    def self.sparse_mat_mul(a, b, transpose_a: false, transpose_b: false, a_is_sparse: false, b_is_sparse: false, ta: nil, tb: nil, name: nil)
    ...
    def self.sparse_matrix_add(a, b, alpha, beta, typeT: nil, name: nil)
      self.execute("SparseMatrixAdd", [a, b, alpha, beta], T: typeT, name: name)
    end
  

    def self.sparse_matrix_mat_mul(a, b, typeT: nil, transpose_a: false, transpose_b: false, adjoint_a: false, adjoint_b: false, transpose_output: false, conjugate_output: false, name: nil)
    ...
    def self.sparse_matrix_mul(a, b, typeT: nil, name: nil)
      self.execute("SparseMatrixMul", [a, b], T: typeT, name: name)
    end
  

    def self.sparse_matrix_nnz(sparse_matrix, name: nil)
      self.execute("SparseMatrixNNZ", [sparse_matrix], name: name)
    end
  

    def self.sparse_matrix_ordering_amd(input, name: nil)
      self.execute("SparseMatrixOrderingAMD", [input], name: name)
    end
  

    def self.sparse_matrix_softmax(logits, type: nil, name: nil)
      self.execute("SparseMatrixSoftmax", [logits], type: type, name: name)
    end
  

    def self.sparse_matrix_softmax_grad(softmax, grad_softmax, type: nil, name: nil)
      self.execute("SparseMatrixSoftmaxGrad", [softmax, grad_softmax], type: type, name: name)
    end
  

    def self.sparse_matrix_sparse_cholesky(input, permutation, type: nil, name: nil)
      self.execute("SparseMatrixSparseCholesky", [input, permutation], type: type, name: name)
    end
  

    def self.sparse_matrix_sparse_mat_mul(a, b, type: nil, transpose_a: false, transpose_b: false, adjoint_a: false, adjoint_b: false, name: nil)
    ...
    def self.sparse_matrix_transpose(input, conjugate: false, type: nil, name: nil)
      self.execute("SparseMatrixTranspose", [input], conjugate: conjugate, type: type, name: name)
    end
  

    def self.sparse_matrix_zeros(dense_shape, type: nil, name: nil)
      self.execute("SparseMatrixZeros", [dense_shape], type: type, name: name)
    end
  

    def self.sparse_reduce_max(input_indices, input_values, input_shape, reduction_axes, keep_dims: false, typeT: nil, name: nil)
      self.execute("SparseReduceMax", [input_indices, input_values, input_shape, reduction_axes], keep_dims: keep_dims, T: typeT, name: name)
    end
  

    def self.sparse_reduce_max_sparse(input_indices, input_values, input_shape, reduction_axes, keep_dims: false, typeT: nil, name: nil)
    ...
    def self.sparse_reduce_sum(input_indices, input_values, input_shape, reduction_axes, keep_dims: false, typeT: nil, name: nil)
      self.execute("SparseReduceSum", [input_indices, input_values, input_shape, reduction_axes], keep_dims: keep_dims, T: typeT, name: name)
    end
  

    def self.sparse_reduce_sum_sparse(input_indices, input_values, input_shape, reduction_axes, keep_dims: false, typeT: nil, name: nil)
    ...
    def self.sparse_reorder(input_indices, input_values, input_shape, typeT: nil, name: nil)
      self.execute("SparseReorder", [input_indices, input_values, input_shape], T: typeT, name: name)
    end
  

    def self.sparse_reshape(input_indices, input_shape, new_shape, name: nil)
      self.execute("SparseReshape", [input_indices, input_shape, new_shape], name: name)
    end
  

    def self.sparse_segment_mean(data, indices, segment_ids, typeT: nil, tidx: nil, name: nil)
      self.execute("SparseSegmentMean", [data, indices, segment_ids], T: typeT, Tidx: tidx, name: name)
    end
  

    def self.sparse_segment_mean_grad(grad, indices, segment_ids, output_dim0, typeT: nil, tidx: nil, name: nil)
      self.execute("SparseSegmentMeanGrad", [grad, indices, segment_ids, output_dim0], T: typeT, Tidx: tidx, name: name)
    end
  

    def self.sparse_segment_mean_with_num_segments(data, indices, segment_ids, num_segments, typeT: nil, tidx: nil, tnumsegments: nil, name: nil)
    ...
    def self.sparse_segment_sqrt_n(data, indices, segment_ids, typeT: nil, tidx: nil, name: nil)
      self.execute("SparseSegmentSqrtN", [data, indices, segment_ids], T: typeT, Tidx: tidx, name: name)
    end
  

    def self.sparse_segment_sqrt_n_grad(grad, indices, segment_ids, output_dim0, typeT: nil, tidx: nil, name: nil)
      self.execute("SparseSegmentSqrtNGrad", [grad, indices, segment_ids, output_dim0], T: typeT, Tidx: tidx, name: name)
    end
  

    def self.sparse_segment_sqrt_n_with_num_segments(data, indices, segment_ids, num_segments, typeT: nil, tidx: nil, tnumsegments: nil, name: nil)
    ...
    def self.sparse_segment_sum(data, indices, segment_ids, typeT: nil, tidx: nil, name: nil)
      self.execute("SparseSegmentSum", [data, indices, segment_ids], T: typeT, Tidx: tidx, name: name)
    end
  

    def self.sparse_segment_sum_with_num_segments(data, indices, segment_ids, num_segments, typeT: nil, tidx: nil, tnumsegments: nil, name: nil)
    ...
    def self.sparse_slice(indices, values, shape, start, size, typeT: nil, name: nil)
      self.execute("SparseSlice", [indices, values, shape, start, size], T: typeT, name: name)
    end
  

    def self.sparse_slice_grad(backprop_val_grad, input_indices, input_start, output_indices, typeT: nil, name: nil)
      self.execute("SparseSliceGrad", [backprop_val_grad, input_indices, input_start, output_indices], T: typeT, name: name)
    end
  

    def self.sparse_softmax(sp_indices, sp_values, sp_shape, typeT: nil, name: nil)
      self.execute("SparseSoftmax", [sp_indices, sp_values, sp_shape], T: typeT, name: name)
    end
  

    def self.sparse_softmax_cross_entropy_with_logits(features, labels, typeT: nil, tlabels: nil, name: nil)
      self.execute("SparseSoftmaxCrossEntropyWithLogits", [features, labels], T: typeT, Tlabels: tlabels, name: name)
    end
  

    def self.sparse_sparse_maximum(a_indices, a_values, a_shape, b_indices, b_values, b_shape, typeT: nil, name: nil)
      self.execute("SparseSparseMaximum", [a_indices, a_values, a_shape, b_indices, b_values, b_shape], T: typeT, name: name)
    end
  

    def self.sparse_sparse_minimum(a_indices, a_values, a_shape, b_indices, b_values, b_shape, typeT: nil, name: nil)
      self.execute("SparseSparseMinimum", [a_indices, a_values, a_shape, b_indices, b_values, b_shape], T: typeT, name: name)
    end
  

    def self.sparse_split(split_dim, indices, values, shape, num_split: nil, typeT: nil, name: nil)
      self.execute("SparseSplit", [split_dim, indices, values, shape], num_split: num_split, T: typeT, name: name)
    end
  

    def self.sparse_tensor_dense_add(a_indices, a_values, a_shape, b, typeT: nil, tindices: nil, name: nil)
      self.execute("SparseTensorDenseAdd", [a_indices, a_values, a_shape, b], T: typeT, Tindices: tindices, name: name)
    end
  

    def self.sparse_tensor_dense_mat_mul(a_indices, a_values, a_shape, b, typeT: nil, tindices: nil, adjoint_a: false, adjoint_b: false, name: nil)
    ...
    def self.sparse_tensor_slice_dataset(indices, values, dense_shape, tvalues: nil, name: nil)
      self.execute("SparseTensorSliceDataset", [indices, values, dense_shape], Tvalues: tvalues, name: name)
    end
  

    def self.sparse_tensor_to_csr_sparse_matrix(indices, values, dense_shape, typeT: nil, name: nil)
      self.execute("SparseTensorToCSRSparseMatrix", [indices, values, dense_shape], T: typeT, name: name)
    end
  

    def self.sparse_to_dense(sparse_indices, output_shape, sparse_values, default_value, validate_indices: true, typeT: nil, tindices: nil, name: nil)
    ...
    def self.sparse_to_sparse_set_operation(set1_indices, set1_values, set1_shape, set2_indices, set2_values, set2_shape, set_operation: nil, validate_indices: true, typeT: nil, name: nil)
    ...
    def self.split(split_dim, value, num_split: nil, typeT: nil, name: nil)
      self.execute("Split", [split_dim, value], num_split: num_split, T: typeT, name: name)
    end
  

    def self.split_v(value, size_splits, split_dim, num_split: nil, typeT: nil, tlen: nil, name: nil)
      self.execute("SplitV", [value, size_splits, split_dim], num_split: num_split, T: typeT, Tlen: tlen, name: name)
    end
  

    def self.sql_dataset(driver_name, data_source_name, query, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.stage_clear(capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.stage_peek(index, capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.stage_size(capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.stateful_partitioned_call(args, tin: nil, tout: nil, f: nil, config: nil, config_proto: nil, executor_type: nil, name: nil)
    ...
    def self.stateful_random_binomial(resource, algorithm, shape, counts, probs, s: nil, typeT: nil, dtype: nil, name: nil)
      self.execute("StatefulRandomBinomial", [resource, algorithm, shape, counts, probs], S: s, T: typeT, dtype: dtype, name: name)
    end
  

    def self.stateful_standard_normal(resource, shape, dtype: nil, shape_dtype: nil, name: nil)
      self.execute("StatefulStandardNormal", [resource, shape], dtype: dtype, shape_dtype: shape_dtype, name: name)
    end
  

    def self.stateful_standard_normal_v2(resource, algorithm, shape, dtype: nil, shape_dtype: nil, name: nil)
      self.execute("StatefulStandardNormalV2", [resource, algorithm, shape], dtype: dtype, shape_dtype: shape_dtype, name: name)
    end
  

    def self.stateful_truncated_normal(resource, algorithm, shape, dtype: nil, shape_dtype: nil, name: nil)
      self.execute("StatefulTruncatedNormal", [resource, algorithm, shape], dtype: dtype, shape_dtype: shape_dtype, name: name)
    end
  

    def self.stateful_uniform(resource, algorithm, shape, dtype: nil, shape_dtype: nil, name: nil)
      self.execute("StatefulUniform", [resource, algorithm, shape], dtype: dtype, shape_dtype: shape_dtype, name: name)
    end
  

    def self.stateful_uniform_full_int(resource, algorithm, shape, dtype: nil, shape_dtype: nil, name: nil)
      self.execute("StatefulUniformFullInt", [resource, algorithm, shape], dtype: dtype, shape_dtype: shape_dtype, name: name)
    end
  

    def self.stateful_uniform_int(resource, algorithm, shape, minval, maxval, dtype: nil, shape_dtype: nil, name: nil)
      self.execute("StatefulUniformInt", [resource, algorithm, shape, minval, maxval], dtype: dtype, shape_dtype: shape_dtype, name: name)
    end
  

    def self.stateless_if(cond, input, tcond: nil, tin: nil, tout: nil, then_branch: nil, else_branch: nil, output_shapes: [], name: nil)
    ...
    def self.stateless_multinomial(logits, num_samples, seed, typeT: nil, tseed: nil, output_dtype: nil, name: nil)
      self.execute("StatelessMultinomial", [logits, num_samples, seed], T: typeT, Tseed: tseed, output_dtype: output_dtype, name: name)
    end
  

    def self.stateless_random_normal(shape, seed, dtype: nil, typeT: nil, tseed: nil, name: nil)
      self.execute("StatelessRandomNormal", [shape, seed], dtype: dtype, T: typeT, Tseed: tseed, name: name)
    end
  

    def self.stateless_random_uniform(shape, seed, dtype: nil, typeT: nil, tseed: nil, name: nil)
      self.execute("StatelessRandomUniform", [shape, seed], dtype: dtype, T: typeT, Tseed: tseed, name: name)
    end
  

    def self.stateless_random_uniform_int(shape, seed, minval, maxval, dtype: nil, typeT: nil, tseed: nil, name: nil)
      self.execute("StatelessRandomUniformInt", [shape, seed, minval, maxval], dtype: dtype, T: typeT, Tseed: tseed, name: name)
    end
  

    def self.stateless_truncated_normal(shape, seed, dtype: nil, typeT: nil, tseed: nil, name: nil)
      self.execute("StatelessTruncatedNormal", [shape, seed], dtype: dtype, T: typeT, Tseed: tseed, name: name)
    end
  

    def self.stateless_while(input, typeT: nil, cond: nil, body: nil, output_shapes: [], parallel_iterations: 10, name: nil)
    ...
    def self.static_regex_full_match(input, pattern: nil, name: nil)
      self.execute("StaticRegexFullMatch", [input], pattern: pattern, name: name)
    end
  

    def self.static_regex_replace(input, pattern: nil, rewrite: nil, replace_global: true, name: nil)
      self.execute("StaticRegexReplace", [input], pattern: pattern, rewrite: rewrite, replace_global: replace_global, name: name)
    end
  

    def self.stats_aggregator_handle(container: nil, shared_name: nil, name: nil)
      self.execute("StatsAggregatorHandle", [], container: container, shared_name: shared_name, name: name)
    end
  

    def self.stats_aggregator_handle_v2(container: nil, shared_name: nil, name: nil)
      self.execute("StatsAggregatorHandleV2", [], container: container, shared_name: shared_name, name: name)
    end
  

    def self.stats_aggregator_set_summary_writer(stats_aggregator, summary, name: nil)
      self.execute("StatsAggregatorSetSummaryWriter", [stats_aggregator, summary], name: name)
    end
  

    def self.stats_aggregator_summary(iterator, name: nil)
      self.execute("StatsAggregatorSummary", [iterator], name: name)
    end
  

    def self.stop_gradient(input, typeT: nil, name: nil)
      self.execute("StopGradient", [input], T: typeT, name: name)
    end
  

    def self.strided_slice(input, start, stop, strides, typeT: nil, index: nil, begin_mask: 0, end_mask: 0, ellipsis_mask: 0, new_axis_mask: 0, shrink_axis_mask: 0, name: nil)
    ...
    def self.strided_slice_assign(ref, start, stop, strides, value, typeT: nil, index: nil, begin_mask: 0, end_mask: 0, ellipsis_mask: 0, new_axis_mask: 0, shrink_axis_mask: 0, name: nil)
    ...
    def self.strided_slice_grad(shape, start, stop, strides, dy, typeT: nil, index: nil, begin_mask: 0, end_mask: 0, ellipsis_mask: 0, new_axis_mask: 0, shrink_axis_mask: 0, name: nil)
    ...
    def self.string_format(inputs, typeT: nil, template: "%s", placeholder: "%s", summarize: 3, name: nil)
      self.execute("StringFormat", [inputs], T: typeT, template: template, placeholder: placeholder, summarize: summarize, name: name)
    end
  

    def self.string_join(inputs, n: nil, separator: nil, name: nil)
      self.execute("StringJoin", [inputs], N: n, separator: separator, name: name)
    end
  

    def self.string_length(input, unit: "BYTE", name: nil)
      self.execute("StringLength", [input], unit: unit, name: name)
    end
  

    def self.string_lower(input, encoding: nil, name: nil)
      self.execute("StringLower", [input], encoding: encoding, name: name)
    end
  

    def self.string_n_grams(data, data_splits, separator: nil, ngram_widths: nil, left_pad: nil, right_pad: nil, pad_width: nil, preserve_short_sequences: nil, tsplits: nil, name: nil)
    ...
    def self.tpu_ordinal_selector(name: nil)
      self.execute("TPUOrdinalSelector", [], name: name)
    end
  

    def self.tpu_partitioned_call(args, device_ordinal, tin: nil, tout: nil, f: nil, autotuner_thresh: 0, name: nil)
      self.execute("TPUPartitionedCall", [args, device_ordinal], Tin: tin, Tout: tout, f: f, autotuner_thresh: autotuner_thresh, name: name)
    end
  

    def self.tpu_replicate_metadata(num_replicas: nil, num_cores_per_replica: 1, topology: nil, use_tpu: true, device_assignment: [], computation_shape: [], host_compute_core: [], padding_map: [], step_marker_location: "STEP_MARK_AT_ENTRY", allow_soft_placement: false, name: nil)
    ...
    def self.tpu_replicated_input(inputs, n: nil, typeT: nil, is_mirrored_variable: false, index: -1, name: nil)
      self.execute("TPUReplicatedInput", [inputs], N: n, T: typeT, is_mirrored_variable: is_mirrored_variable, index: index, name: name)
    end
  

    def self.tpu_replicated_output(input, num_replicas: nil, typeT: nil, name: nil)
      self.execute("TPUReplicatedOutput", [input], num_replicas: num_replicas, T: typeT, name: name)
    end
  

    def self.take_dataset(input_dataset, count, output_types: nil, output_shapes: nil, name: nil)
      self.execute("TakeDataset", [input_dataset, count], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.take_many_sparse_from_tensors_map(sparse_handles, dtype: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.take_while_dataset(input_dataset, other_arguments, predicate: nil, targuments: nil, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.tan(x, typeT: nil, name: nil)
      self.execute("Tan", [x], T: typeT, name: name)
    end
  

    def self.tanh(x, typeT: nil, name: nil)
      self.execute("Tanh", [x], T: typeT, name: name)
    end
  

    def self.tanh_grad(y, dy, typeT: nil, name: nil)
      self.execute("TanhGrad", [y, dy], T: typeT, name: name)
    end
  

    def self.temporary_variable(shape: nil, dtype: nil, var_name: nil, name: nil)
      self.execute("TemporaryVariable", [], shape: shape, dtype: dtype, var_name: var_name, name: name)
    end
  

    def self.tensor_array(size, dtype: nil, dynamic_size: false, clear_after_read: true, tensor_array_name: nil, element_shape: [], name: nil)
    ...
    def self.tensor_array_v3(size, dtype: nil, element_shape: [], dynamic_size: false, clear_after_read: true, identical_element_shapes: false, tensor_array_name: nil, name: nil)
    ...
    def self.tensor_array_write(handle, index, value, flow_in, typeT: nil, name: nil)
      self.execute("TensorArrayWrite", [handle, index, value, flow_in], T: typeT, name: name)
    end
  

    def self.tensor_array_write_v2(handle, index, value, flow_in, typeT: nil, name: nil)
      self.execute("TensorArrayWriteV2", [handle, index, value, flow_in], T: typeT, name: name)
    end
  

    def self.tensor_array_write_v3(handle, index, value, flow_in, typeT: nil, name: nil)
      self.execute("TensorArrayWriteV3", [handle, index, value, flow_in], T: typeT, name: name)
    end
  

    def self.tensor_dataset(components, toutput_types: nil, output_shapes: nil, name: nil)
      self.execute("TensorDataset", [components], Toutput_types: toutput_types, output_shapes: output_shapes, name: name)
    end
  

    def self.tensor_forest_create_tree_variable(tree_handle, tree_config, name: nil)
      self.execute("TensorForestCreateTreeVariable", [tree_handle, tree_config], name: name)
    end
  

    def self.tensor_forest_tree_deserialize(tree_handle, tree_config, name: nil)
      self.execute("TensorForestTreeDeserialize", [tree_handle, tree_config], name: name)
    end
  

    def self.tensor_forest_tree_is_initialized_op(tree_handle, name: nil)
      self.execute("TensorForestTreeIsInitializedOp", [tree_handle], name: name)
    end
  

    def self.tensor_forest_tree_predict(tree_handle, dense_features, logits_dimension: nil, name: nil)
      self.execute("TensorForestTreePredict", [tree_handle, dense_features], logits_dimension: logits_dimension, name: name)
    end
  

    def self.tensor_forest_tree_resource_handle_op(container: nil, shared_name: nil, name: nil)
      self.execute("TensorForestTreeResourceHandleOp", [], container: container, shared_name: shared_name, name: name)
    end
  

    def self.tensor_forest_tree_serialize(tree_handle, name: nil)
      self.execute("TensorForestTreeSerialize", [tree_handle], name: name)
    end
  

    def self.tensor_forest_tree_size(tree_handle, name: nil)
      self.execute("TensorForestTreeSize", [tree_handle], name: name)
    end
  

    def self.tensor_list_concat(input_handle, element_dtype: nil, element_shape: [], name: nil)
      self.execute("TensorListConcat", [input_handle], element_dtype: element_dtype, element_shape: element_shape, name: name)
    end
  

    def self.tensor_list_concat_lists(input_a, input_b, element_dtype: nil, name: nil)
      self.execute("TensorListConcatLists", [input_a, input_b], element_dtype: element_dtype, name: name)
    end
  

    def self.tensor_list_concat_v2(input_handle, element_shape, leading_dims, element_dtype: nil, shape_type: nil, name: nil)
    ...
    def self.tensor_list_set_item(input_handle, index, item, element_dtype: nil, name: nil)
      self.execute("TensorListSetItem", [input_handle, index, item], element_dtype: element_dtype, name: name)
    end
  

    def self.tensor_list_split(tensor, element_shape, lengths, element_dtype: nil, shape_type: nil, name: nil)
      self.execute("TensorListSplit", [tensor, element_shape, lengths], element_dtype: element_dtype, shape_type: shape_type, name: name)
    end
  

    def self.tensor_list_stack(input_handle, element_shape, element_dtype: nil, num_elements: -1, name: nil)
      self.execute("TensorListStack", [input_handle, element_shape], element_dtype: element_dtype, num_elements: num_elements, name: name)
    end
  

    def self.tensor_scatter_add(tensor, indices, updates, typeT: nil, tindices: nil, name: nil)
      self.execute("TensorScatterAdd", [tensor, indices, updates], T: typeT, Tindices: tindices, name: name)
    end
  

    def self.tensor_scatter_sub(tensor, indices, updates, typeT: nil, tindices: nil, name: nil)
      self.execute("TensorScatterSub", [tensor, indices, updates], T: typeT, Tindices: tindices, name: name)
    end
  

    def self.tensor_scatter_update(tensor, indices, updates, typeT: nil, tindices: nil, name: nil)
      self.execute("TensorScatterUpdate", [tensor, indices, updates], T: typeT, Tindices: tindices, name: name)
    end
  

    def self.tensor_slice_dataset(components, toutput_types: nil, output_shapes: nil, name: nil)
      self.execute("TensorSliceDataset", [components], Toutput_types: toutput_types, output_shapes: output_shapes, name: name)
    end
  

    def self.tensor_strided_slice_update(input, start, stop, strides, value, typeT: nil, index: nil, begin_mask: 0, end_mask: 0, ellipsis_mask: 0, new_axis_mask: 0, shrink_axis_mask: 0, name: nil)
    ...
    def self.tensor_summary(tensor, typeT: nil, description: nil, labels: [], display_name: nil, name: nil)
      self.execute("TensorSummary", [tensor], T: typeT, description: description, labels: labels, display_name: display_name, name: name)
    end
  

    def self.tensor_summary_v2(tag, tensor, serialized_summary_metadata, typeT: nil, name: nil)
      self.execute("TensorSummaryV2", [tag, tensor, serialized_summary_metadata], T: typeT, name: name)
    end
  

    def self.text_line_dataset(filenames, compression_type, buffer_size, name: nil)
      self.execute("TextLineDataset", [filenames, compression_type, buffer_size], name: name)
    end
  

    def self.text_line_reader(skip_header_lines: 0, container: nil, shared_name: nil, name: nil)
      self.execute("TextLineReader", [], skip_header_lines: skip_header_lines, container: container, shared_name: shared_name, name: name)
    end
  

    def self.text_line_reader_v2(skip_header_lines: 0, container: nil, shared_name: nil, name: nil)
      self.execute("TextLineReaderV2", [], skip_header_lines: skip_header_lines, container: container, shared_name: shared_name, name: name)
    end
  

    def self.thread_pool_dataset(input_dataset, thread_pool, output_types: nil, output_shapes: nil, name: nil)
      self.execute("ThreadPoolDataset", [input_dataset, thread_pool], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.thread_pool_handle(num_threads: nil, max_intra_op_parallelism: 1, display_name: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.thread_unsafe_unigram_candidate_sampler(true_classes, num_true: nil, num_sampled: nil, unique: nil, range_max: nil, seed: 0, seed2: 0, name: nil)
    ...
    def self.tile(input, multiples, typeT: nil, tmultiples: nil, name: nil)
      self.execute("Tile", [input, multiples], T: typeT, Tmultiples: tmultiples, name: name)
    end
  

    def self.tile_grad(input, multiples, typeT: nil, name: nil)
      self.execute("TileGrad", [input, multiples], T: typeT, name: name)
    end
  

    def self.timestamp(name: nil)
      self.execute("Timestamp", [], name: name)
    end
  

    def self.top_k(input, k: nil, sorted: true, typeT: nil, name: nil)
      self.execute("TopK", [input], k: k, sorted: sorted, T: typeT, name: name)
    end
  

    def self.top_kv2(input, k, sorted: true, typeT: nil, name: nil)
      self.execute("TopKV2", [input, k], sorted: sorted, T: typeT, name: name)
    end
  

    def self.transpose(x, perm, typeT: nil, tperm: nil, name: nil)
      self.execute("Transpose", [x, perm], T: typeT, Tperm: tperm, name: name)
    end
  

    def self.tridiagonal_mat_mul(superdiag, maindiag, subdiag, rhs, typeT: nil, name: nil)
      self.execute("TridiagonalMatMul", [superdiag, maindiag, subdiag, rhs], T: typeT, name: name)
    end
  

    def self.tridiagonal_solve(diagonals, rhs, partial_pivoting: true, typeT: nil, name: nil)
      self.execute("TridiagonalSolve", [diagonals, rhs], partial_pivoting: partial_pivoting, T: typeT, name: name)
    end
  

    def self.truncate_div(x, y, typeT: nil, name: nil)
      self.execute("TruncateDiv", [x, y], T: typeT, name: name)
    end
  

    def self.truncate_mod(x, y, typeT: nil, name: nil)
      self.execute("TruncateMod", [x, y], T: typeT, name: name)
    end
  

    def self.truncated_normal(shape, seed: 0, seed2: 0, dtype: nil, typeT: nil, name: nil)
      self.execute("TruncatedNormal", [shape], seed: seed, seed2: seed2, dtype: dtype, T: typeT, name: name)
    end
  

    def self.try_rpc(address, method, request, protocol: nil, fail_fast: true, timeout_in_ms: 0, name: nil)
      self.execute("TryRpc", [address, method, request], protocol: protocol, fail_fast: fail_fast, timeout_in_ms: timeout_in_ms, name: name)
    end
  

    def self.unbatch(batched_tensor, batch_index, id, timeout_micros: nil, container: nil, shared_name: nil, typeT: nil, name: nil)
    ...
    def self.unbatch_dataset(input_dataset, output_types: nil, output_shapes: nil, name: nil)
      self.execute("UnbatchDataset", [input_dataset], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.unbatch_grad(original_input, batch_index, grad, id, container: nil, shared_name: nil, typeT: nil, name: nil)
    ...
    def self.unicode_decode(input, input_encoding: nil, errors: "replace", replacement_char: 65533, replace_control_characters: false, tsplits: nil, name: nil)
    ...
    def self.unicode_decode_with_offsets(input, input_encoding: nil, errors: "replace", replacement_char: 65533, replace_control_characters: false, tsplits: nil, name: nil)
    ...
    def self.unicode_encode(input_values, input_splits, errors: "replace", output_encoding: nil, replacement_char: 65533, tsplits: nil, name: nil)
    ...
    def self.unicode_script(input, name: nil)
      self.execute("UnicodeScript", [input], name: name)
    end
  

    def self.unicode_transcode(input, input_encoding: nil, output_encoding: nil, errors: "replace", replacement_char: 65533, replace_control_characters: false, name: nil)
    ...
    def self.uniform_candidate_sampler(true_classes, num_true: nil, num_sampled: nil, unique: nil, range_max: nil, seed: 0, seed2: 0, name: nil)
    ...
    def self.unique(x, typeT: nil, out_idx: nil, name: nil)
      self.execute("Unique", [x], T: typeT, out_idx: out_idx, name: name)
    end
  

    def self.unique_dataset(input_dataset, output_types: nil, output_shapes: nil, name: nil)
      self.execute("UniqueDataset", [input_dataset], output_types: output_types, output_shapes: output_shapes, name: name)
    end
  

    def self.unique_v2(x, axis, typeT: nil, taxis: nil, out_idx: nil, name: nil)
      self.execute("UniqueV2", [x, axis], T: typeT, Taxis: taxis, out_idx: out_idx, name: name)
    end
  

    def self.unique_with_counts(x, typeT: nil, out_idx: nil, name: nil)
      self.execute("UniqueWithCounts", [x], T: typeT, out_idx: out_idx, name: name)
    end
  

    def self.unique_with_counts_v2(x, axis, typeT: nil, taxis: nil, out_idx: nil, name: nil)
      self.execute("UniqueWithCountsV2", [x, axis], T: typeT, Taxis: taxis, out_idx: out_idx, name: name)
    end
  

    def self.unpack(value, num: nil, typeT: nil, axis: 0, name: nil)
      self.execute("Unpack", [value], num: num, T: typeT, axis: axis, name: name)
    end
  

    def self.unravel_index(indices, dims, tidx: nil, name: nil)
      self.execute("UnravelIndex", [indices, dims], Tidx: tidx, name: name)
    end
  

    def self.unsorted_segment_join(inputs, segment_ids, num_segments, separator: nil, tindices: nil, tnumsegments: nil, name: nil)
    ...
    def self.unsorted_segment_max(data, segment_ids, num_segments, typeT: nil, tindices: nil, tnumsegments: nil, name: nil)
    ...
    def self.unsorted_segment_min(data, segment_ids, num_segments, typeT: nil, tindices: nil, tnumsegments: nil, name: nil)
    ...
    def self.unsorted_segment_prod(data, segment_ids, num_segments, typeT: nil, tindices: nil, tnumsegments: nil, name: nil)
    ...
    def self.unsorted_segment_sum(data, segment_ids, num_segments, typeT: nil, tindices: nil, tnumsegments: nil, name: nil)
    ...
    def self.unstage(capacity: 0, memory_limit: 0, dtypes: nil, container: nil, shared_name: nil, name: nil)
    ...
    def self.unwrap_dataset_variant(input_handle, name: nil)
      self.execute("UnwrapDatasetVariant", [input_handle], name: name)
    end
  

    def self.upper_bound(sorted_inputs, values, typeT: nil, out_type: nil, name: nil)
      self.execute("UpperBound", [sorted_inputs, values], T: typeT, out_type: out_type, name: name)
    end
  

    def self.var_handle_op(container: nil, shared_name: nil, dtype: nil, shape: nil, name: nil)
      self.execute("VarHandleOp", [], container: container, shared_name: shared_name, dtype: dtype, shape: shape, name: name)
    end
  

    def self.var_is_initialized_op(resource, name: nil)
      self.execute("VarIsInitializedOp", [resource], name: name)
    end
  

    def self.variable(shape: nil, dtype: nil, container: nil, shared_name: nil, name: nil)
      self.execute("Variable", [], shape: shape, dtype: dtype, container: container, shared_name: shared_name, name: name)
    end
  

    def self.variable_shape(input, out_type: nil, name: nil)
      self.execute("VariableShape", [input], out_type: out_type, name: name)
    end
  

    def self.variable_v2(shape: nil, dtype: nil, container: nil, shared_name: nil, name: nil)
      self.execute("VariableV2", [], shape: shape, dtype: dtype, container: container, shared_name: shared_name, name: name)
    end
  

    def self.where(input, typeT: nil, name: nil)
      self.execute("Where", [input], T: typeT, name: name)
    end
  

    def self.while(input, typeT: nil, cond: nil, body: nil, output_shapes: [], parallel_iterations: 10, name: nil)
    ...
    def self.whole_file_reader(container: nil, shared_name: nil, name: nil)
      self.execute("WholeFileReader", [], container: container, shared_name: shared_name, name: name)
    end
  

    def self.whole_file_reader_v2(container: nil, shared_name: nil, name: nil)
      self.execute("WholeFileReaderV2", [], container: container, shared_name: shared_name, name: name)
    end
  

    def self.window_dataset(input_dataset, size, shift, stride, drop_remainder, output_types: nil, output_shapes: nil, name: nil)
    ...
    def self.worker_heartbeat(request, name: nil)
      self.execute("WorkerHeartbeat", [request], name: name)
    end
  

    def self.wrap_dataset_variant(input_handle, name: nil)
      self.execute("WrapDatasetVariant", [input_handle], name: name)
    end
  

    def self.write_audio_summary(writer, step, tag, tensor, sample_rate, max_outputs: 3, name: nil)
      self.execute("WriteAudioSummary", [writer, step, tag, tensor, sample_rate], max_outputs: max_outputs, name: name)
    end
  

    def self.write_file(filename, contents, name: nil)
      self.execute("WriteFile", [filename, contents], name: name)
    end
  

    def self.write_graph_summary(writer, step, tensor, name: nil)
      self.execute("WriteGraphSummary", [writer, step, tensor], name: name)
    end
  

    def self.write_histogram_summary(writer, step, tag, values, typeT: nil, name: nil)
      self.execute("WriteHistogramSummary", [writer, step, tag, values], T: typeT, name: name)
    end
  

    def self.write_image_summary(writer, step, tag, tensor, bad_color, max_images: 3, typeT: nil, name: nil)
      self.execute("WriteImageSummary", [writer, step, tag, tensor, bad_color], max_images: max_images, T: typeT, name: name)
    end
  

    def self.write_raw_proto_summary(writer, step, tensor, name: nil)
      self.execute("WriteRawProtoSummary", [writer, step, tensor], name: name)
    end
  

    def self.write_scalar_summary(writer, step, tag, value, typeT: nil, name: nil)
      self.execute("WriteScalarSummary", [writer, step, tag, value], T: typeT, name: name)
    end
  

    def self.write_summary(writer, step, tensor, tag, summary_metadata, typeT: nil, name: nil)
      self.execute("WriteSummary", [writer, step, tensor, tag, summary_metadata], T: typeT, name: name)
    end
  

    def self.xdivy(x, y, typeT: nil, name: nil)
      self.execute("Xdivy", [x, y], T: typeT, name: name)
    end
  

    def self.xlogy(x, y, typeT: nil, name: nil)
      self.execute("Xlogy", [x, y], T: typeT, name: name)
    end
  

    def self.zeros_like(x, typeT: nil, name: nil)
      self.execute("ZerosLike", [x], T: typeT, name: name)
    end
  

    def self.zeta(x, q, typeT: nil, name: nil)
      self.execute("Zeta", [x, q], T: typeT, name: name)
    end
  

    def self.zip_dataset(input_datasets, output_types: nil, output_shapes: nil, n: nil, name: nil)
      self.execute("ZipDataset", [input_datasets], output_types: output_types, output_shapes: output_shapes, N: n, name: name)
    end
  

    def self._arg(typeT: nil, index: nil, name: nil)
      self.execute("_Arg", [], T: typeT, index: index, name: name)
    end
  

    def self._array_to_list(input, typeT: nil, n: nil, out_types: nil, name: nil)
      self.execute("_ArrayToList", [input], T: typeT, N: n, out_types: out_types, name: name)
    end
  

    def self._configure_distributed_tpu(inputs, n: nil, enable_whole_mesh_compilations: false, name: nil)
      self.execute("_ConfigureDistributedTPU", [inputs], N: n, enable_whole_mesh_compilations: enable_whole_mesh_compilations, name: name)
    end
  

    def self._device_arg(typeT: nil, index: nil, name: nil)
      self.execute("_DeviceArg", [], T: typeT, index: index, name: name)
    end
  

    def self._device_retval(input, typeT: nil, index: nil, name: nil)
      self.execute("_DeviceRetval", [input], T: typeT, index: index, name: name)
    end
  

    def self._disconnect_host_from_distributed_tpu_system(name: nil)
      self.execute("_DisconnectHostFromDistributedTPUSystem", [], name: name)
    end
  

    def self._fused_batch_norm_ex(x, scale, offset, mean, variance, side_input, typeT: nil, u: nil, epsilon: 9.999999747378752e-05, num_side_inputs: 0, activation_mode: "Identity", data_format: "NHWC", is_training: true, name: nil)
    ...
    def self._fused_conv2_d(input, filter, args, typeT: nil, num_args: nil, strides: nil, padding: nil, explicit_paddings: [], data_format: "NHWC", dilations: [], use_cudnn_on_gpu: true, fused_ops: [], epsilon: 9.999999747378752e-05, name: nil)
    ...
    def self._fused_mat_mul(a, b, args, transpose_a: false, transpose_b: false, typeT: nil, num_args: nil, fused_ops: [], epsilon: 9.999999747378752e-05, name: nil)
    ...
    def self._host_cast(x, srct: nil, dstt: nil, truncate: false, name: nil)
      self.execute("_HostCast", [x], SrcT: srct, DstT: dstt, Truncate: truncate, name: name)
    end
  

    def self._host_recv(tensor_type: nil, tensor_name: nil, send_device: nil, send_device_incarnation: nil, recv_device: nil, client_terminated: false, name: nil)
    ...
    def self._host_send(tensor, typeT: nil, tensor_name: nil, send_device: nil, send_device_incarnation: nil, recv_device: nil, client_terminated: false, name: nil)
    ...
    def self._if(cond, input, tcond: nil, tin: nil, tout: nil, then_branch: nil, else_branch: nil, name: nil)
      self.execute("_If", [cond, input], Tcond: tcond, Tin: tin, Tout: tout, then_branch: then_branch, else_branch: else_branch, name: name)
    end
  

    def self._initialize_host_for_distributed_tpu(input, enable_whole_mesh_compilations: false, name: nil)
    ...
    def self._list_to_array(input, tin: nil, typeT: nil, n: nil, name: nil)
      self.execute("_ListToArray", [input], Tin: tin, T: typeT, N: n, name: name)
    end
  

    def self._mkl_maximum(x, y, mkl_x, mkl_y, typeT: nil, name: nil)
      self.execute("_MklMaximum", [x, y, mkl_x, mkl_y], T: typeT, name: name)
    end
  

    def self._mkl_mul(x, y, mkl_x, mkl_y, typeT: nil, name: nil)
      self.execute("_MklMul", [x, y, mkl_x, mkl_y], T: typeT, name: name)
    end
  

    def self._mkl_squared_difference(x, y, mkl_x, mkl_y, typeT: nil, name: nil)
      self.execute("_MklSquaredDifference", [x, y, mkl_x, mkl_y], T: typeT, name: name)
    end
  

    def self._mkl_sub(x, y, mkl_x, mkl_y, typeT: nil, name: nil)
      self.execute("_MklSub", [x, y, mkl_x, mkl_y], T: typeT, name: name)
    end
  

    def self._nccl_broadcast_recv(shape, typeT: nil, num_devices: nil, shared_name: nil, name: nil)
      self.execute("_NcclBroadcastRecv", [shape], T: typeT, num_devices: num_devices, shared_name: shared_name, name: name)
    end
  

    def self._nccl_broadcast_send(input, typeT: nil, num_devices: nil, shared_name: nil, name: nil)
      self.execute("_NcclBroadcastSend", [input], T: typeT, num_devices: num_devices, shared_name: shared_name, name: name)
    end
  

    def self._nccl_reduce_recv(input, reduction: nil, typeT: nil, num_devices: nil, shared_name: nil, name: nil)
      self.execute("_NcclReduceRecv", [input], reduction: reduction, T: typeT, num_devices: num_devices, shared_name: shared_name, name: name)
    end
  

    def self._nccl_reduce_send(input, reduction: nil, typeT: nil, num_devices: nil, shared_name: nil, name: nil)
      self.execute("_NcclReduceSend", [input], reduction: reduction, T: typeT, num_devices: num_devices, shared_name: shared_name, name: name)
    end
  

    def self._parallel_concat_start(shape: nil, dtype: nil, name: nil)
      self.execute("_ParallelConcatStart", [], shape: shape, dtype: dtype, name: name)
    end
  

    def self._parallel_concat_update(value, update, typeT: nil, loc: nil, name: nil)
      self.execute("_ParallelConcatUpdate", [value, update], T: typeT, loc: loc, name: name)
    end
  

    def self._read_variables_op(resources, n: nil, dtypes: nil, name: nil)
      self.execute("_ReadVariablesOp", [resources], N: n, dtypes: dtypes, name: name)
    end
  

    def self._recv(tensor_type: nil, tensor_name: nil, send_device: nil, send_device_incarnation: nil, recv_device: nil, client_terminated: false, name: nil)
    ...
    def self._retval(input, typeT: nil, index: nil, name: nil)
      self.execute("_Retval", [input], T: typeT, index: index, name: name)
    end
  

    def self._scoped_allocator(shapes: nil, shape: nil, typeT: nil, sa_name: nil, id: nil, expected_call_count: nil, name: nil)
    ...
    def self._scoped_allocator_concat(backing, inputs, shape: nil, typeT: nil, reshape: false, sa_name: nil, id: nil, n: nil, name: nil)
    ...
    def self._scoped_allocator_split(concat, split, typeT: nil, sa_name: nil, id: nil, n: nil, shapes: nil, name: nil)
      self.execute("_ScopedAllocatorSplit", [concat, split], T: typeT, sa_name: sa_name, id: id, N: n, shapes: shapes, name: name)
    end
  

    def self._send(tensor, typeT: nil, tensor_name: nil, send_device: nil, send_device_incarnation: nil, recv_device: nil, client_terminated: false, name: nil)
    ...
    def self._unary_ops_composition(x, typeT: nil, op_names: nil, name: nil)
      self.execute("_UnaryOpsComposition", [x], T: typeT, op_names: op_names, name: name)
    end
  

    def self._var_handles_op(containers: nil, shared_names: nil, n: nil, dtypes: nil, shapes: nil, name: nil)
      self.execute("_VarHandlesOp", [], containers: containers, shared_names: shared_names, N: n, dtypes: dtypes, shapes: shapes, name: name)
    end
  

    def self._wait_for_distributed_tpu(inputs, startup_timeout_sec: 20, n: nil, name: nil)
      self.execute("_WaitForDistributedTPU", [inputs], startup_timeout_sec: startup_timeout_sec, N: n, name: name)
    end
  

    def self._while(input, typeT: nil, cond: nil, body: nil, name: nil)
      self.execute("_While", [input], T: typeT, cond: cond, body: body, name: name)
    end
  

    def self._xla_recv_at_host(dynamic_key, toutputs: nil, key: nil, device_ordinal: nil, name: nil)
      self.execute("_XlaRecvAtHost", [dynamic_key], Toutputs: toutputs, key: key, device_ordinal: device_ordinal, name: name)
    end
  

    def self._xla_send_from_host(inputs, dynamic_key, tinputs: nil, key: nil, device_ordinal: nil, name: nil)
